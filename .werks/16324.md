...
- NetApp (SVMs) Storage Virtual Machine's (formerly called "vservers”) traffic
  and status
- NetApp volumes (and snapshots)

Note that the NetApp volumes and snapshots plugins will now produce different
services, which can be addressed using [werk #18971](https://checkmk.com/werk/18971).
