...
Note that the NetApp volumes and snapshots plugins will now produce different services, which can be addressed using [werk #18971](https://checkmk.com/werk/18971).
