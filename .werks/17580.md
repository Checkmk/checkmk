...
a sequence of status objects, one for each site. In this response
we will include the activation status, details, the site the
activation was peformed on, the start time and the end time.
