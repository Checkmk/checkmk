...
With this werk the duplicated services will no longer receive data, causing the Check_MK to report a WARN with the message
```
Missing monitoring data for plugins
```
To get rid of these warnings a new service discovery should be run and the vanished services be removed.
