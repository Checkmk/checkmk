...
Note that, due to the complexity of the change and the very specific circumstances under which this becomes a concern, no patch is planned for Checkmk version 2.2.0 (which is currently in passive maintenance).
