...
Checkmk sites operate in a self-contained environment. To ensure stability, the site environment sets the `LD_LIBRARY_PATH` to prioritize Checkmk’s local libraries (found in the site's `~/lib` directory).
