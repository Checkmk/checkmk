...
powershell Write-Host "       unpack_package.cmd 7-zip\7z.exe ..\..\..\omd\packages\googletest googletest-release-1.8.1.tar.gz ..\packages2 googletest" -ForegroundColor DarkGreen
