...
Join-Object -Left $Data_Set1 -Right $Data_Set2 -LeftJoinProperty Name -RightJoinProperty Name -RightProperties "printerstatus","detectederrorstate" -Type OnlyIfInBoth | Sort Name | format-table -HideTableHeaders
