...
echo keep_arg_clippy=%keep_arg_clippy%
echo keep_arg_test=%keep_arg_test%
...
if "%keep_arg_sign%" == "1" (
    ...
    @call ..\wnx\sign_windows_exe c:\common\store\%keep_arg_sign_file% %keep_arg_sign_secret% %exe%
    if ERRORLEVEL 1 ( 
