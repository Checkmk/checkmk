...
# relative paths like ..\..\windows\plugins\...).
stage_workspace() {
    mkdir -p "$STAGE/agents/wnx" "$STAGE/agents/windows"
...
link_msi() {
    export EncryptedPluginsFolder="Z:${STAGE//\//\\}\\agents\\windows\\plugins" # See Product.wxs.
