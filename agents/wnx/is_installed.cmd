...
if not exist "%theValue%" powershell Write-Host "Agent not found" -foreground Red && exit 3
fc /b "%msi%" "%theValue%" >nul && exit /b 0
powershell Write-Host "Agent is not the same, %theValue%" -foreground Red && exit 3
