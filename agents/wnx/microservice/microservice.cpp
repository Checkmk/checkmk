// microservice.cpp : This file contains the 'main' function. Program execution
...
int __cdecl _tmain(int argc, TCHAR *argv[]) {
    ...
    SERVICE_TABLE_ENTRYW DispatchTable[] = {
        {(wchar_t *)SVCNAME, (LPSERVICE_MAIN_FUNCTION)SvcMain}, {NULL, NULL}};
...
VOID WINAPI SvcMain(DWORD dwArgc, LPTSTR *lpszArgv) {
    ...
    OutputDebugString(L"For Init\n");

    SvcInit(dwArgc, lpszArgv);
    OutputDebugString(L"Past Init\n");
}
