...
rem This tool doesn't remove logs and ugrade.protocol
rem we are using sc to find Check MK Service instead of wmic, because wmis is very slow even for Microsoft Windows
rem **************************************************************************************
