...
def package_wheel(
    ...
    Args:
        ...
        intermediate_prefix: Add prefix to the files, needed for "intermediate install"
    ...
    pkg_files(
        ...
        prefix = intermediate_prefix + "lib/python%s/site-packages" % PYTHON_MAJOR_DOT_MINOR,
