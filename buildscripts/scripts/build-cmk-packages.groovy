...
def create_source_package(workspace, source_dir, cmk_version) {
    ...
    stage("Create source package") {
        ...
        dir("${checkout_dir}") {
            ...
            sh "${checkout_dir}/buildscripts/scripts/create_unsign_msi_patch.sh ${agents_dir}/windows/check_mk_agent.msi ${agents_dir}/windows/check_mk_agent_unsigned.msi ${agents_dir}/windows/unsing-msi.patch"
