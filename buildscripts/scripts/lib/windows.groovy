        ...
        timeout(time: 15, unit: 'MINUTES') {
            try {
                if (args.TARGET == "cached") {
                    ...
                    ARTIFACTS = "cmk-agent-ctl.exe,check_mk_agent-64.exe,check_mk_agent.exe,check_mk_agent.msi,check_mk.user.yml,check_mk.yml,watest32.exe,watest64.exe,OpenHardwareMonitorLib.dll,OpenHardwareMonitorCLI.exe"
