        ...
        timeout(time: 15, unit: 'MINUTES') {
            try {
                if (args.TARGET == "cached") {
                    ...
                    bat 'cd agents\\wnx && call call_integration_tests.cmd && call call_integration_tests_ng.cmd '
                    ARTIFACTS = "integration_tests_results.zip,integration_tests_results_ng.zip"
