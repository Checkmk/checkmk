...
String build_make_target(edition, cross_edition_target="") {
    switch (edition) {
        ...
        case 'cloud':
            return "test-system-update-cloud";
        case 'community':
            switch (cross_edition_target) {
                case 'ultimate':
                    return "test-system-update-cross-edition-community-to-ultimate";
                case 'pro':
                    return "test-system-update-cross-edition-community-to-pro";
                default:
                    return "test-system-update-community";
            }
        case 'pro':
            switch (cross_edition_target) {
                case 'ultimate':
                    return "test-system-update-cross-edition-pro-to-ultimate";
                case 'ultimatemt':
                    return "test-system-update-cross-edition-pro-to-ultimatemt";
                default:
                    return "test-system-update-pro";
            }
        case 'ultimate':
            return "test-system-update-ultimate";
        case 'ultimatemt':
            return "test-system-update-ultimatemt";
        default:
