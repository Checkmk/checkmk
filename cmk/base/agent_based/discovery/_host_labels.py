...
def rewrite_cluster_host_labels_file(
    ...
    """Write the clusters discovered host labels file.

    THIS FILE IS ONLY READ BY OLDER CHECKMK VERSIONS

    These files are synced to the central site in a distributed setup.
    We need it, because a potentially older central site might expect it.
    """
    affected_clusters = {
