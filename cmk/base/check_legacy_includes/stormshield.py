...
def stormshield_scan_function(oid):
    return ((
        oid(".1.3.6.1.2.1.1.2.0").startswith('.1.3.6.1.4.1.8072') or
        oid(".1.3.6.1.2.1.1.2.0") == '.1.3.6.1.4.1.11256.2.0'  # version >= 3.7.18
...
def stormshield_cluster_scan_function(oid):
    ...
    return ((
        oid(".1.3.6.1.2.1.1.2.0").startswith('.1.3.6.1.4.1.8072.3.2.8') or
        oid(".1.3.6.1.2.1.1.2.0") == '.1.3.6.1.4.1.11256.2.0'  # version >= 3.7.18
