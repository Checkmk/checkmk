...
def stormshield_scan_function(oid):
    return oid(".1.3.6.1.2.1.1.2.0").startswith(".1.3.6.1.4.1.8072") and oid(
        ".1.3.6.1.4.1.11256.1.0.1.0"
    )
...
def stormshield_cluster_scan_function(oid):
    ...
    return oid(".1.3.6.1.2.1.1.2.0").startswith(".1.3.6.1.4.1.8072.3.2.8") and oid(
