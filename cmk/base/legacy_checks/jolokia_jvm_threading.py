...
def discover_jolokia_jvm_threading(section: Section) -> Iterator[tuple[str, dict]]:
...
def discover_jolokia_jvm_threading_pool(section: Section) -> Iterator[tuple[str, dict]]:
