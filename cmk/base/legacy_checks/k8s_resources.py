...
from cmk.base.check_api import check_levels, get_bytes_human_readable, get_percent_human_readable
...
check_info["k8s_resources.memory"] = {
    "discovery_function": get_k8s_resources_inventory_function("memory"),
