...
register.snmp_section(
    ...
    parse_function=lambda string_table: parse_ciena_health(_REFERENCES_5142, string_table),
    fetch=[
        SNMPTree(
...
register.snmp_section(
    ...
    parsed_section_name="ciena_health",
    parse_function=lambda string_table: parse_ciena_health(_REFERENCES_5171, string_table),
    fetch=[
        SNMPTree(
