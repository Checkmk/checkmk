...
from numpy import errstate, inf, log10
...
def _micro_watt_to_dBm(m_w: int) -> float:
    # values where m_w = 0 are handled later, here we simply suppress the warning issued by numpy
    # via the python warnings module.
