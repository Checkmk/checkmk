...
register.snmp_section(
    name="enviromux_sems_external",
    parse_function=parse_enviromux,
    fetch=SNMPTree(
        base=".1.3.6.1.4.1.3699.1.1.2.1.5.1.1",
        oids=[
            "1",  # extSensorIndex
            "2",  # extSensorType
...
#   '----------------------------------------------------------------------'
register.check_plugin(
    name="enviromux_sems_external_voltage",
    sections=["enviromux_sems_external"],
    service_name="Sensor External %s",
...
register.check_plugin(
    name="enviromux_sems_external_humidity",
    sections=["enviromux_sems_external"],
    service_name="Sensor External %s",
