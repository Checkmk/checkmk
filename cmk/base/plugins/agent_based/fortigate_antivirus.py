...
#[...]
#.1.3.6.1.4.1.12356.101.8.2.1.1.1.102 1
#.1.3.6.1.4.1.12356.101.8.2.1.1.1.103 2
#.1.3.6.1.4.1.12356.101.8.2.1.1.1.104 3
#.1.3.6.1.4.1.12356.101.8.2.1.1.1.105 4
#.1.3.6.1.4.1.12356.101.8.2.1.1.1.106 5
#.1.3.6.1.4.1.12356.101.8.2.1.1.2.102 11
#.1.3.6.1.4.1.12356.101.8.2.1.1.2.103 22
#.1.3.6.1.4.1.12356.101.8.2.1.1.2.104 33
#.1.3.6.1.4.1.12356.101.8.2.1.1.2.105 44
#.1.3.6.1.4.1.12356.101.8.2.1.1.2.106 55
#[...]

#Example GUI Output:
#OK	FortiGate AntiVirus Info: 0
#       Average amount of Viruses in last 5 Min.: detected: 0.00, blocked: 0.00
...
def check_fortigate_antivirus(item: str, params: Mapping[str, Tuple[float, float]],
    ...
    yield from check_levels(detected_rate,
                            ...
                            metric_name="fortigate_antivirus_detected_5min",
                            label="Average amount of Viruses in last 5 Min.",
                            render_func=lambda v: "detected: %.2f, blocked: %.2f " %
                            (detected_rate, blocked_rate))
    yield Metric("fortigate_antivirus_blocked_5min", blocked_rate)
