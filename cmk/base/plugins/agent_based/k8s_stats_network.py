...
def _check__k8s_stats_network__proxy_results(
    ...
    Metric('in', 0.0, levels=(None, None), boundaries=(None, None))
    Result(state=<State.OK: 0>, summary='Out: 0.00 Bit/s', details='Out: 0.00 Bit/s')
    Metric('out', 0.0, levels=(None, None), boundaries=(None, None))
    Metric('if_in_pkts', 0.0, levels=(None, None), boundaries=(None, None))
    Metric('if_in_errors', 0.0, levels=(None, None), boundaries=(None, None))
    Result(state=<State.OK: 0>, summary='Input error rate: 0.00/s', details='Input error rate: 0.00/s')
    Metric('if_out_pkts', 0.0, levels=(None, None), boundaries=(None, None))
    Metric('if_out_errors', 0.0, levels=(None, None), boundaries=(None, None))
    ...
    Metric('if_in_discards', 0.0, levels=(None, None), boundaries=(None, None))
    Result(state=<State.OK: 0>, summary='Output Discards: 0.00/s', details='Output Discards: 0.00/s')
    Metric('if_out_discards', 0.0, levels=(None, None), boundaries=(None, None))
    """
