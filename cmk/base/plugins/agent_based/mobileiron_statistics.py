...
def check_mobileiron_sourcehost(
    ...
    yield Metric(name="mobileiron_devices_total", value=section.total_count)
    ...
    yield from check_levels(
        label=f"Number of non-compliant devices: {section.non_compliant} out of {section.total_count}",
