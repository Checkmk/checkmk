...
class Params(TypedDict):
    read_attached_latency_s: tuple[float, float]
    read_recovery_latency_s: tuple[float, float]
    write_latency_s: tuple[float, float]
    log_latency_s: tuple[float, float]
...
register.agent_section(name="msexch_database", parse_function=parse_msexch_database)
