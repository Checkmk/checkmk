...
from cmk.base.plugins.agent_based.utils.filerdisks import (
    check_filer_disks,
...
def parse_netapp_ontap_disk(string_table: StringTable) -> Section:
    return [models.DiskModel(**json.loads(line[0])) for line in string_table]
...
register.inventory_plugin(name="netapp_ontap_disk", inventory_function=inventory_netapp_ontap_disk)
