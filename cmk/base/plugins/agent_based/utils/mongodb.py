...
def parse_date(date: Union[float, str]) -> float:
    """
    ...
    In legacy mode, $date is a unix timestamp, while in relaxed mode, it is an ISO-8601 date string,
    see
    ...
    1659317407.827
    """
    return dateutil_parser.isoparse(date).timestamp() if isinstance(date, str) else date
