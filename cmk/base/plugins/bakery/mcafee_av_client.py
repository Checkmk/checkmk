...
def get_mcafee_av_client_files(conf: Mapping[str, object]) -> FileGenerator:
    ...
    yield Plugin(base_os=OS.WINDOWS, source=Path("mcafee_av_client.bat"), interval=interval)
