...
def get_windows_broadcom_bonding_files(conf: Mapping[str, object]) -> FileGenerator:
    ...
    yield Plugin(base_os=OS.WINDOWS, source=Path("windows_broadcom_bonding.bat"), interval=interval)
