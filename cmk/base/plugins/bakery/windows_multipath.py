...
def get_windows_multipath_files(conf: Mapping[str, object]) -> FileGenerator:
    ...
    yield Plugin(base_os=OS.WINDOWS, source=Path("windows_multipath.ps1"), interval=interval)
