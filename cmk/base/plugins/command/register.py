...
from cmk_commands.v1 import ActiveCheckCommand  # pylint: disable=cmk-module-layer-violation
...
def load_active_checks() -> list[str]:
    errors = []
    for plugin, exception_or_module in load_plugins("cmk.base.plugins.command.active_checks"):
