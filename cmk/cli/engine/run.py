...
def run(omd_root: Path, argv: Sequence[str], environ: Mapping[str, str]) -> int:
    ...
    try:
        ...
        if e.errno == errno.EPIPE:
            ...
            return 4
        crash = _generate_crash_report(omd_root, argv, environ)
        crash.save()
        ...
        profiling.output_profile(omd_root / "var/check_mk/web")
