...
active_checks = locals().setdefault('active_checks', {})
...
agent_config = locals().setdefault('agent_config', {})
...
extra_host_conf = locals().setdefault('extra_host_conf', {})
...
extra_service_conf = locals().setdefault('extra_service_conf', {})
...
notification_parameters = locals().setdefault('notification_parameters', {})
...
special_agents = locals().setdefault('special_agents', {})
...
static_checks = locals().setdefault('static_checks', {})
