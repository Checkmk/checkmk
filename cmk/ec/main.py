...
class EventCreator:
    ...
    def _parse_rfc5424_syslog_info(self, line: str) -> Event:
        event: Event = {}
    ...
    def _parse_syslog_info(self, line: str) -> Event:
        event: Event = {}
    ...
    def _parse_monitoring_info(self, line: str) -> Event:
        event: Event = {}
        # line starts with '@'
        if line[11] == ';':
    ...
    def create_event_from_trap(self, trap: List[Tuple[str, Any]], ipaddress: AnyStr) -> Event:
