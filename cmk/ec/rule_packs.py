...
def load_config(paths: Paths, apply_binding: bool = True) -> ConfigFromWATO:
...
def load_rule_packs(paths: Paths, apply_binding: bool = True) -> Sequence[ECRulePack]:
    ...
    """
    return load_config(paths, apply_binding=apply_binding)["rule_packs"]
