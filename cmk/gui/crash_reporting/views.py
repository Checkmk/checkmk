...
FilterCrashServiceDescription = FilterCrashText(
    title="Crash Service Description",
    ident="crash_service_description",
    sort_index=130,
)
FilterCrashCheckName = FilterCrashText(
    title="Crash Check Name", ident="crash_check_type", sort_index=140
)
