...
class TransformForLegacyData(FormSpec[object]):
    ...
    suitable for the FormSpecs. It should only be used for legacy reasons if the old data
    format cannot be cleaned up within a reasonable time.
