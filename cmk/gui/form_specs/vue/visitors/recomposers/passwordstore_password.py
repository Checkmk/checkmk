...
from cmk.gui.form_specs.private import PasswordStorePassword, SingleChoiceEditable
from cmk.gui.form_specs.vue.visitors._type_defs import DefaultValue

from cmk.rulesets.v1.form_specs import FormSpec
from cmk.shared_typing.configuration_entity import ConfigEntityType


def _password_disk_to_ui(value: object) -> str | None:
    match value:
        case DefaultValue():
            return None
        case ("cmk_postprocessed", "stored_password", (str(pw_id), "")):
            return pw_id
        case _:
            raise MKGeneralException("Could not read stored password configuration")
