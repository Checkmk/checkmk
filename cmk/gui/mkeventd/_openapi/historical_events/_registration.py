...
def register(
    ...
    *,
    ...
    endpoint_family_registry.register(HISTORICAL_EVENTS_FAMILY, ignore_duplicates=ignore_duplicates)
    versioned_endpoint_registry.register(
        ENDPOINT_SHOW_HISTORICAL_EVENT,
        ignore_duplicates=ignore_duplicates,
    )
    versioned_endpoint_registry.register(
        ENDPOINT_LIST_HISTORICAL_EVENTS,
        ignore_duplicates=ignore_duplicates,
    )
