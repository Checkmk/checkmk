    ...
    def from_domain(cls, host: Host, *, site_alias: str, customer: str | None) -> Self:
        ...
        return cls(
            ...
            service_counts=ServiceCounts(
                total=read(host.num_services, "num_services"),
                ok=read(host.num_services_ok, "num_services_ok"),
                warn=read(host.num_services_warn, "num_services_warn"),
                crit=read(host.num_services_crit, "num_services_crit"),
                unknown=read(host.num_services_unknown, "num_services_unknown"),
                pending=read(host.num_services_pending, "num_services_pending"),
            ),
