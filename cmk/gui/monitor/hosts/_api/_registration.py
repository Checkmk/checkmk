...
from ._events import ENDPOINT_GET_HOST_EVENTS
...
def register_endpoints(
    ...
    versioned_endpoint_registry.register(ENDPOINT_GET_HOST_ACTION_MENU)
    versioned_endpoint_registry.register(ENDPOINT_GET_HOST_EVENTS)
