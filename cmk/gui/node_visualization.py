...
multisite_builtin_views.update(
    {
        ...
        "bi_map_hover_host": {
            ...
            "column_headers": "pergroup",
            "datasource": "hosts",
            "description": _l("Host tooltip shown in BI visualization"),
            "hidden": True,
            "hidebutton": True,
            "group_painters": [],
            "icon": None,
        ...
        "bi_map_hover_service": {
            ...
            "column_headers": "pergroup",
            "datasource": "services",
            "description": _l("Service tooltip shown in BI visualization"),
            "hidden": True,
            "hidebutton": True,
            "group_painters": [],
            "icon": None,
        ...
        "topology_hover_host": {
            ...
            "column_headers": "pergroup",
            "datasource": "hosts",
            "description": _l("Host tooltip shown in topolgoy visualization"),
            "hidden": True,
            "hidebutton": True,
            "group_painters": [],
            "icon": None,
