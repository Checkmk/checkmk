...
from cmk.gui.graphing._rrd import fetch_metric_name_mapping
...
from .models.response_models import MetricNameMappingResponse
...
def translate_metric_names_v1(body: TranslateMetricNamesRequest) -> MetricNameMappingResponse:
    ...
    try:
        per_service = fetch_metric_name_mapping(
            HostName(body.hostname),
            ServiceName(body.service_description),
            check_metrics,
            site_id=body.site,
