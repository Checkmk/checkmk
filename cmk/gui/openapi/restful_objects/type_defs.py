...
CmkEndpointName = Literal[
    ...
    "cmk/list_maps_aggregations",
    "cmk/list_maps_dyngroup_members",
    "cmk/list_maps_folders",
    "cmk/list_maps_group_members",
    "cmk/list_maps_images",
    "cmk/list_maps_objects",
    "cmk/list_maps_sites",
    "cmk/move",
    "cmk/parse_maps_cfg",
    "cmk/parse_maps_form",
    "cmk/permalink",
    "cmk/rename",
    "cmk/run_maps_command",
    "cmk/show",
    "cmk/show_dashboard_relative_grid",
    "cmk/show_maps_aggregation_states",
    "cmk/show_maps_aggregation_tree",
    "cmk/show_maps_authoring_settings",
    "cmk/show_maps_form_schema",
    "cmk/show_maps_host_geo",
    "cmk/show_maps_image_usage",
    "cmk/show_maps_metric_info",
    "cmk/show_maps_perf_metrics",
    "cmk/show_maps_ticket",
    "cmk/show_dashboard_responsive_grid",
    "cmk/show_site_global_setting",
    "cmk/sign",
    "cmk/start",
    "cmk/translate_metric_names",
    "cmk/upload_maps_background",
    "cmk/host_config",
    "cmk/folder_config",
    "cmk/global_config",
    "cmk/delete_bi_rule",
