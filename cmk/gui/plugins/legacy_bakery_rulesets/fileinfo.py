...
def _valuespec_agent_config_fileinfo() -> ListOfStrings:
    return ListOfStrings(
        ...
        help=_(
            ...
            "<tt>C:\\foo\\*.log</tt> or <tt>/var/*/*.log</tt> here. Per default each file found "
            ...
            "<b>all</b> matching rules will be used for defining the pattern - not just the"
            " first one.</p>"
            ...
            " date command. Example: $DATE:%Y%m%d$ is today's date, in the format YYYYMMDD. "
            "Using this option, the agent will only send files containing the current date. "
            "Date variables can be used together with the rules 'File grouping patterns and size', "
            "'age and count of file groups to monitor' if files are created in a directory "
