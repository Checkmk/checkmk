...
def _form_spec_agent_config_win_license() -> Dictionary:
    return Dictionary(
        help_text=Help("This plug-in checks for Windows License status."),
        elements={
...
rule_spec_win_license = AgentConfig(
    title=Title("Windows License"),
    name="win_license",
    topic=Topic.WINDOWS,
    parameter_form=_form_spec_agent_config_win_license,
)
