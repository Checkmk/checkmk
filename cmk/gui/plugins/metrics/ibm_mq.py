...
metric_info["lgetage"] = {
    "title": _("Age of last get"),
    "help": _("How long ago the last message was retrieved from the queue."),
    "unit": "s",
    "color": "#0da317",
}

metric_info["lputage"] = {
    "title": _("Age of last put"),
    "help": _("How long ago the last message was put on the queue."),
    "unit": "s",
    "color": "#4287f5",
}
...
graph_info["ibm_mq_queue_last_access_age"] = {
    "title": _("Age of last get/put"),
    "metrics": [
        ("lgetage", "line"),
        ("lputage", "line"),
    ],
