...
from cmk.gui.plugins.openapi.endpoints.autocomplete.request_schemas import RequestSchema
from cmk.gui.plugins.openapi.endpoints.autocomplete.response_schemas import ResponseSchema
