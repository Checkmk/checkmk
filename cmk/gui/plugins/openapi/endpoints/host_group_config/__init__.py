...
from cmk.gui.plugins.openapi.endpoints.host_group_config.request_schemas import (
    BulkDeleteHostGroup,
    BulkInputHostGroup,
    BulkUpdateHostGroup,
    InputHostGroup,
...
from cmk.gui.plugins.openapi.endpoints.host_group_config.response_schemas import (
    HostGroup,
    HostGroupCollection,
)
