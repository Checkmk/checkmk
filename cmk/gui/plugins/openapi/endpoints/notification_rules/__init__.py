...
from cmk.gui.plugins.openapi.endpoints.notification_rules.request_schemas import (
    NotificationRuleRequest,
)
from cmk.gui.plugins.openapi.endpoints.notification_rules.response_schemas import (
