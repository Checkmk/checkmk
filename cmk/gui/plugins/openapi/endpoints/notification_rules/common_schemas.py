...
class PluginWithCustomParams(PluginOption):
    plugin_params = Raw(
        metadata={
            "required": True,
            "description": "3rd party plugin parameters",
            "example": {"plugin_name": "plugin_a", "params": ["param1", "param2", "param3"]},
        }
    )
...
class PluginOptionsSelector(OneOfSchema):
    ...
    type_schemas = {
        ...
        "create_notification_with_the_following_custom_parameters": PluginWithCustomParams,
    }
