...
from cmk.utils.type_defs import RuleOptions, RuleOptionsSpec
...
from cmk.gui.watolib.rulesets import RuleConditions, RulesetCollection
...
def edit_rule(param):
    ...
    folder: watolib.CREFolder = rule_entry.folder
    folder.need_permission("write")
...
def _retrieve_from_rulesets(rulesets: RulesetCollection, ruleset_name: str) -> watolib.Ruleset:
