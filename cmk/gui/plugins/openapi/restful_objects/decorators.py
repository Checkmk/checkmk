...
from cmk.gui.watolib.activate_changes import update_config_generation as activate_changes_update_config_generation
            ...
            try:
                if query_schema:
                    param.update(query_schema().load(
                        _filter_profile_headers(_from_multi_dict(request.args))))
