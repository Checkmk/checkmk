...
inventory_displayhints.update({
    ...
    ".hardware.storage.logical_volumes:*.logical_volume_name": { "title" : _("Logical Volume Name")},
    ".hardware.storage.logical_volumes:*.volume_group_state": { "title" : _("Volume Group State")},
    ".hardware.storage.logical_volumes:*.disc_type": { "title" : _("Disc Type")},
    ".hardware.storage.logical_volumes:*.logical_partitions": { "title" : _("# Logical Partitions")},
    ".hardware.storage.logical_volumes:*.physical_partitions": { "title" : _("# Physical Partitions")},
    ".hardware.storage.logical_volumes:*.physical_volumes": { "title" : _("# Physical Volumes")},
    ".hardware.storage.logical_volumes:*.state": { "title" : _("State")},
    ".hardware.storage.logical_volumes:*.mount_point": { "title" : _("Mount Point")},
