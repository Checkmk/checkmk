...
multisite_builtin_views["ec_events"] = mkeventd_view(
    {
        ...
        "painters": [
            PainterSpec(
                painter_name="event_id",
                link_spec=VisualLinkSpec(type_name="views", name="ec_event"),
            ),
            PainterSpec(painter_name="event_icons"),
            PainterSpec(painter_name="event_state"),
            PainterSpec(painter_name="event_sl"),
            PainterSpec(
                painter_name="event_host",
                link_spec=VisualLinkSpec(type_name="views", name="ec_events_of_host"),
            ),
            PainterSpec(painter_name="event_rule_id"),
            PainterSpec(painter_name="event_application"),
            PainterSpec(painter_name="event_text"),
            PainterSpec(painter_name="event_last"),
            PainterSpec(painter_name="event_count"),
        ],
        "is_show_more": True,
        "owner": "",
        "name": "ec_events",
...
multisite_builtin_views["ec_event"] = mkeventd_view(
    {
        ...
        "painters": [
            PainterSpec(painter_name="event_state"),
            PainterSpec(painter_name="event_host"),
            PainterSpec(painter_name="event_ipaddress"),
            PainterSpec(painter_name="foobar"),
            PainterSpec(
                painter_name="alias",
            ...
            PainterSpec(painter_name="event_text"),
            PainterSpec(painter_name="event_match_groups"),
            PainterSpec(painter_name="event_comment"),
            PainterSpec(painter_name="event_owner"),
            PainterSpec(painter_name="event_first"),
            PainterSpec(painter_name="event_last"),
            PainterSpec(painter_name="event_id"),
            PainterSpec(painter_name="event_icons"),
            PainterSpec(painter_name="event_count"),
            PainterSpec(painter_name="event_sl"),
            PainterSpec(painter_name="event_contact"),
            PainterSpec(painter_name="event_effective_contact_groups"),
            PainterSpec(painter_name="event_application"),
            PainterSpec(painter_name="event_pid"),
            PainterSpec(painter_name="event_priority"),
            PainterSpec(painter_name="event_facility"),
            PainterSpec(painter_name="event_rule_id"),
            PainterSpec(painter_name="event_phase"),
            PainterSpec(painter_name="host_services"),
        ],
        "owner": "",
        "name": "ec_event",
        "single_infos": ["event"],
...
multisite_builtin_views["ec_history_recent"] = mkeventd_view(
    {
        ...
        "layout": "table",
        "painters": [
            PainterSpec(painter_name="history_time"),
            PainterSpec(
                painter_name="event_id",
                link_spec=VisualLinkSpec(type_name="views", name="ec_historyentry"),
            ),
            PainterSpec(painter_name="history_who"),
            PainterSpec(painter_name="history_what"),
            PainterSpec(painter_name="event_history_icons"),
            PainterSpec(painter_name="event_state"),
            PainterSpec(painter_name="event_phase"),
            PainterSpec(painter_name="event_sl"),
            PainterSpec(
...
multisite_builtin_views["ec_historyentry"] = mkeventd_view(
    {
        ...
        "painters": [
            PainterSpec(painter_name="history_time"),
            PainterSpec(painter_name="history_line"),
            PainterSpec(painter_name="history_what"),
            PainterSpec(painter_name="history_what_explained"),
            PainterSpec(painter_name="history_who"),
            PainterSpec(painter_name="history_addinfo"),
            PainterSpec(painter_name="event_state"),
            PainterSpec(
                painter_name="event_host",
                link_spec=VisualLinkSpec(type_name="views", name="ec_history_of_host"),
