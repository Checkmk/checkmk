...
def mobile_view(d: dict[str, Any]) -> ViewSpec:
    x = {
        "mobile": True,
        "browser_reload": 0,
        ...
        "mobile_service": mobile_view(
            {
                ...
                "painters": [
                    ...
                    PainterSpec(painter_name="service_description"),
                    PainterSpec(painter_name="svc_plugin_output"),
                    PainterSpec(painter_name="service_state"),
                    PainterSpec(painter_name="svc_state_age"),
                    ...
                    PainterSpec(painter_name="svc_check_type"),
        ...
        "mobile_hoststatus": mobile_view(
            {
                ...
                "painters": [
                    ...
                    PainterSpec(painter_name="host_check_type"),
                ...
                "painters": [
                    ...
                    PainterSpec(
                        ...
                        link_spec=VisualLinkSpec(
                            type_name="views", name="mobile_hostsvcnotifications"
                        ),
                    ),
                    PainterSpec(
                        painter_name="service_description",
        ...
        "mobile_hostsvcevents": mobile_view(
            {
                ...
                "painters": [
                    ...
                    PainterSpec(painter_name="log_state_type"),
                    PainterSpec(painter_name="log_plugin_output"),
                ],
                "sorters": [("log_time", False), ("log_lineno", False)],
