...
def _valuespec_active_checks_tcp() -> Migrate:
    return Migrate(
        migrate=lambda p: p if isinstance(p, dict) else {"port": p[0], **p[1]},
            ...
            elements=[
                ...
                (
                    ...
                    TextInput(
                        ...
                        help=_("String to send server to initiate a clean close of the connection"),
                        size=30,
                    ),
                ),
            ],
