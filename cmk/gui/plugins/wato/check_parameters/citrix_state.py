    ...
    return Dictionary(
        elements=[
            (
                ...
                "vmtoolsstate",
                Dictionary(
                    title=_("Interpretation of vmtoolsstate States"),
                    elements=[
                        ("NotPresent", MonitoringState(title=_("NotPresent"), default_value=2)),
                        ("Unknown", MonitoringState(title=_("Unknown"), default_value=3)),
                        ("NotStarted", MonitoringState(title=_("NotStarted"), default_value=2)),
                        ("Running", MonitoringState(title=_("Running"), default_value=1)),
                    ],
                    optional_keys=False,
                ),
            )
