        ...
        valuespec=Dictionary(
            ...
            elements=[
                ...
                (
                    ...
                    MonitoringState(
                        title="State when service checks are disabled", default_value=2
                    ),
                ),
                (
                ...
                (
                    ...
                    MonitoringState(
                        title="State when not checking host freshness", default_value=2
                    ),
                ),
                (
                    "check_service_freshness",
                    MonitoringState(
                        title="State when not checking service freshness", default_value=2
                    ),
                ),
                (
                    "enable_event_handlers",
                    MonitoringState(
                        title="State when event handlers are disabled", default_value=0
                    ),
                ),
                (
                ...
                (
                    ...
                    MonitoringState(
                        title="State when performance data is disabled", default_value=1
                    ),
                ),
                (
                    "check_external_commands",
                    MonitoringState(
                        title="State when not checking external commands", default_value=2
                    ),
                ),
                (
                    "site_cert_days",
