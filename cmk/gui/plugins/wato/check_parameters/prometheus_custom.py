            ...
            (
                ...
                ListOf(
                    ...
                    help=_(
                        ...
                        "Prometheus custom check can be defined at two places: in the Prometheus "
                        "data source rule and here. The rule set here always has priority over the "
                        "levels defined in the data source rule."
                    ),
                ),
            ),
        ],
