...
from cmk.gui.valuespec import Checkbox, Dictionary, ListOf, MonitoringState, TextInput
        ...
        elements=[
            (
                ...
                Checkbox(
                    ...
                    help=_(
                        "Decides whether 'Disabled' tasks should be ignored or discovered as individual services."
                    ),
                ),
            )
        ],
