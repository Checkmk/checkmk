...
class NotificationParameterJIRA_ISSUES(NotificationParameter):
    ...
    def spec(self):
        return Dictionary(
            title=_("Create notification with the following parameters"),
            optional_keys=[
                'site_customid', 'priority', 'resolution', 'host_summary', 'service_summary',
...
class NotificationParameterServiceNow(NotificationParameter):
            ...
            elements=[
                ...
                ("mgmt_type",
                 CascadingDropdown(
                     ...
                     help=_("With ServiceNow you can create different "
            ...
            elements=[
                ...
                ("host_desc",
                 self._host_desc(
                     ...
                     help_text=_("Text that should be set in field <tt>Description</tt> "
            ...
            elements=[
                ...
                ("host_desc",
                 self._host_desc(
                     ...
                     help_text=_("Text that should be set in field <tt>Resolution notes</tt> "
                ...
                ("priority",
                 DropdownChoice(
                     title=_("Priority"),
                     help=_("Here you can define with which priority the case "
                            "should be created."),
                     choices=[
                         ("low", _("Low")),
                         ("moderate", _("Moderate")),
    ...
    def _host_desc(self, title: str, help_text: str) -> TextAreaUnicode:
        return TextAreaUnicode(title=title,
                               help=help_text,
                               rows=7,
                               cols=58,
                               monospaced=True,
...
""")
    ...
    def _recovery_state_vs(self, issue_type: str) -> Dictionary:
        return Dictionary(
            ...
            help=_("Here you can define the state of the %s in case of a recovery "
                   "of the affected host or service problem.") % issue_type,
            elements=[
                (
                    "start",
                    Transform(
                        Alternative(
                            ...
                            elements=[
                                DropdownChoice(
                                    ...
                                    help=_("Please note that the mapping to the numeric "
                                           "ServiceNow state may be changed at your system "
                                           "and can differ from our definitions. In this case "
                                           "use the option below."),
