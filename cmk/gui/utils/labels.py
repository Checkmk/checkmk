...
class LabelsCache:
    ...
    def _livestatus_get_labels(
            self,
            only_sites: List[SiteId]) -> Tuple[Mapping[SiteId, _Labels], Mapping[SiteId, _Labels]]:
    ...
    def _collect_labels_from_livestatus_rows(
        ...
        for site_id, host_labels, service_labels in rows:
            ...
            all_host_labels.setdefault(site_id,
                                       {}).update(self._serialize_labels(all_site_host_labels))
