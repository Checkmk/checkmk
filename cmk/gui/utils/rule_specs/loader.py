...
def load_api_v1_rule_specs(
    ...
    if not_yet_moved_plugins := (
        ...
        "cmk.gui.plugins.wato.check_parameters.checkpoint_vsx_packets",
        "cmk.gui.plugins.wato.check_parameters.checkpoint_vsx_traffic",
        "cmk.gui.plugins.wato.check_parameters.checkpoint_vsx_connections",
    ):
