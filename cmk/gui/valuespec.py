...
class CascadingDropdown(ValueSpec):
    ...
    def _choice_from_ident(
            self, ident: CascadingDropdownChoiceIdent) -> _Optional[CascadingDropdownCleanChoice]:
        try:
    ...
    def _choice_from_value(
            self, value: CascadingDropdownChoiceValue) -> _Optional[CascadingDropdownCleanChoice]:
...
class Optional(ValueSpec):
    ...
    def __init__(  # pylint: disable=redefined-builtin
        ...
        # FIXME: Any is really problematic here since and makes it impossible to implement
        # e.g. the value_to/from_json functions correctly.
        none_value: Any = None,
        sameline: bool = False,
        indent: bool = True,
        allow_empty: bool = True,
...
class ValueEncrypter:
    ...
    def decrypt(value: str) -> str:
        ...
        return ValueEncrypter._cipher(salt, nonce).decrypt_and_verify(encrypted,
                                                                      tag).decode("utf-8")
    ...
    def render_popup_input(self, varprefix, value):
        ...
        for category_name, category_alias, icons in available_icons:
            ...
            for icon in empty + sorted(icons):
                ...
                icon_path = (html.detect_icon_path(icon, prefix="emblem_")
