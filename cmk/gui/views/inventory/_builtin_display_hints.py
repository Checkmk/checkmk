...
def register(inventory_displayhints: InventoryHintRegistry) -> None:
    inventory_displayhints.update({
        ...
        # MIGRATED ".software.packages:": {
        # MIGRATED     "title": _l("Software packages"),
        # MIGRATED     "icon": "packages",
        # MIGRATED     "keyorder": [
        # MIGRATED         "name",
        # MIGRATED         "arch",
        # MIGRATED         "package_type",
        # MIGRATED         "summary",
        # MIGRATED         "version",
        # MIGRATED         "vendor",
        # MIGRATED         "package_version",
        # MIGRATED         "install_date",
        # MIGRATED         "size",
        # MIGRATED         "path",
        # MIGRATED     ],
        # MIGRATED     "view": "invswpac",
        # MIGRATED     "is_show_more": False,
        # MIGRATED },
        # MIGRATED ".software.packages:*.name": {"title": _l("Name")},
        # MIGRATED ".software.packages:*.arch": {"title": _l("Architecture")},
        # MIGRATED ".software.packages:*.package_type": {"title": _l("Type")},
        # MIGRATED ".software.packages:*.summary": {"title": _l("Description")},
        # MIGRATED ".software.packages:*.version": {
        # MIGRATED     "title": _l("Version"),
        # MIGRATED     "sort": cmp_version,
        # MIGRATED     "filter": FilterInvtableVersion,
        # MIGRATED },
        # MIGRATED ".software.packages:*.vendor": {"title": _l("Publisher")},
        # MIGRATED ".software.packages:*.package_version": {
        # MIGRATED     "title": _l("Package version"),
        # MIGRATED     "sort": cmp_version,
        # MIGRATED     "filter": FilterInvtableVersion,
        # MIGRATED },
        # MIGRATED ".software.packages:*.install_date": {"title": _l("Install date"), "paint": "date"},
        # MIGRATED ".software.packages:*.size": {"title": _l("Size"), "paint": "count"},
        # MIGRATED ".software.packages:*.path": {"title": _l("Path")},
        # MIGRATED ".networking.": {
