...
class ACTestLivestatusUsage(ACTest):
    ...
    def help(self) -> str:
        return _(
            ...
            "Livestatus is reliable and performant.</p><p>There "
            "should always be enough free Livestatus slots to serve new "
            "incoming queries.</p>"
...
class ACTestCheckMKFetcherUsage(ACTest):
    ...
    def help(self) -> str:
        return _(
            ...
            "problem is that the Checkmk are initialized in parallel during startup "
            "of the Checkmk Micro Core, which may cause load peaks when having "
            "a lot of Checkmk helper processes configured.</p>"
        )
