...
def notification_macro_help() -> str:
    return _(
        ...
        "<li><tt>$SERVICEDESC$</tt></li>"
        "<li><tt>$SERVICESHORTSTATE$</tt></li>"
        "<li><tt>$SERVICEOUTPUT$</tt></li>"
        "<li><tt>$LONGSERVICEOUTPUT$</tt></li>"
        "<li><tt>$SERVICEPERFDATA$</tt></li>"
        "<li><tt>$EVENT_TXT$</tt></li>"
        "</ul>"
    )
