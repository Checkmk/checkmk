...
from cmk.gui.form_specs.private import CommentTextArea, not_empty
                            ...
                            + [
                                CascadingSingleChoiceElement(
                                    ...
                                    parameter_form=SingleChoice(
                                        elements=[
                                            SingleChoiceElement(name=name, title=Title(title))  # pylint: disable=localization-of-non-literal-string
...
def save_password_from_slidein_schema(data: object, *, user: LoggedInUser) -> PasswordDescription:
