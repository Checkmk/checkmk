...
from cmk.gui.form_specs import DefaultValue
...
from cmk.gui.form_specs.unstable import Topic as TopicExtended
    ...
    def registration_hook(self, instance: NotificationParameter | NotificationParameters) -> None:
        ...
        if plugin.form_spec is None:
            ...
            loaded_rulespec = NotificationParameters(
                title=Title("%(title)s") % {"title": notification_script_title(plugin.ident)},
                name=plugin.ident,
                        ...
                        elements={
                            ...
                            "docu_url": TopicElement(
                                ...
                                parameter_form=String(
                                    ...
                                    help_text=Help(
                                        "An optional URL pointing to the documentation or any other page. "
                                        "It will be displayed as an icon and opens "
