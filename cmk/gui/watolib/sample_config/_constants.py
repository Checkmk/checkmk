...
PS_DISCOVERY_RULES: list[RuleSpec[Mapping[str, object]]] = [
    ...
    for id_, ps_name, match in [
        ...
        (
            "e7083f95-5ee1-4814-bdba-d7c1fbbff57d",
            "agent-engine",
            "~python3 /omd/sites/[^/]+/bin/uvicorn.*cmk\\.agent_engine\\.app:create_app",
        ),
        (
...
USE_NEW_DESCRIPTIONS_FOR_SETTING = {
    "use_new_descriptions_for": {
        "aix_memory": True,
        "barracuda_mailqueues": True,
        "brocade_sys_mem": True,
        "casa_cpu_temp": True,
        "cisco_mem": True,
        "cisco_mem_asa": True,
        "cisco_mem_asa64": True,
        "cmciii_psm_current": True,
        "cmciii_temp": True,
        "cmciii_lcp_airin": True,
        "cmciii_lcp_airout": True,
        "cmciii_lcp_water": True,
        "cmk_inventory": True,
        "db2_mem": True,
        "df": True,
        "df_netapp": True,
        "df_netapp32": True,
        "docker_container_mem": True,
        "enterasys_temp": True,
        "esx_vsphere_datastores": True,
        "esx_vsphere_hostsystem_mem_usage": True,
        "esx_vsphere_hostsystem_mem_usage_cluster": True,
        "etherbox_temp": True,
        "fortigate_memory": True,
        "fortigate_memory_base": True,
        "fortigate_node_memory": True,
        "hr_fs": True,
        "hr_mem": True,
        ...
        #  can be removed
        "http": True,
        "huawei_switch_mem": True,
        "hyperv_vms": True,
        "ibm_svc_mdiskgrp": True,
        "ibm_svc_system": True,
        "ibm_svc_systemstats_cache": True,
        "ibm_svc_systemstats_disk_latency": True,
        "ibm_svc_systemstats_diskio": True,
        "ibm_svc_systemstats_iops": True,
        "innovaphone_mem": True,
        "innovaphone_temp": True,
        "juniper_mem": True,
        "juniper_screenos_mem": True,
        "juniper_trpz_mem": True,
        "liebert_bat_temp": True,
        "logwatch": True,
        "logwatch_groups": True,
        "mem_used": True,
        "mem_win": True,
        "megaraid_bbu": True,
        "megaraid_pdisks": True,
        "megaraid_ldisks": True,
        "megaraid_vdisks": True,
        "mknotifyd": True,
        "mknotifyd_connection": True,
        "mssql_backup": True,
        "mssql_blocked_sessions": True,
        "mssql_counters_cache_hits": True,
        "mssql_counters_file_sizes": True,
        "mssql_counters_locks": True,
        "mssql_counters_locks_per_batch": True,
        "mssql_counters_pageactivity": True,
        "mssql_counters_sqlstats": True,
        "mssql_counters_transactions": True,
        "mssql_databases": True,
        "mssql_datafiles": True,
        ...
        "prism_alerts": True,
        "prism_containers": True,
        "prism_info": True,
        "prism_storage_pools": True,
        "nvidia_temp": True,
        "postfix_mailq": True,
        "ps": True,
        "qmail_stats": True,
        "raritan_emx": True,
        "raritan_pdu_inlet": True,
        "services": True,
        "solaris_mem": True,
        "sophos_memory": True,
        "statgrab_mem": True,
