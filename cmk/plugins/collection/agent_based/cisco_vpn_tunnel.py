...
def _parse_phase_2(table_phase_2: StringTable) -> Mapping[str, Phase]:
...
def parse_cisco_vpn_tunnel(string_table: Sequence[StringTable]) -> Section:
...
snmp_section_cisco_vpn_tunnel = SNMPSection(
...
check_plugin_cisco_vpn_tunnel = CheckPlugin(
    name="cisco_vpn_tunnel",
