...
_DEVICE_OIDS = (
    *CISCO_WLC_OIDS,
    ...
    ".1.3.6.1.4.1.9.1.2669",  # cisco WLC C9800-80-K9
...
def parse_cisco_wlc(string_table: Sequence[StringTable]) -> Section:
    """
...
snmp_section_cisco_wlc = SNMPSection(
    name="cisco_wlc",
    detect=_DETECT_SPEC,
...
check_plugin_cisco_wlc = CheckPlugin(
