...
def discover_cmciii_leakage(params: DiscoveryParams, section: Section) -> DiscoveryResult:
    yield from discover_cmciii_sensors("leakage", params, section)


def check_cmciii_leakage(item: str, params: CheckParams, section: Section) -> CheckResult:
...
check_plugin_cmciii_leakage = CheckPlugin(
    name="cmciii_leakage",
    sections=["cmciii"],
    service_name="%s",
