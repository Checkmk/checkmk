...
snmp_section_enviromux_aux = SimpleSNMPSection(
    name="enviromux_aux",
...
snmp_section_enviromux5_aux = SimpleSNMPSection(
    name="enviromux5_aux",
    parse_function=parse_enviromux,
    fetch=SNMPTree(
        base=".1.3.6.1.4.1.3699.1.1.10.1.4.1.1",
        oids=[
            "1",  # intSensorIndex
            "2",  # intSensorType
            "3",  # intSensorDescription
    ...
    parsed_section_name="enviromux_aux",
...
check_plugin_enviromux_aux = CheckPlugin(
    name="enviromux_aux",
...
#   |                                                                      |
#   '----------------------------------------------------------------------'
check_plugin_enviromux_aux_voltage = CheckPlugin(
...
check_plugin_enviromux_aux_humidity = CheckPlugin(
