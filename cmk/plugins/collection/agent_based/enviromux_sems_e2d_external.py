...
snmp_section_enviromux_sems_e2d_external = SimpleSNMPSection(
    name="enviromux_sems_e2d_external",
    parse_function=parse_enviromux,
    fetch=SNMPTree(
        base=".1.3.6.1.4.1.3699.1.1.9.1.5.1.1",
        oids=[
            "1",  # extSensorIndex
            "2",  # extSensorType
...
check_plugin_enviromux_sems_e2d_external = CheckPlugin(
    name="enviromux_sems_e2d_external",
...
#   |                                                                      |
#   '----------------------------------------------------------------------'
check_plugin_enviromux_sems_e2d_external_voltage = CheckPlugin(
    name="enviromux_sems_e2d_external_voltage",
    sections=["enviromux_sems_e2d_external"],
    service_name="Sensor External %s",
...
check_plugin_enviromux_sems_e2d_external_humidity = CheckPlugin(
    name="enviromux_sems_e2d_external_humidity",
    sections=["enviromux_sems_e2d_external"],
    service_name="Sensor External %s",
