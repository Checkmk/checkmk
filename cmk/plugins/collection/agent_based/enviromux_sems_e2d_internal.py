...
snmp_section_enviromux_sems_e2d = SimpleSNMPSection(
    name="enviromux_sems_e2d",
    parse_function=parse_enviromux,
    fetch=SNMPTree(
        base=".1.3.6.1.4.1.3699.1.1.9.1.4.1.1",
        oids=[
            "1",  # intSensorIndex
            "2",  # intSensorType
...
check_plugin_enviromux_sems_e2d = CheckPlugin(
    name="enviromux_sems_e2d",
...
#   |                                                                      |
#   '----------------------------------------------------------------------'
check_plugin_enviromux_sems_e2d_voltage = CheckPlugin(
    name="enviromux_sems_e2d_voltage",
    sections=["enviromux_sems_e2d"],
    service_name="Sensor %s",
...
check_plugin_enviromux_sems_e2d_humidity = CheckPlugin(
    name="enviromux_sems_e2d_humidity",
    sections=["enviromux_sems_e2d"],
    service_name="Sensor %s",
