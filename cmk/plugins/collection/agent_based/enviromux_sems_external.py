...
snmp_section_enviromux_sems_external = SimpleSNMPSection(
...
check_plugin_enviromux_sems_external = CheckPlugin(
    name="enviromux_sems_external",
...
#   |                                                                      |
#   '----------------------------------------------------------------------'
check_plugin_enviromux_sems_external_voltage = CheckPlugin(
...
check_plugin_enviromux_sems_external_humidity = CheckPlugin(
