...
snmp_section_fjdarye_thermal_sensors = SNMPSection(
    name="fjdarye_thermal_sensors",
    parse_function=parse_fjdarye_item,
    fetch=[
        SNMPTree(base=f"{device_oid}.2.11.2.1", oids=["1", "3"])
...
check_plugin_fjdarye_thermal_sensors = CheckPlugin(
    name="fjdarye_thermal_sensors",
    service_name="Thermal %s",
