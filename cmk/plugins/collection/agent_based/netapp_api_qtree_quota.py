...
def get_item_names(qtree: Qtree) -> tuple[str, str]:
...
agent_section_netapp_api_qtree_quota = AgentSection(
    name="netapp_api_qtree_quota", parse_function=parse_netapp_api_qtree_quota
)

check_plugin_netapp_api_qtree_quota = CheckPlugin(
