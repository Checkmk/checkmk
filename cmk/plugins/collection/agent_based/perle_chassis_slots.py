...
def parse_perle_chassis_slots(string_table: StringTable) -> Section:
    return string_table


snmp_section_perle_chassis_slots = SimpleSNMPSection(
    ...
    detect=DETECT_PERLE,
    parse_function=parse_perle_chassis_slots,
)
