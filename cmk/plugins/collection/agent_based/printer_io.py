...
def parse_printer_io(string_table: Sequence[StringTable]) -> Section:
    parsed: Section = {}
...
snmp_section_printer_input = SNMPSection(
    name="printer_input",
...
snmp_section_printer_output = SNMPSection(
    name="printer_output",
    detect=DETECT_PRINTER,
    parse_function=parse_printer_io,
    fetch=[
...
check_plugin_printer_input = CheckPlugin(
    name="printer_input",
...
check_plugin_printer_output = CheckPlugin(
    name="printer_output",
