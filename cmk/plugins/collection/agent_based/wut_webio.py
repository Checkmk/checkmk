...
def parse_wut_webio(string_table: Sequence[StringTable]) -> Section | None:
...
snmp_section_wut_webio = SNMPSection(
    name="wut_webio",
...
def discover_wut_webio(section: Section) -> DiscoveryResult:
    yield from [
...
check_plugin_wut_webio = CheckPlugin(
    name="wut_webio",
    service_name="W&T %s",
