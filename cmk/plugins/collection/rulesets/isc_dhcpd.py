...
def _valuespec_agent_config_isc_dhcpd() -> Dictionary:
    return Dictionary(
        help_text=Help(
            "The plug-in <tt>isc_dhcpd</tt> collects information about a DHCP server"
            " daemon on Linux."
        ),
        elements={
...
rule_spec_isc_dhcpd = AgentConfig(
    title=Title("ISC DHCP-Daemon (Linux)"),
    name="isc_dhcpd",
    topic=Topic.NETWORKING,
    parameter_form=_valuespec_agent_config_isc_dhcpd,
)
