...
def _valuespec_agent_config_kaspersky_av() -> Dictionary:
    return Dictionary(
        help_text=Help(
            "Deploy a plug-in for monitoring the quarantine queue, tasks and updates"
...
rule_spec_kaspersky_av = AgentConfig(
    title=Title("Kaspersky Anti-Virus (Linux)"),
    name="kaspersky_av",
    topic=Topic.APPLICATIONS,
    parameter_form=_valuespec_agent_config_kaspersky_av,
)
