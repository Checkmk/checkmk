...
def parse_entity_sensors(string_table: Sequence[StringTable]) -> EntitySensorSection:
    return utils.parse_entity_sensors(string_table)


snmp_section_entity_sensors = SNMPSection(
    name="entity_sensors",
    detect=any_of(
...
check_plugin_entity_sensors_temp = CheckPlugin(
...
check_plugin_entity_sensors_fan = CheckPlugin(
...
check_plugin_entity_sensors_power_presence = CheckPlugin(
