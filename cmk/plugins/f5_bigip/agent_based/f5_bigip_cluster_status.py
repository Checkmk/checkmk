...
snmp_section_f5_bigip_cluster_status = SNMPSection(
...
snmp_section_f5_bigip_cluster_status_v11_2 = SNMPSection(
...
def parse_f5_bigip_vcmpfailover(string_table: Sequence[StringTable]) -> NodeState | None:
    """Read a node status encoded as stringified int
...
snmp_section_f5_bigip_vcmpfailover = SNMPSection(
