...
snmp_section_fjdarye_expanders = SNMPSection(
    name="fjdarye_expanders",
    parse_function=parse_fjdarye_item,
    fetch=[
        SNMPTree(base=f"{device_oid}.2.8.2.1", oids=["1", "3"])
...
check_plugin_fjdarye_expanders = CheckPlugin(
    name="fjdarye_expanders",
    service_name="Expander %s",
