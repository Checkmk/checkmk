...
def _valuespec_agent_config_hyperv_vms() -> Dictionary:
    return Dictionary(
        help_text=Help("Deploy the agent plug-in <tt>hyperv_vms</tt> on your target system."),
        elements={
...
rule_spec_hyperv_vms = AgentConfig(
    title=Title("Hyper-V VMs (Windows)"),
    name="hyperv_vms",
    topic=Topic.VIRTUALIZATION,
    parameter_form=_valuespec_agent_config_hyperv_vms,
)
