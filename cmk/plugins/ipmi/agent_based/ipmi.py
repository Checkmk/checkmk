...
def parse_ipmi(string_table: StringTable) -> ipmi.Section:
    """
...
agent_section_ipmi = AgentSection(
    name="ipmi",
    parse_function=parse_ipmi,
)

agent_section_ipmi_discrete = AgentSection(
    name="ipmi_discrete",
    parse_function=parse_ipmi,
)
