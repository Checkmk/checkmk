...
def _form_spec_agent_config_mailman_lists() -> Dictionary:
    return Dictionary(
        help_text=Help(
            "The plug-in <tt>mailman3_lists</tt> (Mailman 3) monitors Mailman mailing lists."
        ),
        elements={
...
rule_spec_mailman_lists = AgentConfig(
    title=Title("Mailman mailing lists (Linux)"),
    name="mailman_lists",
    topic=Topic.APPLICATIONS,
    parameter_form=_form_spec_agent_config_mailman_lists,
)
