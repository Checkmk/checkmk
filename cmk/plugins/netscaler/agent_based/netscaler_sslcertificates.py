...
def parse_netscaler_sslcertificates(string_table: Sequence[StringTable]) -> Section:
    """
...
snmp_section_netscaler_sslcertificates = SNMPSection(
...
check_plugin_netscaler_sslcertificates = CheckPlugin(
    name="netscaler_sslcertificates",
