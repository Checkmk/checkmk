...
def _valuespec_agent_config_plesk() -> Dictionary:
    return Dictionary(
        help_text=Help(
            "Deploy the agent plug-ins <tt>plesk_backups</tt> and"
            " <tt>plesk_domains</tt> on your target system."
        ),
        elements={
...
rule_spec_plesk = AgentConfig(
    title=Title("Plesk backups and domains (Linux)"),
    name="plesk",
    topic=Topic.APPLICATIONS,
    parameter_form=_valuespec_agent_config_plesk,
)
