...
def _simple_levels_element(property: str) -> DictElement:
    ...
    return DictElement(
        ...
        parameter_form=Dictionary(
            title=Title(f"{property.capitalize()} Podman pods"),  # pylint: disable=localization-checker
            elements={
                "levels_lower": DictElement(
                    parameter_form=SimpleLevels(
                        title=Title(f"Lower threshold on {property} number of Podman pods"),  # pylint: disable=localization-checker
                ...
                "levels_upper": DictElement(
                    parameter_form=SimpleLevels(
                        title=Title(f"Upper threshold on {property} number of Podman pods"),  # pylint: disable=localization-checker
                        form_spec_template=Integer(),
