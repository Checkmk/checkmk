...
from cmk.plugins.lib.ra32e import DETECT_RA3S
...
snmp_section_ra3s_digital_sensors = SimpleSNMPSection(
    ...
    fetch=SNMPTree(
        ...
        oids=[
            ...
            "1",
            # digital-sen1-1 --> Temperature in Celsius for any of: Temperature | Temp/Humidity | Temp/Analog | Temp/Active Power | Digital Extreme Temp.
            "2",
            # digital-sen1-2 --> Temperature in Fahrenheit for any of: Temperature | Temp/Humidity | Temp/Analog | Temp/Active Power | Digital Extreme Temp.
            "3",
            # digital-sen1-3 --> Humidity percentage IF Temp/Humidity. Voltage IF Temp/Analog. Power state boolean IF Temp/Active Power. Thermocouple temp in Celsius IF Digital Extreme Temp.
            "4",
            # digital-sen1-4 --> Heat index Fahrenheit IF Temp/Humidity. Current IF Temp/Analog. Thermocouple temp in Fahrenheit IF Digital Extreme Temp.
...
def check_ra3s_voltage(
    ...
    if section.voltage is not None:
        yield from check_elphase(
            item,
            params,
            {item: {"voltage": (float(section.voltage), (0, "Voltage reading"))}},
        )
...
def check_ra3s_power(
    ...
    state = (0, "power detected") if section.power_detected else (2, "no power detected")
    yield from check_elphase(
        item,
        params,
