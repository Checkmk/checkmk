...
def _valuespec_agent_config_vxvm() -> Dictionary:
    return Dictionary(
        help_text=Help("This plug-in monitors various aspects of VxVM."),
        elements={
...
rule_spec_vxvm = AgentConfig(
    title=Title("Veritas Volume Manager (Linux, HP-UX)"),
    name="vxvm",
    topic=Topic.STORAGE,
    parameter_form=_valuespec_agent_config_vxvm,
)
