...
def _form_spec_agent_config_windows_multipath() -> Dictionary:
    return Dictionary(
        help_text=Help(
...
rule_spec_windows_multipath = AgentConfig(
    title=Title("Windows Multipath"),
    name="windows_multipath",
    topic=Topic.STORAGE,
    parameter_form=_form_spec_agent_config_windows_multipath,
)
