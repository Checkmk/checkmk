...
class Service(Metadata):
    def __init__(self, service, use_namespace) -> None:  # type:ignore[no-untyped-def]
...
class Ingress(Metadata):
    def __init__(self, ingress, use_namespace) -> None:  # type:ignore[no-untyped-def]
...
class Endpoint(Metadata):
    ...
    def __init__(self, endpoint, use_namespace) -> None:  # type:ignore[no-untyped-def]
...
class Job(Metadata):
    def __init__(self, job, use_namespace) -> None:  # type:ignore[no-untyped-def]
...
class DaemonSet(Metadata):
    def __init__(self, daemon_set, use_namespace) -> None:  # type:ignore[no-untyped-def]
...
class StatefulSet(Metadata):
    def __init__(self, stateful_set, use_namespace) -> None:  # type:ignore[no-untyped-def]
