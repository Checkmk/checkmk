...
def fetch_volumes(connection: HostConnection) -> Iterable[netapp_ontap_models.VolumeModel]:
    yield from netapp_ontap_models.get_volumes(connection)


def fetch_volumes_counters(
    connection: HostConnection, volumes: Sequence[netapp_ontap_models.VolumeModel]
) -> Iterable[netapp_ontap_models.VolumeCountersRowModel]:
    """
    ...
    for volume in volumes:
        volume_counters = list(
            netapp_ontap_models.get_volume_counters(
...
def fetch_disks(connection: HostConnection) -> Iterable[netapp_ontap_models.DiskModel]:
    yield from netapp_ontap_models.get_disks(connection)
