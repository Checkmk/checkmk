...
from cmk.gui.backup.formspec_adapter import is_formspec_password, target_config_from_ui
    ...
    def __call__(self, logger: Logger) -> None:
        ...
        for target_id, target_config in config.site.targets.items():
            if not _has_formspec_password(target_config):
                continue
            config.site.targets[target_id] = target_config_from_ui(target_config)
