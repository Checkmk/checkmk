...
AGENT_ENGINE_RULE_ID = "e7083f95-5ee1-4814-bdba-d7c1fbbff57d"
MCP_SERVER_RULE_ID = "9c90e72e-443e-4400-8374-cd4f9d9fdbf5"
...
_NEW_DEFAULT_RULE_IDS = (
    frozenset(
        {UI_JOB_SCHEDULER_RULE_ID, OTEL_COLLECTOR_RULE_ID, AGENT_ENGINE_RULE_ID, MCP_SERVER_RULE_ID}
    )
    | PROXMOX_RULE_IDS
)
