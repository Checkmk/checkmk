...
class Hostsbygroup(Table):
    __tablename__ = 'hostsbygroup'
    ...
    hostgroup_members_with_state = Column(
    ...
    hostgroup_num_hosts_down = Column(
    ...
    hostgroup_num_hosts_handled_problems = Column(
        'hostgroup_num_hosts_handled_problems',
        col_type='int',
    ...
    hostgroup_num_hosts_pending = Column(
    ...
    hostgroup_num_hosts_unhandled_problems = Column(
        'hostgroup_num_hosts_unhandled_problems',
        col_type='int',
    ...
    hostgroup_num_hosts_unreach = Column(
    ...
    hostgroup_num_services_crit = Column(
    ...
    hostgroup_num_services_handled_problems = Column(
        'hostgroup_num_services_handled_problems',
        col_type='int',
    ...
    hostgroup_num_services_hard_crit = Column(
    ...
    hostgroup_num_services_hard_ok = Column(
    ...
    hostgroup_num_services_hard_unknown = Column(
    ...
    hostgroup_num_services_hard_warn = Column(
    ...
    hostgroup_num_services_ok = Column(
    ...
    hostgroup_num_services_pending = Column(
    ...
    hostgroup_num_services_unhandled_problems = Column(
        'hostgroup_num_services_unhandled_problems',
        col_type='int',
    ...
    hostgroup_num_services_unknown = Column(
    ...
    hostgroup_num_services_warn = Column(
    ...
    hostgroup_worst_host_state = Column(
    ...
    hostgroup_worst_service_hard_state = Column(
    ...
    hostgroup_worst_service_state = Column(
