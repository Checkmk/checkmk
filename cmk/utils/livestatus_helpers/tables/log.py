...
class Log(Table):
    ...
    current_contact_address1 = Column(
    ...
    current_contact_address2 = Column(
    ...
    current_contact_address3 = Column(
    ...
    current_contact_address4 = Column(
    ...
    current_contact_address5 = Column(
    ...
    current_contact_address6 = Column(
    ...
    current_contact_can_submit_commands = Column(
    ...
    current_contact_custom_variable_names = Column(
    ...
    current_contact_custom_variable_values = Column(
    ...
    current_contact_custom_variables = Column(
    ...
    current_contact_host_notification_period = Column(
    ...
    current_contact_host_notifications_enabled = Column(
    ...
    current_contact_in_host_notification_period = Column(
    ...
    current_contact_in_service_notification_period = Column(
    ...
    current_contact_modified_attributes_list = Column(
    ...
    current_contact_service_notification_period = Column(
    ...
    current_contact_service_notifications_enabled = Column(
    ...
    current_contact_tag_names = Column(
        'current_contact_tag_names',
        col_type='list',
        description='A list of the names of the tags',
    )
    """A list of the names of the tags"""

    current_contact_tag_values = Column(
        'current_contact_tag_values',
        col_type='list',
        description='A list of the values of the tags',
    )
    """A list of the values of the tags"""

    current_contact_tags = Column(
        'current_contact_tags',
        col_type='dict',
    ...
    long_plugin_output = Column(
        'long_plugin_output',
        col_type='string',
        description='The complete output of the check, if any is associated with the message',
    )
