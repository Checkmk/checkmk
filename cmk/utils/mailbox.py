...
Message = Union[POPIMAPMessage, EWSMessage]
...
class EWS:
    ...
    def add_folder(self, folder_path: str) -> Folder:
        ...
        parent_folder: Union[Folder, None] = None  # default
...
class Mailbox:
    ...
    * OAuth https://stackoverflow.com/questions/5193707/use-imaplib-and-oauth-for-connection-with-gmail
    ...
    def fetch_mails(self, subject_pattern: str = "") -> MailMessages:
        ...
        def matches(subject: Optional[str], re_pattern: Optional[re.Pattern[str]]) -> bool:
    ...
    def mails_by_date(
        ...
        *,
        ...
        def fetch_timestamp(mail_id: Union[str, bytes]) -> int:
