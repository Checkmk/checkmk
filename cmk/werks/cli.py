...
def get_werk_arg(arg: Optional[WerkId]) -> WerkId:
...
def edit_werk(
    werk_path: Path, custom_files: Optional[list[str]] = None, commit: bool = True
) -> None:
...
def werk_cherry_pick(commit_id: str, no_commit: bool, werk_version: WerkVersion) -> None:
    ...
    found_werk_path: Optional[WerkToPick] = None
