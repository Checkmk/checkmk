...
def _check_html(string: str) -> None:
    ...
    tags_found = {e.tag for e in tree.xpath("./body//*")}  # type: ignore[union-attr]
    ...
    li_parents_found = {e.getparent().tag for e in tree.xpath("./body//li")}  # type: ignore[union-attr]
