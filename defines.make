...
# However, we should keep them as close as possible. Centralized in package_versions.bzl, like PYTHON_VERSION.
PYTHON_VERSION_WINDOWS := $(shell sed -n 's|^PYTHON_VERSION_WINDOWS = \"\(\S*\)\"$$|\1|p' $(REPO_PATH)/package_versions.bzl)
...
AGENT_PLUGIN_PYTHON_VERSIONS := 3.4 3.5 3.6 3.7 3.8 3.9 3.10 3.11 3.12 3.13 3.14
