...
We have to keep the commercial editions and Checkmk Community partly in sync
because the rely on different core implementations:  the
commercial editions use a closed-source CMC microcore and
Checkmk Community uses the third-party `Nagios`_ core.
