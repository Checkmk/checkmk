...
register_check_parameters(
    ...
    Dictionary(
        title=_("Limits"),
        elements=[('version', memcached_lower_bounds("Version", "1.4.15", "1.4.15")),
                  ...
                  ('total_items',
                   memcached_upper_bounds("Number of items stored on the server", 0, 0)),
                  ('cache_hit_rate',
                   memcached_lower_bounds("Rate of cache hits", 0.9, 0.8, _("percent"))),
                  ...
                  ('connection_structures',
                   memcached_upper_bounds("Internal connection handles", 0, 0)),
                  ...
                  ('reclaimed',
                   memcached_upper_bounds(
                       "Number of times a request used memory from an expired key", 0, 0))]),
