...
def determine_license(
    ...
    assert component.license_info is not None, (
        f"License for {component.ref} could not be determined. Please research it and add it to the manually researched licenses. (`bazel run //omd/dependency_management:research_licenses`)"
    )
    return component
