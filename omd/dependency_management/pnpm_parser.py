...
import yaml
from cyclonedx import Component, PUrl
    ...
    def bom_components(self, path: Path) -> list[Component]:
        return [
            Component(
                type_="library",
                purl=id_.purl,
                sha256s=frozenset({integrity_hash_to_hexdigest(details.resolution.integrity)}),
