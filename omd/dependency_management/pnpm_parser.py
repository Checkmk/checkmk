...
class MyDependencyIdentifier:
    ...
    def parse(cls, dep_path: str) -> Self:
        ...
        >>> MyDependencyIdentifier.parse("/@internationalized/date@3.9.0")
        MyDependencyIdentifier(name='@internationalized/date', import_version=_ImportVersion(version='3.9.0', path=''))
        """
        dep_path = dep_path.lstrip("/")
