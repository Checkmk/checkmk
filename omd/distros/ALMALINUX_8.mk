...
OS_PACKAGES       += dialog
OS_PACKAGES       += expat
OS_PACKAGES       += git # needed for git-based version control for Setup
...
OS_PACKAGES       += rsync
OS_PACKAGES       += sendmail # needed for e.g. reporting and notifications
OS_PACKAGES       += uuid
OS_PACKAGES       += cronie
...
OS_PACKAGES       += openldap-devel # needed for ldap
