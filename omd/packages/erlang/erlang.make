...
$(ERLANG_INSTALL): $(ERLANG_BUILD)
	...
	$(SED) -i "s|$(ERLANG_PLACEHOLDER)|$(OMD_ROOT)|g" $(DESTDIR)$(OMD_ROOT)/lib/erlang/erts-14.2.5.10/bin/erl
	$(SED) -i "s|$(ERLANG_PLACEHOLDER)|$(OMD_ROOT)|g" $(DESTDIR)$(OMD_ROOT)/lib/erlang/erts-14.2.5.10/bin/start
