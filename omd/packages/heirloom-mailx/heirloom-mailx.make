...
HEIRLOOM_MAILX_SKEL := $(BUILD_HELPER_DIR)/$(HEIRLOOM_MAILX_DIR)-skel
...
.PHONY: $(HEIRLOOM_MAILX)-clean

$(HEIRLOOM_MAILX_BUILD): $(HEIRLOOM_MAILX_PATCHING)
	cd $(HEIRLOOM_MAILX_BUILD_DIR) && $(MAKE) -j 1
	$(TOUCH) $@
...
$(HEIRLOOM_MAILX)-clean:
	rm -rf $(HEIRLOOM_MAILX_BUILD_DIR) $(BUILD_HELPER_DIR)/$(HEIRLOOM_MAILX_DIR)*
