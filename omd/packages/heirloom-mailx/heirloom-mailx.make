...
# TODO: Make bazel-bin dir a variable for all bazelized builds
HEIRLOOM_MAILX_BUILD_DIR := bazel-bin/external/heirloom-mailx/heirloom-mailx

$(HEIRLOOM_MAILX_BUILD):
	$(BAZEL_BUILD) @$(HEIRLOOM_MAILX)//:$(HEIRLOOM_MAILX)
	$(TOUCH) $@
