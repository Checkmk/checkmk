...
$(MK_LIVESTATUS_BUILD): $(MK_LIVESTATUS_UNPACK) $(RE2_BUILD)
	...
	unset DESTDIR MAKEFLAGS ; \
	    $(MAKE) -C $(MK_LIVESTATUS_BUILD_DIR) PACKAGE_GOOGLETEST=$(PACKAGE_DIR)/googletest PACKAGE_ASIO=$(PACKAGE_DIR)/asio all
	$(TOUCH) $@

$(MK_LIVESTATUS_INSTALL): $(MK_LIVESTATUS_BUILD)
	$(MAKE) -j1 DESTDIR=$(DESTDIR) -C $(MK_LIVESTATUS_BUILD_DIR) PACKAGE_GOOGLETEST=$(PACKAGE_DIR)/googletest PACKAGE_ASIO=$(PACKAGE_DIR)/asio install
