...
MONITORING_PLUGINS_SKEL := $(BUILD_HELPER_DIR)/$(MONITORING_PLUGINS_DIR)-skel
...
.PHONY: $(MONITORING_PLUGINS)-clean
...
$(MONITORING_PLUGINS_SKEL):
	$(TOUCH) $@

$(MONITORING_PLUGINS)-clean:
	$(RM) -r $(MONITORING_PLUGINS_BUILD_DIR) $(BUILD_HELPER_DIR)/$(MONITORING_PLUGINS)*
