...
def _check_interactive(command: Command, global_opts: GlobalOptions) -> None:
...
def parse_args_or_exec_other_omd(  # pylint: disable=too-many-branches
    ...
    match command.command:
        case "su":
            ...
            if exec_version is not None:
                return exec_version
            _check_interactive(command, global_opts)
