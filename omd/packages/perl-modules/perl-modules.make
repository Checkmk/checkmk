...
$(PERL_MODULES_BUILD):
	...
	unset LANG; \
		...
		FORCE=1 ./build_module.pl -d "$(DISTRO_INFO)" -p $(PACKAGE_PERL_MODULES_DESTDIR)/dest \
	    ...
	    cd $(PACKAGE_PERL_MODULES_DESTDIR)/src ; \
	    ./build_module.pl -d "$(DISTRO_INFO)" -p $(PACKAGE_PERL_MODULES_DESTDIR)/dest $(PERL_MODULES_LIST)
