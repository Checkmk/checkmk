...
PYTHON_MODULES_LIST += PyYAML-5.4.tar.gz
...
python-modules-dump-Pipfile:
	...
	@echo ''
	@echo '[dev-packages]'
	@echo 'astroid = "==1.6.6"  # used by testlib.pylint_checker_localization'
	@echo 'bandit = "==1.6.2"  # used by test/Makefile'"'"'s test-bandit target'
	@echo '"beautifulsoup4" = "==4.7.1"  # used by the GUI crawler and various tests'
	@echo 'compiledb = "==0.10.1"  # used by the Livestatus/CMC Makefiles for building compile_command.json'
	@echo 'docker = "==4.0.2"  # used by test_docker test and mk_docker agent plugin'
	@echo 'freezegun = "==0.3.12"  # used by various unit tests'
	@echo 'isort = "==4.3.21"  # used as a plugin for editors'
	@echo 'lxml = "==4.3.4"  # used via beautifulsoup4 as a parser and in the agent_netapp special agent'
	@echo 'mock = "==3.0.5"  # used in checktestlib in unit tests'
	@echo 'mockldap = "==0.3.0"  # used in test_userdb_ldap_connector unit test'
	@echo 'pylint = "==1.9.4"  # used by test/Makefile'"'"'s test-pylint target'
	@echo 'pytest = "==4.6.4"  # used by various test/Makefile targets'
	@echo 'pytest-cov = "==2.7.1"  # used (indirectly) by test/Makefile'"'"'s test-unit-coverage-html target, see comment there'
	@echo 'coverage = "==4.5.3"  # indirect dependency of pytest-cov'
	@echo 'pytest-mock = "==1.10.4"  # used by quite a few unit/integration tests via the mocker fixture'
	@echo 'yapf = "==0.28.0"  # used for editor integration and the format-python Makefile target'
	@echo ''
	@echo '[packages]'
