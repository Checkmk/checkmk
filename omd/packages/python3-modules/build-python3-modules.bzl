...
build_cmd = """
    ...
    export PATH="$$TMPDIR/workdir:$$PATH"
    ...
    export CPATH="$$HOME/$$EXT_DEPS_PATH/python/python/include/python3.11/:$$HOME/$$EXT_DEPS_PATH/openssl/openssl/include/openssl:$$HOME/$$EXT_DEPS_PATH/freetds/freetds/include/"
