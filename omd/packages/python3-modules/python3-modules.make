...
PYTHON3_MODULES_BUILD_ID := 5-$(md5sum $(REPO_PATH)/Pipfile.lock | cut -d' ' -f1)
...
PACKAGE_PYTHON3_MODULES_PYTHON_DEPS    := \
	...
	$(PYTHON3_MODULES_INTERMEDIATE_INSTALL)

$(PYTHON3_MODULES_BUILD): $(PYTHON_CACHE_PKG_PROCESS) $(OPENSSL_INTERMEDIATE_INSTALL) $(FREETDS_INTERMEDIATE_INSTALL) $(PYTHON3_MODULES_PATCHING)
