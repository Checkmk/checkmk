...
python3-modules-dump-Pipfile:
	...
	@echo ''
	@echo '[dev-packages]'
	@echo 'astroid = "==2.4.2"  # used by testlib.pylint_checker_localization'
	@echo 'bandit = "==1.7.0"  # used by test/Makefile'"'"'s test-bandit target'
	@echo '"beautifulsoup4" = "==4.9.3"  # used by the GUI crawler and various tests'
	@echo 'bson = "==0.5.10"  # used by test_mk_mongodb unit test'
	@echo 'compiledb = "==0.10.1"  # used by the Livestatus/CMC Makefiles for building compile_command.json'
	@echo 'docker = "==4.4.2"  # used by test_docker test and mk_docker agent plugin'
	@echo 'dockerpty = "==0.4.1"  # used by dockerized tests for opening debug shells'
	@echo 'freezegun = "==1.1.0"  # used by various unit tests'
	@echo 'isort = "==5.7.0"  # used as a plugin for editors'
	@echo 'lxml = "==4.6.2"  # used via beautifulsoup4 as a parser and in the agent_netapp special agent'
	@echo 'mock = "==4.0.3"  # used in checktestlib in unit tests'
	@echo 'mockldap = "==0.3.0.post1"  # used in test_userdb_ldap_connector unit test'
	@echo 'pylint = "==2.6.2"  # used by test/Makefile'"'"'s test-pylint target'
	@echo 'mypy = "==0.800"  # used by test/static/Makefile'"'"'s test-mypy target'
	@echo 'pymongo = "==3.11.3"  # used by mk_mongodb agent plugin'
	@echo '# TODO: Fix "make test-unit-coverage-html" issue with pytest 6.2.1 (See CMK-6796)'
	@echo 'pytest = "==6.1.2"  # used by various test/Makefile targets'
	@echo 'pytest-cov = "==2.11.1"  # used (indirectly) by test/Makefile'"'"'s test-unit-coverage-html target, see comment there'
	@echo 'pytest-mock = "==3.5.1"  # used by quite a few unit/integration tests via the mocker fixture'
	@echo 'pytest-testmon = "==1.0.3"  # used for pre-commit checking via .pre-commit-config.yaml'
	@echo 'pytest-profiling = "==1.7.0"  # used to analyze test run performance'
	@echo 'responses = "==0.12.1"  # used for unit tests'
	@echo 'webtest = "==2.0.35"  # used by WSGI based tests'
	@echo 'pre-commit = "==2.10.1"  # used to fix / find issues before commiting changes'
	@echo 'flake8 = "==3.8.4"'
	@echo 'sphinx = "==3.5.1"  # used for the plugin API documentation'
	@echo 'sphinx-autodoc-typehints = "==1.11.1"  # used for the plugin API documentation'
	@echo 'sphinx-rtd-theme = "==0.5.1"  # used for the plugin API documentation'
	@echo '3to2 = "==1.1.1"  # used for converting agent plugins from py3 to 2'
	...
	@echo 'python-lsp-server = "==1.0.1"  # Note: There are extras, but the default seems sensible.'
	@echo 'mypy-ls = "==0.4.0"  # mypy-plugin for the above'
	@echo '# Pinned indirect dependencies'
	@echo 'coverage = "==5.4"'
	@echo 'gitpython = "==3.1.13"'
	@echo 'gprof2dot = "==2019.11.30"'
	@echo 'identify = "==1.5.13"'
	@echo 'jedi = "==0.18.0"'
	@echo 'parso = "==0.8.2"'
