...
PYTHON3_MODULES_LIST += s3transfer-0.4.2.tar.gz # needed by boto3 (aws)
PYTHON3_MODULES_LIST += boto3-1.17.102.tar.gz # needed by boto3 (aws)
...
PYTHON3_MODULES_LIST += yapf-0.31.0.tar.gz  # formatter for REST-API documentation code examples
...
python3-modules-dump-Pipfile:
	...
	@echo 'sphinxcontrib-plantuml = "*"  # used for the API and architecture'
	@echo 'sphinxcontrib-spelling = "*"'
	...
	@echo 'python-lsp-server = "*"  # Note: There are extras, but the default seems sensible.'
	@echo 'mypy-ls = "*"  # mypy-plugin for the above'
	@echo ''
	@echo '[packages]'
