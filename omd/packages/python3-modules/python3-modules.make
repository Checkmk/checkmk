...
PYTHON3_MODULES_BUILD_ID := $(call cache_pkg_build_id,21,$(PYTHON3_MODULES_DEPS))
...
$(PYTHON3_MODULES_BUILD): $(PYTHON_CACHE_PKG_PROCESS) $(OPENSSL_CACHE_PKG_PROCESS) $(FREETDS_CACHE_PKG_PROCESS) $(PYTHON3_MODULES_PATCHING)
	...
	set -e ; cd $(PYTHON3_MODULES_BUILD_DIR) ; \
		...
		pipenv requirements --hash | grep -Ev '(protobuf|rrdtool|agent-receiver|pymssql|netapp-ontap)' > requirements-dist.txt ; \
