...
#    ( TAG=2022-12-01; git archive --prefix=re2-$TAG/ --output=re2-$TAG.tar.gz $TAG )
RE2 := re2
RE2_VERS := 2022-12-01
...
# basically what part of AC_PROC_CXX does
	@CXX="" ; \
	for PROG in g++-12 clang++-15 clang++-14 clang++-13 g++-11 clang++-12 g++-10 clang++-11 clang++-10 g++-9 clang++-9 clang++-8 g++-8 clang++-7 g++-7 clang++-6.0 clang++-5.0 g++ clang++; do \
