...
RRDTOOL_CACHE_PKG_PATH_LIBRARY := $(call cache_pkg_path,$(RRDTOOL_DIR),$(RRDTOOL_BUILD_ID)-library)

$(RRDTOOL_CACHE_PKG_PATH_LIBRARY):
	$(call pack_pkg_archive,$@,$(RRDTOOL_DIR),$(RRDTOOL_BUILD_ID)-library,$(RRDTOOL_INTERMEDIATE_INSTALL_LIBRARY))

$(RRDTOOL_CACHE_PKG_PROCESS_LIBRARY): $(RRDTOOL_CACHE_PKG_PATH_LIBRARY)
	$(call unpack_pkg_archive,$(RRDTOOL_CACHE_PKG_PATH_LIBRARY),$(RRDTOOL_DIR))
	$(call upload_pkg_archive,$(RRDTOOL_CACHE_PKG_PATH_LIBRARY),$(RRDTOOL_DIR),$(RRDTOOL_BUILD_ID)-library)
	$(TOUCH) $@

RRDTOOL_CACHE_PKG_PATH_BINDINGS := $(call cache_pkg_path,$(RRDTOOL_DIR),$(RRDTOOL_BUILD_ID)-bindings)

$(RRDTOOL_CACHE_PKG_PATH_BINDINGS):
	$(call pack_pkg_archive,$@,$(RRDTOOL_DIR),$(RRDTOOL_BUILD_ID)-bindings,$(RRDTOOL_INTERMEDIATE_INSTALL_BINDINGS))

$(RRDTOOL_CACHE_PKG_PROCESS_BINDINGS): $(RRDTOOL_CACHE_PKG_PATH_BINDINGS)
	$(call unpack_pkg_archive,$(RRDTOOL_CACHE_PKG_PATH_BINDINGS),$(RRDTOOL_DIR))
	$(call upload_pkg_archive,$(RRDTOOL_CACHE_PKG_PATH_BINDINGS),$(RRDTOOL_DIR),$(RRDTOOL_BUILD_ID)-bindings)
	$(TOUCH) $@
...
$(RRDTOOL_INSTALL): $(RRDTOOL_CACHE_PKG_PROCESS)
