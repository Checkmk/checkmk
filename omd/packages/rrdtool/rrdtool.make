...
$(RRDTOOL_BUILD_BINDINGS): $(RRDTOOL_CONFIGURE) $(RRDTOOL_BUILD_LIBRARY) $(PYTHON3_CACHE_PKG_PROCESS) $(PYTHON3_MODULES_INTERMEDIATE_INSTALL) $(MODULEBUILDRC_PATH) $(PERL_MODULES_CACHE_PKG_PROCESS)
# TODO: We need to find out which variables here are needed for the configure and which for the make calls
	set -e ; \
