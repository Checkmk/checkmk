...
$(RRDTOOL_BUILD_BINDINGS): $(RRDTOOL_CONFIGURE) $(RRDTOOL_BUILD_LIBRARY) $(PYTHON_CACHE_PKG_PROCESS) $(PYTHON3_MODULES_CACHE_PKG_PROCESS) $(MODULEBUILDRC_PATH) $(PERL_MODULES_CACHE_PKG_PROCESS)
# TODO: We need to find out which variables here are needed for the configure and which for the make calls
	set -e ; \
