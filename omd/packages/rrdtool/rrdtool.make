...
RRDTOOL_CACHE_PKG_PATH := $(call cache_pkg_path,$(RRDTOOL_DIR),$(RRDTOOL_BUILD_ID))

$(RRDTOOL_CACHE_PKG_PATH):
	$(call pack_pkg_archive,$@,$(RRDTOOL_DIR),$(RRDTOOL_BUILD_ID),$(RRDTOOL_INTERMEDIATE_INSTALL))

$(RRDTOOL_CACHE_PKG_PROCESS): $(RRDTOOL_CACHE_PKG_PATH)
	$(call unpack_pkg_archive,$(RRDTOOL_CACHE_PKG_PATH),$(RRDTOOL_DIR))
	$(call upload_pkg_archive,$(RRDTOOL_CACHE_PKG_PATH),$(RRDTOOL_DIR),$(RRDTOOL_BUILD_ID))
	$(TOUCH) $@
