...
fn test_signature_algorithm_ee_pss_sha256_wrong_alg() {
    ...
    assert_eq!(
        out.to_string(),
        format!(
            "WARNING - Signature algorithm is rsassa-pss (1.2.840.113549.1.1.10) but expected 1.2.3.4.5.6 (!)"
        )
    );
}
...
fn test_signature_algorithm_ee_pss_sha1_wrong_alg() {
    ...
    assert_eq!(
        out.to_string(),
        format!(
            "WARNING - Signature algorithm is rsassa-pss (1.2.840.113549.1.1.10) but expected 1.2.840.113549.1.1.11 (!)"
        )
    );
}
