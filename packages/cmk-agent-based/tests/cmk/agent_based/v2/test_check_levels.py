...
def test_check_levels(  # pylint: disable=too-many-arguments,too-many-positional-arguments
    value: float,
...
def test_check_levels_with_metric(  # pylint: disable=too-many-arguments,too-many-positional-arguments
    value: float,
