...
@RELAY_ROUTER.get("/{relay_id}/tasks/{task_id}")
async def get_task(relay_id: UUID4, task_id: UUID4) -> TaskResponse:
    """Get a specific task by ID.

    This endpoint allows clients to retrieve details of a specific task
    assigned to a relay.
    ...
    """
    # Business logic for task retrieval intentionally not implemented
    # - Validate relay exists
    # - Validate task exists and belongs to relay
    # - Return task details

    raise NotImplementedError("Task retrieval business logic not implemented")
...
async def get_tasks(
    ...
    raise NotImplementedError("Task listing business logic not implemented")
