...
import { ErrorResponse, Response, type Suggestions } from '@/components/CmkSuggestions'
...
const slowOptions: Suggestions = {
  ...
  querySuggestions: async (query) => {
    slowProgressClass.value = 'demo-cmk-dropdown__action'
...
<template>
  ...
  <div class="demo-cmk-dropdown__progress" :class="slowProgressClass"></div>
...
div.demo-cmk-dropdown__action::after {
  content: '';
  display: block;
  width: 100%;
  height: 100%;
