...
export interface CmkDatePickerProps<Nullable extends boolean = false>
...
export interface CmkDateTimePickerProps<Nullable extends boolean = false>
  extends DateTimeSaveModeProps {
  /** Display overrides; each field falls back to the browser locale. Extra fields from a wider
   * settings bundle are ignored. */
...
export interface CmkTimeRangePickerProps<Nullable extends boolean = false>
  extends DateTimeSaveModeProps {
  /** Display overrides; each field falls back to the browser locale. Extra fields from a wider
   * settings bundle are ignored. */
  settings?: DateTimePickerSettings | undefined
