 ...
 */
import type { ComponentConfig, ConfiguredFilters } from '@/dashboard-wip/components/filter/types'
import type { FilterDefinitions } from '@/dashboard-wip/components/filter/types'
import type { UseViewsCollection } from '@/dashboard-wip/composables/api/useViewsCollection'
import type { UseVisualInfoCollection } from '@/dashboard-wip/composables/api/useVisualInfoCollection'
