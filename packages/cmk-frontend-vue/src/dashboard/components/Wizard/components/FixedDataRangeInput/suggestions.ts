...
export function dataRangeSymbolSuggestions(): Suggestion[] {
  const { _t } = usei18n()
  return [
    {
      name: 'DecimalNotation_%_AutoPrecision_2',
      title: _t('% (Decimal, auto precision, 2 digits)')
    },
    {
    ...
    {
      name: 'DecimalNotation_A_AutoPrecision_3',
      title: _t('A (Decimal, auto precision, 3 digits)')
    },
    {
    ...
    {
      name: 'DecimalNotation_V_AutoPrecision_3',
      title: _t('V (Decimal, auto precision, 3 digits)')
    },
    {
    ...
    {
      name: 'DecimalNotation_W_AutoPrecision_3',
      title: _t('W (Decimal, auto precision, 3 digits)')
    },
    {
    ...
    {
      name: 'SINotation_bits/s_AutoPrecision_2',
      title: _t('bits/s (SI, auto precision, 2 digits)')
    },
    {
