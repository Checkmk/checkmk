...
export class AutoCompleterResponseError extends CmkError {
...
export async function fetchData(
...
): Promise<AjaxVsAutocompleterResponse> {
  ...
  return (ajaxResponse.result || { choices: [] }) as AjaxVsAutocompleterResponse
}
