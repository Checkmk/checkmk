...
<template>
  ...
  >
    <AgentSlideOutContent
      ...
      :kubernetes-helm-command="agentSlideout.kubernetes_helm_command"
      :kubernetes-values="agentSlideout.kubernetes_values"
      :kubernetes-doc-url="agentSlideout.kubernetes_doc_url"
