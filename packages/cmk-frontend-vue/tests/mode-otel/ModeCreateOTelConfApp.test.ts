...
const PROPS = {
  ...
  overview_url: 'wato.py?mode=otel_overview'
}
...
function clickSave() {
  return fireEvent.click(screen.getByRole('button', { name: /Save OpenTelemetry configuration/ }))
}
