 ...
 */
export { listOptions, PanelStateCreator } from '../../types/prop-panel'
...
export { default as UclDetailPageExternalReference } from './UclDetailPageExternalReference.vue'
export type { ExternalReferenceItem } from './UclDetailPageExternalReference.vue'
