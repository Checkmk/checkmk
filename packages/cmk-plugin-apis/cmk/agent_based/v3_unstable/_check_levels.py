...
def check_levels[NumberT: (int, float)](
    ...
    *,
    ...
    Example:
        ...
        >>> print(metric)
        Metric(name='temperature', value=23.0, levels=(12.0, 42.0), lower_levels=(5.0, 1.0), boundaries=(None, None))
    ...
    if metric_name:
        yield Metric(
            metric_name,
            value,
            levels=result_upper.levels or (None, None),
            lower_levels=result_lower.levels or (None, None),
            boundaries=boundaries or (None, None),
        )
