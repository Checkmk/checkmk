...
class _Localizable:
    ...
    Examples:
        ...
        >>> help = Help("Translate this. ") + Help("Translate this separately.")
...
class Topic(_Localizable):
    """Groups diagnostics plug-ins; users choose one sensitivity threshold per topic

    Topics are compared by value: plug-ins declaring an equal ``Topic`` share a group.
    """
