...
"""The deprecated `cmk.bakery.v2_unstable` namespace must stay a faithful alias.

Plug-ins written against Checkmk 2.5 still import it.
It is removed in Checkmk 3.1.
"""

from cmk.bakery import v2 as stable
from cmk.bakery import v2_unstable as unstable
