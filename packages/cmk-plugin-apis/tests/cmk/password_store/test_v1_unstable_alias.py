...
"""The deprecated `cmk.password_store.v1_unstable` namespace must stay a faithful alias.

Plug-ins written against Checkmk 2.5 still import it.
It is removed in Checkmk 3.1.
"""

from cmk.password_store import v1 as stable
from cmk.password_store import v1_unstable as unstable
