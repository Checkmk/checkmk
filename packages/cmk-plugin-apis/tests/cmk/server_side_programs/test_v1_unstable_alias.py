...
"""The deprecated `cmk.server_side_programs.v1_unstable` namespace must stay a faithful alias.

Plug-ins written against Checkmk 2.5 still import it.
It is removed in Checkmk 3.1.
"""

from cmk.server_side_programs import v1 as stable
from cmk.server_side_programs import v1_unstable as unstable
