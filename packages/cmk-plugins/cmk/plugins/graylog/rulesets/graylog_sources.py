...
def _parameter_valuespec_graylog_sources() -> Dictionary:
    return Dictionary(
        elements={
...
rule_spec_graylog_sources = CheckParameters(
    name="graylog_sources",
    title=Title("Graylog sources"),
    topic=Topic.APPLICATIONS,
    parameter_form=_parameter_valuespec_graylog_sources,
    condition=HostAndItemCondition(item_title=Title("Source name")),
)
