...
from cmk.plugins.azure_deprecated.agent_based.azure_usagedetails import (
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            [Service(item="microsoft.compute"), Service(item="Summary")],
        ...
        pytest.param(
            ...
            [Service(item="Unattributed"), Service(item="Summary")],
