...
from cmk.plugins.kube.agent_based.inventory_kube_cluster import inventorize_kube_cluster
...
def test_inventorize_kube_statefulset(
    ...
    assert sort_inventory_result(inventorize_kube_cluster(section_info)) == sort_inventory_result(
