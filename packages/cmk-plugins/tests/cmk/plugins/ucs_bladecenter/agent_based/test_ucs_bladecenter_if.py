...
from cmk.plugins.ucs_bladecenter.agent_based.ucs_bladecenter_if import parse_ucs_bladecenter_if_pure


def test_parse_ucs_bladecenter_if_pure() -> None:
    assert parse_ucs_bladecenter_if_pure(
        [
            [
                "fcStats",
