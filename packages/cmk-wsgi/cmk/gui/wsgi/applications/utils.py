...
def ensure_authentication(handler: pages.PageHandler) -> Callable[[PageContext], Response]:
...
def _handle_not_authenticated(ctx: PageContext) -> Response:
    if fail_silently():
