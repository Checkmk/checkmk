...
def test_automation_try_discovery_host(test_cfg, site):
    ...
    expected_check_table = [  # type: ignore[var-annotated]
        ('old', 'apache_status', 'apache_status', '127.0.0.1:5000', '{}', {},
         'Apache 127.0.0.1:5000 Status', 0, 'Counter initialization'),
        ('old', 'apache_status', 'apache_status', '127.0.0.1:5004', '{}', {},
         'Apache 127.0.0.1:5004 Status', 0, 'Counter initialization'),
        ('old', 'apache_status', 'apache_status', '127.0.0.1:5007', '{}', {},
         'Apache 127.0.0.1:5007 Status', 0, 'Counter initialization'),
        ('old', 'apache_status', 'apache_status', '127.0.0.1:5008', '{}', {},
         'Apache 127.0.0.1:5008 Status', 0, 'Counter initialization'),
        ('old', 'apache_status', 'apache_status', '127.0.0.1:5009', '{}', {},
         'Apache 127.0.0.1:5009 Status', 0, 'Counter initialization'),
        ...
        ('old', 'df', 'filesystem', '/', "{'include_volume_name': False}", {
         ...
         '98.48% used (210.35 of 213.60 GB), (warn/crit at 80.0%/90.0%)(!!)\n98.48% used (210.35 of 213.60 GB), (warn/crit at 80.0%/90.0%)(!!)'
        ),
        ...
        ('old', 'df', 'filesystem', '/boot/efi', "{'include_volume_name': False}", {
            ...
            'trend_perfdata': True,
            'trend_range': 24
        }, 'Filesystem /boot/efi', 0,
         '0.7% used (3.58 of 510.98 MB)\n0.7% used (3.58 of 510.98 MB)'),
        ...
        ('old', 'mounts', 'fs_mount_options', '/',
         ...
         ['data=ordered', 'errors=remount-ro', 'noatime', 'nodiratime', 'rw'], 'Mount options of /',
         0, 'Mount options exactly as expected\nMount options exactly as expected'),
        ('old', 'mounts', 'fs_mount_options', '/boot',
         ...
         ['acl', 'barrier', 'block_validity', 'relatime', 'rw', 'stripe=4',
          'user_xattr'], 'Mount options of /boot', 0,
         'Mount options exactly as expected\nMount options exactly as expected'),
