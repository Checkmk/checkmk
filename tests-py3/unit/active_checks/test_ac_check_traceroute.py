...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([
            'traceroute to www.google.de (173.194.44.55), 30 hops max, 60 byte packets',
            '1  10.10.11.4  0.419 ms  0.444 ms  0.518 ms',
        ], [], "missing routers: none, bad routers: none", 0, [('hops', 1)]),
        ([
            'traceroute to www.google.de (173.194.44.55), 30 hops max, 60 byte packets',
            '1  10.10.11.4  0.419 ms  0.444 ms  0.518 ms',
        ], [('w', '10.10.11.4')
           ], "missing routers: none, bad routers: 10.10.11.4(!)", 1, [('hops', 1)]),
        ([
            'traceroute to www.google.de (173.194.44.55), 30 hops max, 60 byte packets',
            '1  10.10.11.4  0.419 ms  0.444 ms  0.518 ms',
        ], [('W', 'foobar')], "missing routers: foobar(!), bad routers: none", 1, [('hops', 1)]),
        ([
            'traceroute to www.google.de (173.194.44.55), 30 hops max, 60 byte packets',
            '1  10.10.11.4  0.419 ms  0.444 ms  0.518 ms',
        ], [('c', '10.10.11.4')
           ], "missing routers: none, bad routers: 10.10.11.4(!!)", 2, [('hops', 1)]),
        ([
            'traceroute to www.google.de (173.194.44.55), 30 hops max, 60 byte packets',
            '1  10.10.11.4  0.419 ms  0.444 ms  0.518 ms',
        ], [('C', 'foobar')], "missing routers: foobar(!!), bad routers: none", 2, [('hops', 1)]),
        # without -n
        ([
            'traceroute to www.google.de (173.194.44.56), 30 hops max, 60 byte packets',
            '1  fritz.box (10.10.11.4)  0.570 ms  0.606 ms  0.677 ms',
        ...
        ([
           ...
           ], "missing routers: none, bad routers: 2001:2e8:665:0:2:2:0:1(!)", 1, [('hops', 1)]),
        ([
            'traceroute to ipv6.google.com (2404:6800:4004:80e::200e), 30 hops max, 80 byte packets',
            '1  2001:2e8:665:0:2:2:0:1 (2001:2e8:665:0:2:2:0:1)  0.082 ms  0.046 ms  0.044 ms',
        ], [('W', 'foobar')], "missing routers: foobar(!), bad routers: none", 1, [('hops', 1)]),
        ([
           ...
           ], "missing routers: none, bad routers: 2001:2e8:665:0:2:2:0:1(!!)", 2, [('hops', 1)]),
        ([
            'traceroute to ipv6.google.com (2404:6800:4004:80e::200e), 30 hops max, 80 byte packets',
            '1  2001:2e8:665:0:2:2:0:1 (2001:2e8:665:0:2:2:0:1)  0.082 ms  0.046 ms  0.044 ms',
        ], [('C', 'foobar')], "missing routers: foobar(!!), bad routers: none", 2, [('hops', 1)]),
        ...
        ([
           ...
           ], 'missing routers: none, bad routers: 204.152.141.11(!)', 1, [('hops', 1)]),
        ([
            'traceroute to ipv6.google.com (2404:6800:4004:80e::200e), 30 hops max, 80 byte packets',
            '1 xe-0-0-1-0.co2-96c-1b.ntwk.msn.net (204.152.141.11)  174.185 ms xe-10-0-2-0.co1-96c-1a.ntwk.msn.net (207.46.40.94)  174.279 ms xe-0-0-1-0.co2-96c-1b.ntwk.msn.net (204.152.141.11)  174.444 ms',
        ], [('w', '207.46.40.94')
           ], 'missing routers: none, bad routers: 207.46.40.94(!)', 1, [('hops', 1)]),
        ([
            'traceroute to ipv6.google.com (2404:6800:4004:80e::200e), 30 hops max, 80 byte packets',
            '1 xe-0-0-1-0.co2-96c-1b.ntwk.msn.net (204.152.141.11)  174.185 ms xe-10-0-2-0.co1-96c-1a.ntwk.msn.net (207.46.40.94)  174.279 ms xe-0-0-1-0.co2-96c-1b.ntwk.msn.net (204.152.141.11)  174.444 ms',
        ], [('w', '204.152.141.11')
        ...
        ([
           ...
           ], 'missing routers: none, bad routers: 204.152.141.11(!!)', 2, [('hops', 1)]),
        ([
            'traceroute to ipv6.google.com (2404:6800:4004:80e::200e), 30 hops max, 80 byte packets',
            '1 xe-0-0-1-0.co2-96c-1b.ntwk.msn.net (204.152.141.11)  174.185 ms xe-10-0-2-0.co1-96c-1a.ntwk.msn.net (207.46.40.94)  174.279 ms xe-0-0-1-0.co2-96c-1b.ntwk.msn.net (204.152.141.11)  174.444 ms',
        ], [('c', '207.46.40.94')
           ], 'missing routers: none, bad routers: 207.46.40.94(!!)', 2, [('hops', 1)]),
        ([
            'traceroute to ipv6.google.com (2404:6800:4004:80e::200e), 30 hops max, 80 byte packets',
            '1 xe-0-0-1-0.co2-96c-1b.ntwk.msn.net (204.152.141.11)  174.185 ms xe-10-0-2-0.co1-96c-1a.ntwk.msn.net (207.46.40.94)  174.279 ms xe-0-0-1-0.co2-96c-1b.ntwk.msn.net (204.152.141.11)  174.444 ms',
        ], [('c', '204.152.141.11')
