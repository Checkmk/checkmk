...
checks = {
    '': [(u'MY CHECK MK', {}, [(
        ...
        [(u'Uptime', 99739, None, None, None, None),
         (u'IdleWorkers', 49, None, None, None, None),
         (u'BusyWorkers', 1, None, None, None, None),
         ('OpenSlots', 100, None, None, None, None),
         ...
         ('State_Keepalive', 0, None, None, None, None),
         ('State_DNS', 0, None, None, None, None),
         ('State_Closing', 0, None, None, None, None),
         ('State_Logging', 0, None, None, None, None),
         ('State_Finishing', 0, None, None, None, None),
         ('State_IdleCleanup', 0, None, None, None, None),
         (u'ConnsTotal', 0, None, None, None, None),
