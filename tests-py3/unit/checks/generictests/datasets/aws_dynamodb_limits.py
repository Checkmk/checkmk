...
info = [['[["number_of_tables",', '"Number', 'of', 'tables",', '256,', '3,', '"eu-central-1"],',
         '["read_capacity",', '"Read', 'Capacity",', '80000,', '3,', '"eu-central-1"],',
         '["write_capacity",', '"Write', 'Capacity",', '80000,', '3,', '"eu-central-1"]]'],
        ['[["number_of_tables",', '"Number', 'of', 'tables",', '256,', '1,', '"us-east-1"],',
