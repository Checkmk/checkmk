...
info = [
    ...
    [
        'Power Domain 1 Power Unit 0 - Redundancy lost', '', '0', 'power', '0', '', 'yellow',
        'Yellow', 'Sensor is operating under conditions that are non-critical'
    ],
    [
        'Power Supply 2 Power Supply 2 0: Power Supply AC lost - Assert', '', '0', 'power', '0', '',
        'red', 'Red', 'Sensor is operating under critical conditions'
    ],
