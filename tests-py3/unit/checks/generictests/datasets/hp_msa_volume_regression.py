...
info = [
    [u'volumes', u'1', u'durable-id', u'V3'],
    [u'volumes', u'1', u'virtual-disk-name', u'A'],
    ...
    [u'volumes', u'1', u'raidtype', u'RAID0'],
    [u'volumes', u'1', u'health', u'OK'],
    [u'volumes', u'2', u'durable-id', u'V4'],
    ...
    [u'volumes', u'2', u'raidtype', u'RAID0'],
    [u'volumes', u'2', u'health', u'OK'],
    [u'volumes', u'3', u'durable-id', u'V2'],
    ...
    [u'volumes', u'3', u'raidtype', u'RAID0'],
    [u'volumes', u'3', u'health', u'OK'],
    [u'volumes', u'4', u'durable-id', u'V5'],
    ...
    [u'volumes', u'4', u'raidtype', u'RAID0'],
...
discovery = {
    '': [
        (u'VMFS_01', None), (u'VMFS_02', None), (u'VMFS_ISO', None),
        (u'VMFS_VDI_01', None)
    ],
    'df': [
        (u'VMFS_01', {}), (u'VMFS_02', {}), (u'VMFS_ISO', {}),
        (u'VMFS_VDI_01', {})
    ],
...
checks = {
    '': [
        ...
        (
            u'VMFS_VDI_01', {}, [
                (0, u'Status: OK, container name: A (RAID0)', [])
            ]
        )
    ],
    'df': [
            ...
            u'VMFS_01', {
                ...
                (
                    0, '57.81% used (1.16 of 2.00 TB)', [
                        (
                            u'VMFS_01', 1212896, 1678313.6, 1888102.8, 0,
                            2097892
        ...
        (
            u'VMFS_02', {
                ...
                (
                    ...
                    [
                        (
                            u'VMFS_02', 1916852, 1678236.8, 1888016.4, 0,
                            2097796
            ...
            u'VMFS_VDI_01', {
                ...
                (
                    0, '78.78% used (322.78 of 409.72 GB)', [
                        (
                            u'VMFS_VDI_01', 330528, 335644.8, 377600.4, 0,
                            419556
