...
checks = {
    '': [
        ...
        (
            ...
            [(
                1,
                u'85.0 \xb0C (warn/crit at 80.0/90.0 \xb0C)',
                [('temp', 85.0, 80.0, 90.0, None, None)],
            )],
        ),
        (
            '3',
            ...
            [(
                2,
                u'95.0 \xb0C (warn/crit at 80.0/90.0 \xb0C)',
                [('temp', 95.0, 80.0, 90.0, None, None)],
            )],
        ),
        (
            '4',
