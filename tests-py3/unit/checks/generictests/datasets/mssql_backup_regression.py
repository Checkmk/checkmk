...
checks = {'': [('MSSQL_Parrot Polly',
               ...
               ('MSSQL_SQL0x4 master',
                {'database': (None, None),
                 ...
                 'unspecific': (None, None)},
                [(0,
                  '[database] Last backup was at 2016-07-08 20:20:27 (3.6 y ago)',
                  [('backup_age_database', 112340373.0, None, None, None, None)])]),
               ('MSSQL_SQL0x4 model',
                {'database': (None, None),
                 'database_diff': (None, None),
                 'file_diff': (None, None),
                 ...
                 'unspecific': (None, None)},
                [(0,
                  '[database] Last backup was at 2016-07-08 20:20:28 (3.6 y ago)',
                  [('backup_age_database', 112340372.0, None, None, None, None)]),
                 (0,
                  '[log] Last backup was at 2016-07-12 09:09:42 (3.6 y ago)',
                  [('backup_age_log', 112035018.0, None, None, None, None)]),
                 (0,
                  '[database diff] Last backup was at 2016-07-11 20:20:07 (3.6 y ago)',
                  [('backup_age_database_diff', 112081193.0, None, None, None, None)])]),
               ('MSSQL_SQL0x4 msdb',
                {'database': (None, None),
                 'database_diff': (None, None),
                 'file_diff': (None, None),
                 ...
                 'unspecific': (None, None)},
                [(0,
                  '[database] Last backup was at 2016-07-08 20:20:43 (3.6 y ago)',
                  [('backup_age_database', 112340357.0, None, None, None, None)]),
                 (1, 'No backup found', [])]),
               ('MSSQL_SQL0x4 tempdb',
                {'database': (None, None),
                 'database_diff': (None, None),
