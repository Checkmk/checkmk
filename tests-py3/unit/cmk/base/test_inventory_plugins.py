...
def test_items_sorted_by_dependency(monkeypatch, inv_info, expected_order):
...
def test_items_sorted_by_dependency_cyclic(monkeypatch):
    monkeypatch.setattr(
...
def test_items_sorted_by_dependency_unknown(monkeypatch):
