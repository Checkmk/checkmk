...
# This is run against every Python from 2.7 up, so no pathlib and no f-strings
import os
import sys
...
def test_parse_report_lines_error(lines: list, expected_error: str) -> None:
...
def test_error_from_trailer(fields: list, expected_error: str) -> None:
