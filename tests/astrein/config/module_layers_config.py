...
COMPONENTS: Mapping[Component, ImportCheckerProtocol] = {
    ...
    **{
    ...
    Component("cmk.update_config.nonfree.ultimate"): _allow(
        *PACKAGE_CCC,
        *PACKAGE_PLUGIN_APIS,
        *PACKAGE_TRACE,
        *PACKAGE_WERKS,
    ...
    **{Component(f"cmk.utils.{module}"): _allow(*PACKAGE_CCC) for module in CLEAN_UTILS_MODULES},
    ...
    Component("tests.unit.cmk.product_usage"): _allow(
        *PACKAGE_CCC,
        "cmk.utils",
        "cmk.product_usage",
    ),
...
_EXPLICIT_FILE_TO_COMPONENT = {
    ...
    ModulePath("bin/cmk-migrate-oracle-rulesets.py"): Component("cmk.update_config"),
