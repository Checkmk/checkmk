...
def test_test_check_1(request, site: Site, web) -> None:  # type:ignore[no-untyped-def]
...
@pytest.mark.skipif(cmk_version.is_raw_edition(), reason="flaky on raw edition")
def test_test_check_2(request, site, web) -> None:  # type:ignore[no-untyped-def]
    host_name = "check-variables-test-host"
...
@pytest.mark.skipif(cmk_version.is_raw_edition(), reason="flaky on raw edition")
def test_check_factory_settings(request, site: Site, web) -> None:  # type:ignore[no-untyped-def]
