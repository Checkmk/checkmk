...
def test_test_check_1_merged_rule(request, site: Site, web) -> None:  # type:ignore[no-untyped-def]
...
def test_test_check_1_all_rule(request, site: Site, web) -> None:  # type:ignore[no-untyped-def]
