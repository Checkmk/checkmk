...
from cmk.utils.plugin_loader import _find_modules  # pylint: disable=cmk-module-layer-violation

from cmk.base.core_nagios import HostCheckConfig  # pylint: disable=cmk-module-layer-violation

from cmk.discover_plugins import PluginLocation  # pylint: disable=cmk-module-layer-violation
from cmk.validate_plugins import _AgentBasedPlugins  # pylint: disable=cmk-module-layer-violation
