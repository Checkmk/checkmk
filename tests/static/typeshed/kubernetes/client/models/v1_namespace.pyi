# Stubs for kubernetes.client.models.v1_namespace (Python 2)
#
# NOTE: This dynamically typed stub was automatically generated by stubgen.

from typing import Any, Optional
from . import V1ObjectMeta, V1NamespaceStatus
...
class V1Namespace:
    ...
    @property
    def status(self) -> Optional[V1NamespaceStatus]: ...
    @status.setter
    def status(self, status: Optional[V1NamespaceStatus]) -> None: ...
    def to_dict(self): ...
    def to_str(self): ...
