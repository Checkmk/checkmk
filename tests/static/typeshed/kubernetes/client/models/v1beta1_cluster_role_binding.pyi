# Stubs for kubernetes.client.models.v1beta1_cluster_role_binding (Python 2)
#
...
class V1beta1ClusterRoleBinding:
    ...
    role_ref: Any = ...
    subjects: Any = ...
    def __init__(self, api_version: Optional[Any] = ..., kind: Optional[Any] = ..., metadata: Optional[Any] = ..., role_ref: Optional[Any] = ..., subjects: Optional[Any] = ...) -> None: ...
    @property
