# Stubs for kubernetes.client.models.v1beta2_daemon_set_spec (Python 2)
#
...
class V1beta2DaemonSetSpec:
    ...
    template: Any = ...
    update_strategy: Any = ...
    def __init__(self, min_ready_seconds: Optional[Any] = ..., revision_history_limit: Optional[Any] = ..., selector: Optional[Any] = ..., template: Optional[Any] = ..., update_strategy: Optional[Any] = ...) -> None: ...
    @property
