# Stubs for kubernetes.client.models.v2beta1_object_metric_status (Python 2)
#
...
class V2beta1ObjectMetricStatus:
    ...
    selector: Any = ...
    target: Any = ...
    def __init__(self, average_value: Optional[Any] = ..., current_value: Optional[Any] = ..., metric_name: Optional[Any] = ..., selector: Optional[Any] = ..., target: Optional[Any] = ...) -> None: ...
    @property
