...
from tests.system.gui.testlib.playwright.pom.customize.dashboard_properties_old import (
    CreateDashboard,
    EditDashboard,
)
from tests.system.gui.testlib.playwright.pom.monitor.custom_dashboard_old import CustomDashboard
from tests.system.gui.testlib.playwright.pom.monitor.dashboard_old import (
    MainDashboard,
    SummaryDashletType,
)
from tests.system.gui.testlib.playwright.pom.monitor.hosts_dashboard_old import (
    LinuxHostsDashboard,
)
from tests.system.gui.testlib.playwright.pom.tactical_overview_snapin import TacticalOverviewSnapin
