...
from tests.system.gui.testlib.playwright.pom.monitor.dashboard import DashboardMobile
...
def browser_context_args(
    ...
    This overrides the `browser_context_args` fixture from system/gui/testlib/playwright/plugin.py.
    """
    return {
