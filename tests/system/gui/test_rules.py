...
from tests.system.gui.testlib.playwright.pom.setup.add_rule_cpu_load import AddRuleCPULoad
from tests.system.gui.testlib.playwright.pom.setup.add_rule_disk_io_levels import (
    AddRuleDiskIOLevels,
)
from tests.system.gui.testlib.playwright.pom.setup.add_rule_periodic_discovery import (
...
def _get_tasks() -> dict[str, list[dict[str, str]]]:
    tasks_file_path = repo_path() / "tests" / "system" / "gui" / "customize_rules.json"
