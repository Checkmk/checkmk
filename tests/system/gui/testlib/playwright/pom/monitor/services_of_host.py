...
from tests.system.gui.testlib.playwright.services_table import ServicesTable
...
class ServicesOfHostPage(CmkPage):
    ...
    def validate_page(self) -> None:
        ...
        self.page.wait_for_url(url=re.compile(re.escape("view_name=host")), wait_until="load")
