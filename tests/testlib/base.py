...
KNOWN_AUTO_MIGRATION_FAILURES = [
    ...
    ('check', 'esx_vsphere_hostsystem_cpu_usage'),
    ('check', 'esx_vsphere_hostsystem_cpu_util_cluster'),
    ('check', 'esx_vsphere_hostsystem_maintenance'),
    ('check', 'esx_vsphere_hostsystem_mem_usage'),
    ('check', 'esx_vsphere_hostsystem_mem_usage_cluster'),
    ('check', 'esx_vsphere_hostsystem_multipath'),
    ('check', 'esx_vsphere_hostsystem_state'),
    ('check', 'if64'),
    ('check', 'if64adm'),
    ('check', 'if_fortigate'),
