...
class HostTagGroupClient(RestApiClient):
    ...
    def create(
        ...
        identification_field_name: str = "id",
        expect_ok: bool = True,
    ) -> Response:
        body = {"title": title, "tags": tags}
        body[identification_field_name] = ident
...
class ServiceDiscoveryClient(RestApiClient):
    ...
    def bulk_discovery(
        ...
        mode: str | None = None,
        monitor_undecided_services: bool | None = None,
        remove_vanished_services: bool | None = None,
        update_service_labels: bool | None = None,
        update_host_labels: bool | None = None,
        ...
        options = {}
        if monitor_undecided_services is not None:
            options["monitor_undecided_services"] = monitor_undecided_services
        if remove_vanished_services is not None:
            options["remove_vanished_services"] = remove_vanished_services
        if update_service_labels is not None:
            options["update_service_labels"] = update_service_labels
        if update_host_labels is not None:
            options["update_host_labels"] = update_host_labels
