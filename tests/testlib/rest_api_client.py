...
class UserClient(RestApiClient):
    ...
    def create(
        ...
        *,
        ...
        interface_options: dict[str, Any] | None = None,
...
class GraphClient(RestApiClient):
    ...
    def discover_custom_graphs(
        ...
        return self.request(
            "post",
            url=f"/domain-types/{self.domain}/actions/discover_custom_graphs/invoke",
            body={
...
class OtelConfigClient(RestApiClient):
    ...
    def get_receiver(self, config_id: str, expect_ok: bool = True) -> Response:
        return self.request(
            "get",
...
class MonitorHostsClient(RestApiClient):
    ...
    def service_action_menu(
        ...
        return self.request(
            "get",
            url=f"/monitor/hosts/{hostname}/service/action_menu",
            query_params={"site_id": site_id, "service_name": service_name},
            expect_ok=expect_ok,
        )
    ...
    def reschedule(
        ...
        return self.request(
            "post",
            url="/monitor/hosts/actions/reschedule",
            body=_only_set_keys(
                {
                    "hosts": hosts,
