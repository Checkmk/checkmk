        ...
        'tree': {
            ...
            'aggr_treestate': ({
                ...
                ({
                    ...
                    'host': ('heute', 'heute'),
                    'reqhosts': [('heute', 'heute')],
                    'service': 'Check_MK HW/SW '
                               'Inventory',
                    'title': 'heute - Check_MK HW/SW '
                             'Inventory',
                    'type': 1
                }),
                    ({
...
@pytest.mark.parametrize("webapi_data", [
    legacy_response_example,
    latest_response_example,
])
