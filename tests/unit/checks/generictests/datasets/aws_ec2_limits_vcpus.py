...
info = [[
    ...
    u'["running_ondemand_instances___vcpu",', u'"Running', u'On-Demand',
    u'Standard', u'(A,', u'C,', u'D,', u'H,', u'I,', u'M,', u'R,', u'T,',
    u'Z)', u'instances', u'vCPUs",', u'1152,', u'8],',
    u'["running_ondemand_instances_t2.nano",', u'"Running', u'On-Demand',
    u't2.nano', u'Instances",', u'20,', u'2],',
    u'["running_ondemand_instances_total",', u'"Total', u'Running',
    u'On-Demand', u'Instances",', u'20,', u'5],',
    ...
    u'20,', u'0],', u'["active_spot_fleet_requests",', u'"Active', u'Spot',
    u'Fleet', u'Requests",', u'1000,', u'0],',
...
checks = {
    '': [(None, {
        ...
        'running_ondemand_instances': [('a1.2xlarge', (None, 80.0, 90.0)),
        ...
        'running_ondemand_instances_vcpus': [('__vcpu', (None, 80.0, 90.0)),
        ...
        'vpc_sec_groups': (None, 80.0, 90.0)
         ...
         [(u'aws_ec2_running_ondemand_instances_t2.medium', 3, None, None, None, None),
          (u'aws_ec2_running_ondemand_instances___vcpu', 8, None, None, None, None),
          (u'aws_ec2_running_ondemand_instances_t2.nano', 2, None, None, None, None),
          (u'aws_ec2_running_ondemand_instances_total', 5, None, None, None, None),
          (u'aws_ec2_vpc_elastic_ip_addresses', 0, None, None, None, None),
          (u'aws_ec2_elastic_ip_addresses', 0, None, None, None, None),
          (u'aws_ec2_spot_inst_requests', 0, None, None, None, None),
          (u'aws_ec2_active_spot_fleet_requests', 0, None, None, None, None),
          (u'aws_ec2_spot_fleet_total_target_capacity', 0, None, None, None, None)]),
        (0,
         ...
         (None, {
             'vpc_elastic_ip_addresses': (None, 80.0, 90.0),
             'running_ondemand_instances': [('t2.nano', (10, 80.0, 90.0)),
          ...
          [(2,
            ...
            [(u'aws_ec2_running_ondemand_instances_t2.medium', 3, None, None, None, None),
             ...
             (u'aws_ec2_spot_fleet_total_target_capacity', 0, None, None, None, None)]),
           (0,
            u'\nActive Spot Fleet Requests: 0 (of max. 1000)\nElastic IP Addresses: 0 (of max. 5)\nRunning On-Demand Standard (A, C, D, H, I, M, R, T, Z) instances vCPUs: 8 (of max. 10), Usage: 80.0% (warn/crit at 50.0%/70.0%)(!!)\nRunning On-Demand t2.medium Instances: 3 (of max. 10)\nRunning On-Demand t2.nano Instances: 2 (of max. 10)\nSpot Fleet Requests Total Target Capacity: 0 (of max. 5000)\nSpot Instance Requests: 0 (of max. 20)\nTotal Running On-Demand Instances: 5 (of max. 20)\nVPC Elastic IP Addresses: 0 (of max. 5)',
            [])])]
}
