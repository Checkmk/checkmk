...
info = [
    ['[["web_acls",', '"Web', 'ACLs",', '100,', '1,', '"CloudFront"],', '["rule_groups",', '"Rule',
     'groups",', '100,', '1,', '"CloudFront"],', '["ip_sets",', '"IP', 'sets",', '100,', '0,',
     '"CloudFront"],', '["regex_pattern_sets",', '"Regex', 'sets",', '10,', '1,', '"CloudFront"]]'],
    ['[["web_acls",', '"Web', 'ACLs",', '100,', '1,', '"eu-central-1"],', '["rule_groups",',
     '"Rule', 'groups",', '100,', '1,', '"eu-central-1"],', '["ip_sets",', '"IP', 'sets",', '100,',
     '1,', '"eu-central-1"],', '["regex_pattern_sets",', '"Regex', 'sets",', '10,', '1,',
     '"eu-central-1"]]'],
