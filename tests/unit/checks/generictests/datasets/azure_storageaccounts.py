...
checks = {
    ...
    'flow': [
        ...
        (u'st0ragetestaccount', {'egress_levels': (100 * MB, 200 * MB)}, [
    ...
    'performance': [
        (u'glastonburydiag381', 'default', [
            (0, 'Success server latency: 20105 ms', [('server_latency', 20.105, None, None, 0, None)]),
            (0, 'End-to-end server latency: 37606 ms', [('e2e_latency', 37.606, None, None, 0, None)]),
            (0, 'Availability: 190700.0%', [('availability', 190700.0, None, None, 0, None)]),
        ]),
        (u'st0ragetestaccount', 'default', [
            (0, 'Success server latency: 5624 ms', [('server_latency', 5.624, None, None, 0, None)]),
            (0, 'End-to-end server latency: 9584 ms', [('e2e_latency', 9.584, None, None, 0, None)]),
