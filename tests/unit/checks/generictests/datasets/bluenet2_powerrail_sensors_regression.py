...
discovery = {
    "": [],
    "rcm": [],
    "temp": [("Sensor Master 4/255", {}), ("Sensor PDU 1 4/1", {}), ("Sensor PDU 2 4/1", {})],
    "humidity": [
...
checks = {
    ...
    "humidity": [
        (
            "Sensor Master 4/255",
            (5, 8, 75, 80),
            [(0, "63.40%", [("humidity", 63.400000000000006, 75, 80, 0, 100)]), (0, "OK", [])],
        ),
        (
            "Sensor PDU 1 4/1",
            (5, 8, 75, 80),
            [(0, "39.80%", [("humidity", 39.800000000000004, 75, 80, 0, 100)]), (0, "OK", [])],
        ),
        (
            "Sensor PDU 2 4/1",
            (5, 8, 75, 80),
            [(0, "46.50%", [("humidity", 46.5, 75, 80, 0, 100)]), (0, "OK", [])],
        ),
    ],
}
