...
checks = {'': [('SUMMARY',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '10.77% used (94 of 873 TB), trend: 0 B / 24 hours',
                  [('SUMMARY',
                    98566144.0,
                    732325478.4,
                    823866163.2,
               ...
               (u'.rgw.root',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0% used (11.1 kB of 242 TB), trend: 0 B / 24 hours',
                  [(u'.rgw.root',
               ...
               (u'ceph-bench',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.003% used (6.21 GB of 242.01 TB), trend: 0 B / 24 hours',
                  [(u'ceph-bench',
                    6359.039999991655,
                    203009400.83200002,
                    228385575.936,
               ...
               (u'default.rgw.buckets.data',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.17% used (425 GB of 242.42 TB), trend: 0 B / 24 hours',
                  [(u'default.rgw.buckets.data',
                    435200.0,
                    203352473.6,
                    228771532.8,
               ...
               (u'default.rgw.buckets.index',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0% used (0 B of 242 TB), trend: 0 B / 24 hours',
                  [(u'default.rgw.buckets.index',
                    0.0,
                    203004313.6,
                    228379852.8,
               ...
               (u'default.rgw.log',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0% used (149 B of 242 TB), trend: 0 B / 24 hours',
                  [(u'default.rgw.log',
               ...
               (u'default.rgw.meta',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0% used (73.6 kB of 242 TB), trend: 0 B / 24 hours',
                  [(u'default.rgw.meta',
                    0.07187500596046448,
                    203004313.6575,
                    228379852.8646875,
               ...
               (u'rados-bench-ude.ec',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.001% used (6.6 GB of 544.01 TB), trend: 0 B / 24 hours',
                  [(u'rados-bench-ude.ec',
                    6758.399999976158,
                    456345681.92,
                    513388892.16,
               ...
               (u'rados-bench.ec',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.001% used (6.59 GB of 544.01 TB), trend: 0 B / 24 hours',
                  [(u'rados-bench.ec',
                    6748.159999966621,
                    456345673.7279999,
                    513388882.94399995,
               ...
               (u'rbd',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '8.16% used (21.5 of 263.5 TB), trend: 0 B / 24 hours',
               ...
               (u'rbd-rub.ec',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '3.44% used (19.4 of 563.4 TB), trend: 0 B / 24 hours',
                  [(u'rbd-rub.ec',
                    20342374.399999976,
                    472614174.72,
                    531690946.56,
               ...
               (u'rub-s3.ec',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0% used (4.88 kB of 272 TB), trend: 0 B / 24 hours',
                  [(u'rub-s3.ec',
               ...
               (u'scbench',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.0009% used (2.32 GB of 242 TB), trend: 0 B / 24 hours',
                  [(u'scbench',
                    2375.6800000071526,
                    203006214.14400002,
                    228381990.912,
