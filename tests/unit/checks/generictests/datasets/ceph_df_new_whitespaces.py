...
checks = {'': [('SUMMARY',
               ...
               (u'cephfs_data',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '2.08% used (1.60 of 77.00 GB), trend: 0.00 B / 24 hours',
                  [(u'cephfs_data',
                    1638.3999999999942,
                    63078.4,
                    70963.2,
                    0,
                    78848.0),
                   ('fs_size', 78848.0, None, None, None, None),
                   ('growth', 0.0, None, None, None, None),
                   ('trend', 0, None, None, 0, 3285.3333333333335)])]),
               (u'cephfs_metadata',
                {'inodes_levels': (10.0, 5.0),
                 'levels': (80.0, 90.0),
                 'levels_low': (50.0, 60.0),
                ...
                [(0,
                  ...
                  [(u'cephfs_metadata', 32.0, 63078.4, 70963.2, 0, 78848.0),
                   ('fs_size', 78848.0, None, None, None, None),
                   ('growth', 0.0, None, None, None, None),
                   ('trend', 0, None, None, 0, 3285.3333333333335)])])]}