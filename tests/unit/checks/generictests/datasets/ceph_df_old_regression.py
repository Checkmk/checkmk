...
checks = {'': [('SUMMARY',
               ...
               (u'cephfs01-cache',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '9.7% used (79.77 of 823.77 GB), trend: 0.00 B / 24 hours',
               ...
               (u'cephfs01_meta',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.0172% used (131.00 MB of 744.13 GB), trend: 0.00 B / 24 hours',
               ...
               (u'rbd-cache',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '5.1% used (39.70 of 783.70 GB), trend: 0.00 B / 24 hours',
               ...
               (u'seafile-blocks',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.559% used (685.00 GB of 119.67 TB), trend: 0.00 B / 24 hours',
                  [(u'seafile-blocks',
                    701440.0,
                    100385587.2,
                    112933785.6,
               ...
               (u'seafile-blocks-cache',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '16.7% used (149.00 of 893.00 GB), trend: 0.00 B / 24 hours',
                  [(u'seafile-blocks-cache',
                    152576.0,
                    731545.6,
                    822988.8,
               ...
               (u'seafile-commits',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.0362% used (276.00 MB of 744.27 GB), trend: 0.00 B / 24 hours',
