...
checks = {'': [('SUMMARY',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '7.0% used (14 of 200 TB), trend: 0 B / 24 hours',
                  [('SUMMARY',
                    14680064.0,
                    167772160.0,
                    188743680.0,
               ...
               (u'cephfs01',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '3.67% used (4.53 of 123.53 TB), trend: 0 B / 24 hours',
                  [(u'cephfs01',
                    4754432.0,
                    103627980.8,
                    116581478.4,
               ...
               (u'cephfs01-cache',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '9.68% used (79.77 of 823.77 GB), trend: 0 B / 24 hours',
               ...
               (u'cephfs01_meta',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.02% used (131 MB of 744.13 GB), trend: 0 B / 24 hours',
               ...
               (u'rbd',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '2.49% used (3.03 of 122.03 TB), trend: 0 B / 24 hours',
               ...
               (u'rbd-cache',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '5.07% used (39.7 of 783.7 GB), trend: 0 B / 24 hours',
               ...
               (u'seafile-blocks',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.56% used (685 GB of 119.67 TB), trend: 0 B / 24 hours',
                  [(u'seafile-blocks',
                    701440.0,
                    100385587.2,
                    112933785.6,
               ...
               (u'seafile-blocks-cache',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '16.69% used (149 of 893 GB), trend: 0 B / 24 hours',
                  [(u'seafile-blocks-cache',
                    152576.0,
                    731545.6,
                    822988.8,
               ...
               (u'seafile-commits',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.04% used (276 MB of 744.27 GB), trend: 0 B / 24 hours',
               ...
               (u'seafile-fs',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '1.48% used (11.14 of 755.14 GB), trend: 0 B / 24 hours',
