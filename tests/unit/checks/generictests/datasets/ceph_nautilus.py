    ...
    '': [
        (
            'SUMMARY', {
                ...
                (
                    0,
                    '3.57% used (3 of 84 TB), trend: 0 B / 24 hours',
                    [
                        (
        ...
        (
            u'.rgw.root', {
                ...
                (
                    0,
                    '0.000001% used (288 kB of 25 TB), trend: 0 B / 24 hours',
                    [
                        (
        ...
        (
            u'cephfs_data', {
                ...
                (
                    0,
                    '0% used (0 B of 25 TB), trend: 0 B / 24 hours', [
                        (
        ...
        (
            u'cephfs_metadata', {
                ...
                (
                    0,
                    '0.000004% used (969 kB of 25 TB), trend: 0 B / 24 hours',
                    [
                        (
        ...
        (
            u'cinder-volumes', {
                ...
                (
                    0,
                    '6.72% used (1.8 of 26.8 TB), trend: 0 B / 24 hours',
                    [
                        (
        ...
        (
            u'glance-images', {
                ...
                (
                    0,
                    '0.29% used (75 GB of 25.07 TB), trend: 0 B / 24 hours',
                    [
                        (
        ...
        (
            u'nova-vms', {
                ...
                (
                    0,
                    '3.85% used (1 of 26 TB), trend: 0 B / 24 hours',
                    [
                        (
