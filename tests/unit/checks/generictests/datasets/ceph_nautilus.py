                ...
                (
                    0, 'Used: 3.57% - 3.00 TiB of 84.0 TiB', [
                        (
                            ...
                            None
                        ), ('fs_free', 84934656.0, None, None, 0, None),
                        (
                ...
                (
                    0, 'Used: <0.01% - 2.60 KiB of 25.0 TiB', [
                        (
                            ...
                            20971520.00203125, 23592960.002285156, 0, None
                        ), ('fs_free', 26214400.0, None, None, 0, None),
                        (
            ...
            'cephfs_data', {
                ...
                (
                    0, 'Used: 0% - 0 B of 25.0 TiB', [
                        ('fs_used', 0.0, 20971520.0, 23592960.0, 0, None),
                        ('fs_free', 26214400.0, None, None, 0, None),
                ...
                (
                    0, 'Used: <0.01% - 15.0 KiB of 25.0 TiB', [
                        (
                            ...
                            23592960.013183594, 0, None
                        ), ('fs_free', 26214400.0, None, None, 0, None),
                        (
                            'fs_used_percent', 5.587935444570369e-08, 80.0, 90.0, 0.0, 100.0
                        ), ('fs_size', 26214400.014648438, None, None, 0, None)
                    ]
                )
            ]
        ),
            ...
            'cinder-volumes', {
                ...
                (
                    0, 'Used: 2.35% - 616 GiB of 25.6 TiB', [
                        ('fs_used', 630784.0, 21476147.2, 24160665.6, 0, None),
                        ('fs_free', 26214400.0, None, None, 0, None),
                        (
            ...
            'glance-images', {
                ...
                (
                    0, 'Used: 0.10% - 25.0 GiB of 25.0 TiB', [
                        ('fs_used', 25600.0, 20992000.0, 23616000.0, 0, None),
                        ('fs_free', 26214400.0, None, None, 0, None),
                        (
            ...
            'nova-vms', {
                ...
                (
                    0, 'Used: 1.34% - 349 GiB of 25.3 TiB', [
                        ('fs_used', 357376.0, 21257420.8, 23914598.4, 0, None),
                        ('fs_free', 26214400.0, None, None, 0, None),
                        (
