...
info = [
    ...
    ['"store_stats":', "{"],
    ['"bytes_total":', "731100461,"],
    ['"bytes_sst":', "0,"],
    ['"bytes_log":', "1384653,"],
    ['"bytes_misc":', "729715808,"],
    ...
    ['"store_stats":', "{"],
    ['"bytes_total":', "728622881,"],
    ['"bytes_sst":', "0,"],
    ['"bytes_log":', "969152,"],
    ['"bytes_misc":', "727653729,"],
    ['"last_updated":', '"0.000000"'],
    ["},"],
    ['"health":', '"HEALTH_OK"'],
    ["},"],
    ...
    ['"store_stats":', "{"],
    ['"bytes_total":', "729631480,"],
    ['"bytes_sst":', "0,"],
    ['"bytes_log":', "2220377,"],
    ['"bytes_misc":', "727411103,"],
    ['"last_updated":', '"0.000000"'],
    ["},"],
    ['"health":', '"HEALTH_OK"'],
    ["}"],
    ...
    ['"summary":', '"too', "many", "PGs", "per", "OSD", "(409", ">", "max", '300)"'],
    ["},"],
    ["{"],
    ['"severity":', '"HEALTH_WARN",'],
    [
    ...
    ['"rank":', "0,"],
    ['"name":', '"charon",'],
    ['"addr":', '"10.249.12.121:6789\\/0"'],
    ["},"],
    ["{"],
    ['"rank":', "1,"],
    ['"name":', '"nix",'],
    ['"addr":', '"10.249.12.122:6789\\/0"'],
    ["},"],
    ["{"],
    ['"rank":', "2,"],
    ['"name":', '"hydra",'],
    ...
    ['"version":', "15285527,"],
    ['"num_pgs":', "6400,"],
    ['"data_bytes":', "9321031634464,"],
    ['"bytes_used":', "14768864055296,"],
    ['"bytes_avail":', "205284138250240,"],
    ['"bytes_total":', "220053002305536,"],
    ['"read_bytes_sec":', "291,"],
    ['"read_op_per_sec":', "0,"],
    ['"write_op_per_sec":', "0"],
    ["},"],
...
discovery = {"": [(None, {})], "osds": [(None, {})], "pgs": [(None, {})], "mgrs": []}
