...
checks = {
    "": [
        ("my_vsid1 0", {}, [(0, "Type: VSX Gateway", []), (0, "Main IP: 192.168.1.11", [])]),
        ("my_vsid2 1", {}, [(0, "Type: VSX Gateway", []), (0, "Main IP: 192.168.1.111", [])]),
    ],
    "connections": [
        (
            "my_vsid1 0",
            ...
            [
                (0, "Used connections: 104470", [("connections", 104470, None, None, None, None)]),
    ...
    "packets": [
        (
            ...
            [
                (
                    0,
                    "Total number of packets processed: 0 1/s",
                    [("packets", 0.0, None, None, None, None)],
                ),
                (
                    0,
                    "Total number of accepted packets: 0 1/s",
                    [("packets_accepted", 0.0, None, None, None, None)],
                ),
                (
                    0,
                    "Total number of dropped packets: 0 1/s",
    ...
    "traffic": [
        (
            ...
            [
                (
                    0,
                    "Total number of bytes accepted: 0.00 B/s",
                    [("bytes_accepted", 0.0, None, None, None, None)],
                ),
                (
                    0,
                    "Total number of bytes dropped: 0.00 B/s",
                    [("bytes_dropped", 0.0, None, None, None, None)],
                ),
                (
                    0,
                    "Total number of bytes rejected: 0.00 B/s",
