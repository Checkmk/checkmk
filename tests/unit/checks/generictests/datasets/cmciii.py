...
info = [
    ...
    [['1.1', 'Temperature.DescName', '1', '', '0', 'Temperature', '0'],
     ...
     ['1.4', 'Temperature.SetPtHighAlarm', '3', 'degree C', '-100', '45.00 degree C', '4500'],
     ['1.5', 'Temperature.SetPtHighWarning', '4', 'degree C', '-100', '40.00 degree C', '4000'],
     ['1.6', 'Temperature.SetPtLowWarning', '9', 'degree C', '-100', '10.00 degree C', '1000'],
     ...
     [
         '1.56', 'System.Temperature.SetPtHighAlarm', '3', 'degree C', '-100', '80.00 degree C',
         '8000'
    ],
        [
         '1.57', 'System.Temperature.SetPtHighWarning', '4', 'degree C', '-100', '70.00 degree C',
         '7000'
    ],
        [
         '1.58', 'System.Temperature.SetPtLowWarning', '9', 'degree C', '-100', '-25.00 degree C',
         '-2500'
    ],
        [
         '1.59', 'System.Temperature.SetPtLowAlarm', '5', 'degree C', '-100', '-30.00 degree C',
         '-3000'
        ...
        ['3.4', 'Temperature.SetPtHighAlarm', '3', 'degree C', '-100', '40.00 degree C', '4000'],
        ['3.5', 'Temperature.SetPtHighWarning', '4', 'degree C', '-100', '35.00 degree C', '3500'],
        ['3.6', 'Temperature.SetPtLowWarning', '9', 'degree C', '-100', '10.00 degree C', '1000'],
...
checks = {
    ...
    'io': [
        ('CMC-IOModul Input 1', {}, [(0, 'Status: OK, Logic: 0:OK / 1:Alarm, Delay: 5.0 s', [])]),
        ('CMC-IOModul Input 2', {}, [(0, 'Status: OK, Logic: 0:OK / 1:Alarm, Delay: 5.0 s', [])]),
        ('CMC-IOModul Input 3', {}, [(0, 'Status: Off, Logic: 0:On / 1:Off, Delay: 5.0 s', [])]),
        ('CMC-IOModul Input 4', {}, [(0, 'Status: OK, Logic: 0:Alarm / 1:OK, Delay: 0.5 s', [])]),
        ('CMC-IOModul Input 5', {}, [(0, 'Status: OK, Logic: 0:Alarm / 1:OK, Delay: 0.5 s', [])]),
        ('CMC-IOModul Input 6', {}, [(0, 'Status: OK, Logic: 0:Alarm / 1:OK, Delay: 0.5 s', [])]),
        ('CMC-IOModul Input 7', {}, [(0, 'Status: Off, Logic: 0:Off / 1:On, Delay: 0.5 s', [])]),
        ('CMC-IOModul Input 8', {}, [(0, 'Status: Off, Logic: 0:Off / 1:On, Delay: 0.5 s', [])]),
        ('CMC-IOModul Output 1', {}, [(0, 'Status: OK, Logic: 0:OK / 1:Alarm, Relay: Off', [])]),
        ('CMC-IOModul Output 2', {}, [(0, 'Status: OK, Logic: 0:OK / 1:Alarm, Relay: Off', [])]),
        ('CMC-IOModul Output 3', {}, [(0, 'Status: OK, Logic: 0:OK / 1:Alarm, Relay: Off', [])]),
        ('CMC-IOModul Output 4', {}, [(0, 'Status: OK, Logic: 0:OK / 1:Alarm, Relay: Off', [])]),
        ('CMC-PU Input 1', {}, [(0, 'Status: Off, Logic: 0:Off / 1:On, Delay: 0.5 s', [])]),
        ('CMC-PU Input 2', {}, [(0, 'Status: Off, Logic: 0:Off / 1:On, Delay: 0.5 s', [])]),
        ('CMC-PU Output', {}, [(2, 'Status: Off, Logic: 0:Off / 1:On, Relay: Off', [])]),
    ],
    'access': [('CMC-PU Access', {}, [(2, 'Door: Inactive, Delay: 10 s, Sensitivity: 0.0', [])])],
    'temp': [
        ('Ambient CMC-PU', {}, [(0, '30.5 °C', [('temp', 30.5, 40.0, 45.0, None, None)])]),
        ('Ambient CMC-Temperatur', {}, [(0, '27.0 °C', [('temp', 27.0, 35.0, 40.0, None, None)])]),
        (
            'Dew Point CMC-Temperatur',
            {},
        ...
        (
            'System CMC-PU',
            {},
            [(0, '[Sys Temp] 32.3 °C', [('temp', 32.3, 70.0, 80.0, None, None)])],
        ),
    ],
    'can_current': [
