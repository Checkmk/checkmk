    ...
    'tieringtypes': [
        (
            u'backup Capacity', {}, [
                (
                    0,
                    'User capacity: 10.75 TB, Consumed capacity: 8.88 TB, Available capacity: 1.86 TB, Percent subscribed: 82.66%, Move up: 17.03 GB, Move down: 0 B, Move within: 0 B',
                    [
                        (
                        ...
                        (
                            'emcvnx_targeted_within', 0.0, None, None, None,
                            None
                        )
                    ]
                )
        ...
        (
            u'backup Performance', {}, [
                (
                    0,
                    'User capacity: 4.3 TB, Consumed capacity: 3.87 TB, Available capacity: 439.86 GB, Percent subscribed: 90.01%, Move up: 0 B, Move down: 17.03 GB, Move within: 0 B',
                    [
                        (
                        ...
                        (
                            'emcvnx_targeted_higher', 0.0, None, None, None,
                            None
                        ),
                        (
    ...
    'tiering': [
        (
            u'backup', {
                ...
                (
                    0,
                    u'Fast cache: Disabled, Relocation status: Inactive, Relocation rate: Medium, Move up: 17.03 GB, Move down: 17.03 GB, Move within: 0 B, Movement completed: 102.7 GB',
                    [
                        (
                ...
                (
                    ...
                    [('emcvnx_time_to_complete', 240, None, None, None, None)]
                )
            ]
        )
    ],
