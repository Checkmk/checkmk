...
checks = {'': [(u'WIN-0100-MCC15-M-L000-SSD',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '24.7% used (1012.89 GB of 4.00 TB), trend: 0.00 B / 24 hours, uncommitted: 0.00 GB, provisioning: 24.7%',
                  [(u'WIN-0100-MCC15-M-L000-SSD',
                    1037195.0,
                    3355238.4,
                    3774643.2,
               ...
               (u'WIN-0108-MCC35-U-L008-SSD-EXC2',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '78.2% used (9.38 of 12.00 TB), trend: 0.00 B / 24 hours, uncommitted: 0.00 GB, provisioning: 78.2%',
                  [(u'WIN-0108-MCC35-U-L008-SSD-EXC2',
                    9836700.0,
                    10066124.8,
                    11324390.4,
