    ...
    '': [
        (
            'foo', {
                ...
                (0, '[/var/log/apport.log.2.gz] Age: 53 days 1 hour, Size: 479.00 B(!!)', []),
                (0, '\nRemaining files: 1', []),
                (0, '\n[/var/log/boot.log] Age: 5 hours 56 minutes, Size: 138.57 kB(!!)', []),
            ]
        ),
    ]
}
