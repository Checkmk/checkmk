...
checks = {'': [(None,
                ...
                [(0,
                 ...
                 (0,
                  'Number of stream rules: 7',
                  [('num_stream_rules', 7, None, None, None, None)]),
                 (0,
          ...
          'elastic': [(None,
                       ...
                       [(0, u'Name: Graylog', []),
                        ...
                        (0,
                         'ID cache size: 0.00 B',
                         [('id_cache_size', 0, None, None, None, None)]),
                        (0,
                         'Field data size: 622.02 kB',
          ...
          'mongodb': [(None,
                       ...
                       [(0, u'Name: Graylog', []),
                        ...
                        (0,
                         'Total size of uncompressed data: 2.26 MB',
                         [('mongodb_collection_size',
                           ...
                           None)]),
                        (0,
                         'Average document size: 323.21 B',
                         [('avg_doc_size',
                           323.20581808249113,
                           None,
                           None,
                        ...
                        (0,
                         'Number of collections: 47',
                         [('num_collections', 47, None, None, None, None)]),
                        (0,
                         'Number of objects: 7322',
