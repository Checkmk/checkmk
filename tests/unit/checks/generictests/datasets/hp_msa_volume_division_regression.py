...
info = [
    ...
    ["volumes", "2", "volume-parent"],
    ["volumes", "2", "snap-pool"],
    ["volumes", "2", "replication-set"],
    ["volumes", "2", "attributes"],
    ["volumes", "2", "virtual-disk-serial", "00c0ff1ec10b0000e423415500000000"],
    ...
    ["volumes", "2", "pi-format-numeric", "0"],
    ["volumes", "2", "health", "OK"],
    ["volumes", "2", "health-numeric", "0"],
    ["volumes", "2", "health-reason"],
    ...
    ["volume-statistics", "2", "serial-number", "00c0ff1ec10b00009925415501000000"],
...
discovery = {
    ...
    "df": [("IMSAKO2B1_U1_B01-04_v0001", {}), ("IMSAKO2B1_U1_B05-08_v0001", {})],
...
checks = {
    "": [
        ...
        (
            ...
            {},
            [(0, "Status: OK, container name: IMSAKO2B1_U1_B05-08 (RAID10)", [])],
        ),
    ],
    "df": [
        (
            ...
            [
                ...
                (
                    2,
                    "Used: 100.00% - 1.20 TB of 1.20 TB (warn/crit at 80.00%/90.00% used)",
                    [
