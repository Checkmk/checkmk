...
info = [[u'volumes', u'1', u'durable-id', u'V3'],
...
discovery = {
    '': [(u'VMFS_ISO', None), (u'VMFS_01', None), (u'VMFS_02', None),
        (u'VMFS_VDI_01', None)],
    'df': [(u'VMFS_ISO', {}), (u'VMFS_01', {}), (u'VMFS_02', {}),
        (u'VMFS_VDI_01', {})],
    'io': [('SUMMARY', 'diskstat_default_levels')]
}

checks = {
    '': [(u'VMFS_ISO', 'default', [(0, u'Status: OK, container name: A (RAID0)', [])]),
         (u'VMFS_01', 'default', [(0, u'Status: OK, container name: A (RAID0)', [])]),
         (u'VMFS_02', 'default', [(0, u'Status: OK, container name: A (RAID0)', [])]),
         (u'VMFS_VDI_01', 'default', [(0, u'Status: OK, container name: A (RAID0)', [])])],
    'df': [
        (u'VMFS_ISO', 'default', [(0, u'A (RAID0)', []),
        ...
        (u'VMFS_VDI_01', 'default', [(0, u'A (RAID0)', []),
