...
discovery = {
    "": [("VMFS_01", None), ("VMFS_02", None), ("VMFS_ISO", None), ("VMFS_VDI_01", None)],
    "df": [("VMFS_01", {}), ("VMFS_02", {}), ("VMFS_ISO", {}), ("VMFS_VDI_01", {})],
...
checks = {
    "": [
        ...
        ("VMFS_VDI_01", {}, [(0, "Status: OK, container name: A (RAID0)", [])]),
    ],
    "df": [
        (
            "VMFS_ISO",
            ...
            [
                ...
                (
                    0,
                    "Used: 24.76% - 24.8 GB of 100.0 GB",
                    [
                        ("fs_used", 23616, 76291.2, 85827.6, 0, 95364.0),
        ...
        (
            ...
            [
                ...
                (
                    2,
                    "Used: 91.37% - 2.01 TB of 2.20 TB (warn/crit at 80.00%/90.00% used)",
                    [
                        ("fs_used", 1916852, 1678236.8, 1888016.4, 0, 2097796.0),
        ...
        (
            ...
            [
                ...
                (
                    0,
                    "Used: 78.78% - 347 GB of 440 GB",
                    [
                        ("fs_used", 330528, 335644.8, 377600.4, 0, 419556.0),
