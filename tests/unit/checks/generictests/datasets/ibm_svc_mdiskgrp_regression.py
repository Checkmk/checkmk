    ...
    '': [
        (
            'Quorum_0', {
                ...
                (
                    0, 'Used: 0% - 0 B of 512 MiB', [
                        ('fs_used', 0.0, 409.6, 460.8, 0, None),
                        ('fs_free', 512.0, None, None, 0, None),
        ...
        (
            'Quorum_2', {
                ...
                (
                    0, 'Used: 0% - 0 B of 704 MiB', [
                        ('fs_used', 0.0, 563.2, 633.6, 0, None),
                        ('fs_free', 704.0, None, None, 0, None),
                        ('fs_used_percent', 0.0, 80.0, 90.0, 0.0, 100.0),
                        ('fs_size', 704.0, None, None, 0, None)
                    ]
                ),
                (
                    0, 'Provisioning: 0%', [
        ...
        (
            'stp5_300G_01', {
                ...
                (
                    2,
                    'Used: 97.18% - 15.9 TiB of 16.3 TiB (warn/crit at 80.00%/90.00% used)',
                    [
                        (
                            'fs_used', 16651386.88, 13706985.472000001,
                            15420358.656, 0, None
                        ),
                        ('fs_free', 482344.95999999903, None, None, 0, None),
                        (
                            'fs_used_percent', 97.18482252141983, 80.0, 90.0, 0.0, 100.0
                        ), ('fs_size', 17133731.84, None, None, 0, None)
                    ]
                ),
                (
        ...
        (
            'stp5_450G_01', {
                ...
                (
                    2,
                    'Used: 98.42% - 19.3 TiB of 19.6 TiB (warn/crit at 80.00%/90.00% used)',
                    [
                        (
                            'fs_used', 20248002.56, 16458448.896000002,
                            18515755.008, 0, None
                        ), ('fs_free', 325058.5600000024, None, None, 0, None),
                        (
                            'fs_used_percent', 98.41997961264015, 80.0, 90.0, 0.0, 100.0
                        ), ('fs_size', 20573061.12, None, None, 0, None)
                    ]
                ),
                (
        ...
        (
            'stp5_450G_02', {
                ...
                (
                    2,
                    'Used: 98.90% - 24.3 TiB of 24.5 TiB (warn/crit at 80.00%/90.00% used)',
                    [
                        (
                            'fs_used', 25438453.76, 20577255.424000002,
                            23149412.352, 0, None
                        ),
                        ('fs_free', 283115.51999999955, None, None, 0, None),
                        (
                            'fs_used_percent', 98.89930697105585, 80.0, 90.0, 0.0, 100.0
                        ), ('fs_size', 25721569.28, None, None, 0, None)
                    ]
                ),
                (
        ...
        (
            'stp5_450G_03', {
                ...
                (
                    0, 'Used: 26.33% - 7.75 TiB of 29.4 TiB', [
                        (
                            'fs_used', 8126464.0, 24687673.344, 27773632.512,
                            0, None
                        ), ('fs_free', 22733127.68, None, None, 0, None),
                        (
                            'fs_used_percent', 26.33367312266395, 80.0, 90.0, 0.0, 100.0
                        ), ('fs_size', 30859591.68, None, None, 0, None)
                    ]
                ),
                (
        ...
        (
            'stp5_600G_01', {
                ...
                (
                    2,
                    'Used: 100.00% - 6.54 TiB of 6.54 TiB (warn/crit at 80.00%/90.00% used)',
                    [
                        (
                            'fs_used', 6857687.04, 5486149.632, 6171918.336, 0,
                            None
                        ), ('fs_free', 0.0, None, None, 0, None),
                        ('fs_used_percent', 100.0, 80.0, 90.0, 0.0, 100.0),
                        ('fs_size', 6857687.04, None, None, 0, None)
                    ]
                ),
                (
