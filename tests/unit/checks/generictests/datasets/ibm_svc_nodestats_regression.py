...
info = [['1', 'BLUBBSVC01', 'compression_cpu_pc', '0', '0', '140325134931'],
...
discovery = {'cache': [('BLUBBSVC01', None)],
             'cpu_util': [('BLUBBSVC01', 'ibm_svc_cpu_default_levels'),
                          ('BLUBBSVC02', 'ibm_svc_cpu_default_levels')],
             'disk_latency': [('Drives BLUBBSVC01', None),
                              ('MDisks BLUBBSVC01', None),
                              ('VDisks BLUBBSVC01', None)],
             'diskio': [('Drives BLUBBSVC01', None),
                        ('MDisks BLUBBSVC01', None),
                        ('VDisks BLUBBSVC01', None)],
             'iops': [('Drives BLUBBSVC01', None),
                      ('MDisks BLUBBSVC01', None),
                      ('VDisks BLUBBSVC01', None)]}


checks = {'cache': [('BLUBBSVC01',
                     {},
                     [(0,
          ...
          'cpu_util': [('BLUBBSVC01',
                       ...
                       ('BLUBBSVC02',
                        (90.0, 95.0),
                        [(0, 'Total CPU: 1.00%', [('util', 1, 90.0, 95.0, 0, 100)])])],
          'disk_latency': [('Drives BLUBBSVC01',
                            {},
                            [(0,
                              'Latency is 0.00 ms for read, 0.00 ms for write',
                              [('read_latency', 0, None, None, None, None),
                               ('write_latency', 0, None, None, None, None)])]),
                           ('MDisks BLUBBSVC01',
                            {},
                            [(0,
                              'Latency is 5.00 ms for read, 1.00 ms for write',
                              [('read_latency', 5, None, None, None, None),
                               ('write_latency', 1, None, None, None, None)])]),
                           ('VDisks BLUBBSVC01',
                            {},
                            [(0,
                              'Latency is 2.00 ms for read, 0.00 ms for write',
                              [('read_latency', 2, None, None, None, None),
                               ('write_latency', 0, None, None, None, None)])])],
          'diskio': [('Drives BLUBBSVC01',
                      {},
                      [(0,
                     ...
                     ('MDisks BLUBBSVC01',
                      {},
                      [(0,
                        '1.05 MB/s read, 16.80 MB/s write',
