...
extra_sections = {
    # empty lnx_if extra_section for both subchecks
    'fs': [[]],
    'network': [[]],
}
    ...
    'fs': [(u'/dev/sda1', {
        ...
        'trend_range': 24
         ...
         [(u'/dev/sda1', 11133.41015625, 23668.284375, 26626.819921875, 0, 29585.35546875),
          ...
          ('inodes_used', 262652, 3456000.0, 3648000.0, 0, 3840000)])]),
           (u'shm', {
               'inodes_levels': (10.0, 5.0),
               'levels': (80.0, 90.0),
               'levels_low': (50.0, 60.0),
               ...
               'trend_range': 24
                ...
                [(u'shm', 3817.31640625, 7991.828125, 8990.806640625, 0, 9989.78515625),
                 ...
                 ('trend', 0, None, None, 0, 416.2410481770833),
                 ('inodes_used', 87599, 1285999.2, 1357443.5999999999, 0, 1428888)])])],
    'network': [
        (u'cbr0',
         {}, [(0, 'In: 0.00 B/s', [('in', 0.0, None, None, None, None)]),
              ...
              (0, 'Input Discards: 0.00 1/s', [('if_in_discards', 0.0, None, None, None, None)]),
              (0, 'Output Discards: 0.00 1/s', [('if_out_discards', 0.0, None, None, None, None)])]),
        (u'eth0', {},
         [(0, 'In: 0.00 B/s', [('in', 0.0, None, None, None, None)]),
          (0, 'Out: 0.00 B/s', [('out', 0.0, None, None, None, None)]),
          (0, '', [
