...
parsed = [{'filesystem': [{'available': 96380989440,
                           'base_usage': 0,
                          ...
                          {'available': 2068180992,
                           'base_usage': 0,
                           'capacity': 2068193280,
                           'device': '/var/lib/kubelet/pods/50d6471a-b836-4752-a118-3dcc601e584d/volumes/kubernetes.io~secret/kube-proxy-token-6spq2',
                           'has_inodes': True,
                           'inodes': 504930,
                           'inodes_free': 504921,
                           'io_in_progress': 0,
...
checks = {'fs': [('/dev/vda1',
                  {'inodes_levels': (10.0, 5.0),
                   ...
                   'trend_range': 24},
                  [(0,
                    '7.22% used (6.98 of 96.75 GB), trend: 0 B / 24 hours',
                    [('/dev/vda1',
                      7151.8359375,
                      79254.328125,
                      89161.119140625,
                     ...
                     ('trend', 0, None, None, 0, 4127.82958984375),
                     ('inodes_used', 265490, 11612160.0, 12257280.0, 0, 12902400)])]),
                 ('/run/user/1000',
                  {'inodes_levels': (10.0, 5.0),
                   'levels': (80.0, 90.0),
                   'levels_low': (50.0, 60.0),
                 ...
                 ('/var/lib/kubelet/pods/50d6471a-b836-4752-a118-3dcc601e584d/volumes/kubernetes.io~secret/kube-proxy-token-6spq2',
                  {'inodes_levels': (10.0, 5.0),
                   ...
                   'trend_range': 24},
                  [(0,
                    '0.0006% used (12 kB of 1.93 GB), trend: 0 B / 24 hours',
                    [('/var/lib/kubelet/pods/50d6471a-b836-4752-a118-3dcc601e584d/volumes/kubernetes.io~secret/kube-proxy-token-6spq2',
                      0.01171875,
                      1577.90625,
                      1775.14453125,
                     ...
                     ('growth', 0.0, None, None, None, None),
                     ('trend', 0, None, None, 0, 82.1826171875),
                     ('inodes_used', 9, 454437.0, 479683.5, 0, 504930)])])]}