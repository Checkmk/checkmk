...
info = [
    ['Actual Supply Fluid Temp Set Point', '60.8', 'deg F',
     'Ambient Air Temperature', '21.1', 'def C'],
    ['Free Cooling Utilization', '0.0',  '%',
     'Return Fluid Temperature',  '62.1',  'deg F'],
    ['Supply Fluid Temperature', '57.2', 'deg F',
     'Invalid Data for Testsing', 'bogus value', 'Unicycles'],
]


discovery = {'': [('Actual Supply Fluid Temp Set Point', {}),
...
checks = {'': [('Actual Supply Fluid Temp Set Point',
                {},
