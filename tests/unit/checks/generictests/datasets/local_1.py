...
info = [
    ...
    [
        'node_1', 'P', 'Some_other_Service', 'value1=10;30;50|value2=20;10:20;0:50;0;100', 'Result',
...
checks = {
    '': [
        ...
        ('No-Text', {}, [
            (1, u'On node node_2: hirn: -8.00 (warn/crit at -20.00/inf)', [
                ('hirn', -8.0, -20.0, float('inf'), None, None),
            ]),
        ]),
        ('NotGood', {}, [
            (2, 'On node node_1: A critical check', [
                ('V', 120.0, 50.0, 100.0, 0.0, 1000.0),
            ]),
        ]),
        ('Service_FOO', {}, [
            (0, 'On node node_1: This Check is OK', [
                ('V', 1.0, None, None, None, None),
            ]),
        ]),
        ('Some_other_Service', {}, [
            ...
            (1, u'value2: 20.00 (warn/crit at 20.00/50.00)', [
                ('value2', 20.0, 20.0, 50.0, 0.0, 100.0),
            ]),
        ]),
        ('Some_yet_other_Service', {}, [
            (1, u'On node node_1: temp: 40.00 (warn/crit at 30.00/50.00)', [
                ('temp', 40.0, 30.0, 50.0, None, None),
            ]),
            (1, u'humidity: 28.00 (warn/crit below 50.00/0.00)', [
                ('humidity', 28.0, 100.0, 50.0, 0.0, 100.0),
            ]),
        ]),
        ('This_is_OK', {}, [
            (0, 'On node node_1: foo: 18.00', [
                ('foo', 18.0, 20.0, 50.0, None, None),
            ]),
        ]),
        ("D'oh!", {}, [
            (3,
             "On node rogue: Invalid performance data: 'this is an invalid metric'. Output is: I messed up!",
             [
                 ('isotopes', 0.0, None, None, None, None),
             ]),
        ]),
        ('This_is_yay', {}, [
            (0, 'On node node_1: Na Na Na', [('foo', 18.0, 20.0, 50.0, None, None)]),
        ]),
    ]
}
