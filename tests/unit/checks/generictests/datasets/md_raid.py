...
info = [
    ...
    [
        'md2', ':', 'active', 'raid5', 'sdf1[5]', 'sde1[2]', 'sdc1[1]',
        'sdg1[3]', 'sda1[0]'
    ],
    [
        '31255568384', 'blocks', 'super', '1.2', 'level', '5,', '512k',
        'chunk,', 'algorithm', '2', '[5/5]', '[UUUUU]'
    ],
    [
        '[===============>.....]', 'check', '=', '76.0%',
        '(5938607824/7813892096)', 'finish=255.8min', 'speed=122145K/sec'
    ...
    [
        'md6', ':', 'active', 'raid5', 'sde1[3](S)', 'sdd1[0]', 'sdg1[2]',
        'sdf1[1]'
    ],
    [
        '976767872', 'blocks', 'level', '5,', '64k', 'chunk,', 'algorithm',
        '2', '[3/3]', '[UUU]'
    ...
    ['4200952', 'blocks', 'super', '1.0', '[2/2]', '[UU]'], ['resync=PENDING'],
    ...
    ['bitmap:', '1/1', 'pages', '[4KB],', '65536KB', 'chunk'],
    [
        'md14', ':', 'active', 'raid5', 'sda3[0]', 'sdb3[1]', 'sdd3[4]',
        'sdc3[2]'
    ],
    [
        '11686055424', 'blocks', 'super', '1.2', 'level', '5,', '512k',
        'chunk,', 'algorithm', '2', '[4/3]', '[UUU_]'
    ],
    [
        '[======>..............]', 'recovery', '=', '31.8%',
        '(1241578496/3895351808)', 'finish=746.8min', 'speed=59224K/sec'
    ...
    '': [
        ...
        (
            'md2', {}, [
                ...
                (
                    0,
                    '[Check] Finish: 255.8min, Speed: 122145K/sec, Status: 76.0%',
                    []
                )
            ]
        ),
