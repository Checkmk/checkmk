...
info = [
    ...
    ["Spool:           Deferred"],
    ["Count:           1"],
    ["Oldest:          1571143926 (2019-10-15 14:52:06, 68800 sec ago)"],
    ...
    "": [
        (
            ...
            [
                ...
                (
                    1,
                    "2 corrupted files: youngest 2 seconds ago",
                    [
                        ('corrupted_files', 2, None, None, None, None),
                    ],
                ),
                (
                    1,
                    "1 deferred files: oldest 19 hours 6 minutes ago",
                    [
                        ('deferred_age', 68802.0, None, None, None, None),
                        ('deferred_files', 1, None, None, None, None),
                    ],
                )
            ],
        )
