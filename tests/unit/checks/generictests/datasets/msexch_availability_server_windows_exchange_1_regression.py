...
info = [[u'AvailabilityRequestssec',
         u'AverageNumberofMailboxesProcessedperRequest',
         ...
         u'AverageTimetoProcessaFreeBusyRequest',
         u'AverageTimetoProcessaFreeBusyRequest_Base',
         ...
         u'AverageTimetoProcessanIntraSiteFreeBusyRequest_Base',
         u'Caption',
         u'ClientReportedFailuresAutodiscoverFailures',
         u'ClientReportedFailuresConnectionFailures',
         u'ClientReportedFailuresPartialorOtherFailures',
         u'ClientReportedFailuresTimeoutFailures',
         u'ClientReportedFailuresTotal',
         u'CrossForestCalendarFailuressec',
         u'CrossForestCalendarQueriessec',
         u'CrossSiteCalendarFailuressec',
         u'CrossSiteCalendarQueriessec',
         u'CurrentRequests',
         u'Description',
         u'FederatedFreeBusyCalendarQueriesincludingOAuthsec',
         u'FederatedFreeBusyFailuressec',
         u'FederatedFreeBusyFailureswithOAuthsec',
         u'ForeignConnectorQueriessec',
         u'ForeignConnectorRequestFailureRate',
         u'Frequency_Object',
         u'Frequency_PerfTime',
         u'Frequency_Sys100NS',
         u'IntraSiteCalendarFailuressec',
         u'IntraSiteCalendarQueriessec',
         u'IntraSiteProxyFreeBusyCalendarQueriessec',
         u'IntraSiteProxyFreeBusyFailuressec',
         u'Name',
         u'PublicFolderQueriessec',
         u'PublicFolderRequestFailuressec',
         ...
         u'SuccessfulClientReportedRequestsOver20seconds',
         u'SuccessfulClientReportedRequestsTotal',
         u'SuggestionsRequestssec',
         u'Timestamp_Object',
