    ...
    "": [
        (
            ...
            [
                ...
                (
                    0,
                    "Unallocated space: 1.59 MiB, 30.29%",
                    [("unallocated", 1667235.84, None, None, None, None)],
                ),
                (
                    0,
                    "Reserved space: 2.41 MiB, 45.83%",
                    [("reserved", 2523136.0, None, None, None, None)],
                ),
        ...
        (
            ...
            [
                (
                    1,
                    "Size: 5.25 MiB (warn/crit at 3.00 MiB/6.00 MiB)",
                    [("size", 5505024.0, 3 * 1024**2, 6 * 1024**2, None, None)],
                ),
                (
                    0,
                    "Unallocated space: 1.59 MiB, 30.29%",
