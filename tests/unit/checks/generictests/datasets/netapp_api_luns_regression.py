...
checks = {
    '': [('crm_dblogs_lu01', {
        ...
        'levels': (80.0, 90.0),
        'trend_perfdata': True
    }, [(1, '83.65% used (501.91 of 600.04 GB), trend: 0 B / 24 hours',
         ...
         ('crm_dbprod_lu01', {
             ...
             'levels': (80.0, 90.0),
             'trend_perfdata': True
         }, [(1, '89.53% used (2.15 of 2.4 TB), trend: 0 B / 24 hours',
         ...
         ('crm_dbtemp_lu01', {
             ...
             'levels': (80.0, 90.0),
             'trend_perfdata': True
         }, [(1, '83.38% used (542.04 of 650.06 GB), trend: 0 B / 24 hours',
         ...
         ('nice_db_lun', {
             ...
             'levels': (80.0, 90.0),
             'trend_perfdata': True
         }, [(0, '67.6% used (405.63 of 600.04 GB), trend: 0 B / 24 hours',
