...
checks = {
    '': [('crm_dblogs_lu01', {
        ...
        'levels': (80.0, 90.0),
        'trend_perfdata': True
    }, [(1, '83.6% used (501.91 of 600.04 GB), trend: 0.00 B / 24 hours',
         ...
         ('crm_dbprod_lu01', {
             ...
             'levels': (80.0, 90.0),
             'trend_perfdata': True
         }, [(1, '89.5% used (2.15 of 2.40 TB), trend: 0.00 B / 24 hours',
         ...
         ('crm_dbtemp_lu01', {
             ...
             'levels': (80.0, 90.0),
             'trend_perfdata': True
         }, [(1, '83.4% used (542.04 of 650.06 GB), trend: 0.00 B / 24 hours',
