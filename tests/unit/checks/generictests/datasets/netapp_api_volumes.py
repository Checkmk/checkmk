...
info = [
    ...
    ['volume vol0', 'size-available 209570025472', 'state online', 'files-total 7782396',
     ...
     'read_latency 20135569973', 'cifs_read_latency 0', 'fcp_write_latency 0', 'fcp_read_latency 0',
     'iscsi_write_latency 0', 'nfs_read_latency 19007164', 'iscsi_read_data 0',
     'instance_name vol0', 'cifs_read_data 0', 'nfs_read_data 180684471',
    ...
    ['volume vol_bronze1_fundorado_cifs', 'size-available 5681445965824', 'state online',
     'files-total 31876689', 'files-used 3058888', 'size-total 9400824418304', 'fcp_write_data 0',
     'fcp_read_data 0', 'cifs_write_data 5993355785148', 'iscsi_read_latency 0',
     'iscsi_write_data 0', 'read_data 10083880638990', 'nfs_write_latency 0', 'san_write_latency 0',
     'san_write_data 0', 'read_latency 62090615998', 'cifs_read_latency 59464480059',
     'fcp_write_latency 0', 'fcp_read_latency 0', 'iscsi_write_latency 0', 'nfs_read_latency 0',
     'iscsi_read_data 0', 'instance_name vol_bronze1_fundorado_cifs',
     'cifs_read_data 9748984278714', 'nfs_read_data 0', 'write_latency 132180118822',
     'san_read_data 0', 'san_read_latency 0', 'write_data 6300214716764', 'nfs_write_data 0',
     'cifs_write_latency 128809541597'],
    ['volume vol_bronze1_ftpfreenet_nfs', 'size-available 2348812120064', 'state online',
     'files-total 31876689', 'files-used 2694615', 'size-total 4947802324992', 'fcp_write_data 0',
     'fcp_read_data 0', 'cifs_write_data 0', 'iscsi_read_latency 0', 'iscsi_write_data 0',
     'read_data 14495321097272', 'nfs_write_latency 436623773693', 'san_write_latency 0',
     'san_write_data 0', 'read_latency 1321841542993', 'cifs_read_latency 0', 'fcp_write_latency 0',
     'fcp_read_latency 0', 'iscsi_write_latency 0', 'nfs_read_latency 1318276162059',
     'iscsi_read_data 0', 'instance_name vol_bronze1_ftpfreenet_nfs', 'cifs_read_data 0',
    ...
    ['volume vol_bronze1_nfs', 'size-available 18063153672192', 'state online',
     ...
     'fcp_write_data 0', 'fcp_read_data 0', 'cifs_write_data 629525512283', 'iscsi_read_latency 0',
     'iscsi_write_data 0', 'read_data 258198800160064', 'nfs_write_latency 3284753782325',
     'san_write_latency 0', 'san_write_data 0', 'read_latency 18906485485409',
     'cifs_read_latency 59911208593', 'fcp_write_latency 0', 'fcp_read_latency 0',
     'iscsi_write_latency 0', 'nfs_read_latency 18738739813315', 'iscsi_read_data 0',
     'instance_name vol_bronze1_nfs', 'cifs_read_data 1373882337514',
    ...
    ['volume vol_bronze1_enterprise_vault', 'size-available 6317505187840', 'state online',
     ...
     'fcp_write_data 0', 'fcp_read_data 0', 'cifs_write_data 2797504453226', 'iscsi_read_latency 0',
     'iscsi_write_data 0', 'read_data 13198309405534', 'nfs_write_latency 0', 'san_write_latency 0',
     'san_write_data 0', 'read_latency 1332614234054', 'cifs_read_latency 1332014859907',
     'fcp_write_latency 0', 'fcp_read_latency 0', 'iscsi_write_latency 0', 'nfs_read_latency 0',
     'iscsi_read_data 0', 'instance_name vol_bronze1_enterprise_vault',
     'cifs_read_data 13060307696514', 'nfs_read_data 0', 'write_latency 75431342425',
     'san_read_data 0', 'san_read_latency 0', 'write_data 2935420540154', 'nfs_write_data 0',
     'cifs_write_latency 73712224394'],
    ['volume vol_bronze1_cifs', 'size-available 12137213788160', 'state online',
     'files-total 31876689', 'files-used 10483961', 'size-total 16712576745472', 'fcp_write_data 0',
     'fcp_read_data 0', 'cifs_write_data 6531283943261', 'iscsi_read_latency 0',
     'iscsi_write_data 0', 'read_data 4002760800079', 'nfs_write_latency 13176712585',
     'san_write_latency 0', 'san_write_data 0', 'read_latency 958566213067',
     'cifs_read_latency 878519925020', 'fcp_write_latency 0', 'fcp_read_latency 0',
     'iscsi_write_latency 0', 'nfs_read_latency 76274494693', 'iscsi_read_data 0',
     'instance_name vol_bronze1_cifs', 'cifs_read_data 3017117067272', 'nfs_read_data 513505960083',
     'write_latency 439931061563', 'san_read_data 0', 'san_read_latency 0',
     'write_data 8408643107314', 'nfs_write_data 1445857053805', 'cifs_write_latency 422105859254'],
    ['volume vol_bronze1_firebirdbackup_nfs', 'size-available 457455501312', 'state online',
     ...
     'san_write_data 0', 'read_latency 287461642429', 'cifs_read_latency 0', 'fcp_write_latency 0',
     'fcp_read_latency 0', 'iscsi_write_latency 0', 'nfs_read_latency 283857474274',
     'iscsi_read_data 0', 'instance_name vol_bronze1_firebirdbackup_nfs', 'cifs_read_data 0',
    ...
    ['volume vol_bronze1_singlescm_nfs', 'size-available 68105011200', 'state offline',
     ...
     'nfs_read_data 284389248', 'write_latency 248329456', 'san_read_data 0', 'san_read_latency 0',
     'write_data 50241577605', 'nfs_write_data 5550238259', 'cifs_write_latency 0']
]
...
discovery = {
    "": [
        ...
        ("euedcnas1710.v_1710_data", {'patterns': (['euedcnas1710.v_1710_data'], [])}),
        ('group1', {'patterns': (['vol0'], [])}),
        ('group2', {'patterns': (['vol_bronze1*'], ['vol_bronze1_cifs'])}),
        ('vol_bronze1_cifs', {}),
    ]
}
...
def mock_util(*args):
    ...
    for item in ["euedcnas1011.vol_1011_root", "euedcnas1012.vol_1012_root",
                 ...
                 "euedcnas1710.v_1710_data", "group1", "group2"]:
