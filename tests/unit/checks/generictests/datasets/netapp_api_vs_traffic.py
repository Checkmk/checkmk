...
info = [
    ...
    [
        "protocol nfsv3",
        "instance_name n3",
        "nfsv3_read_ops 10000",
        "nfsv3_write_ops 10000",
        "nfsv3_read_throughput 10000",
        "nfsv3_write_throughput 10000",
        "nfsv3_ops 10000",
    ],
    [
        "protocol nfsv4",
        "instance_name n4",
        "nfsv4_read_ops 10000",
        "nfsv4_write_ops 10000",
        "nfsv4_read_throughput 10000",
        "nfsv4_write_throughput 10000",
        "nfsv4_ops 10000",
    ],
    [
        "protocol nfsv4_1",
        "instance_name n41",
        "nfs4_1_ops 10000",
        "nfs41_read_throughput 10000",
        "nfs41_write_throughput 10000",
    ],
]
    ...
    "": [
        ...
        (
            ...
            [
                ...
                (
                    0,
                    "iSCSI read data: 0 B",
                    [("iscsi_read_data", 9.000180003600072e-06, None, None, None, None)],
                ),
                (
                    0,
                    "iSCSI write data: 0 B",
                    [("iscsi_write_data", 9.000180003600072e-06, None, None, None, None)],
                ),
            ],
        ),
        (
        ...
        (
            ...
            [
                ...
                (
                    0,
                    "Ethernet received errors: 0",
                    [("if_in_errors", 9.000180003600072e-06, None, None, None, None)],
                ),
                (
                    0,
                    "Ethernet sent errors: 0",
                    [("if_out_errors", 9.000180003600072e-06, None, None, None, None)],
                ),
                (
                    0,
                    "Ethernet received packets: 0",
                    [("if_in_pkts", 9.000180003600072e-06, None, None, None, None)],
                ),
                (
                    0,
                    "Ethernet sent packets: 0",
                    [("if_out_pkts", 9.000180003600072e-06, None, None, None, None)],
                ),
            ],
        ),
        (
            ...
            [
                (
                    0,
                    "NFS read OPs: 0",
                    [("nfs_read_ios", 9.000180003600072e-06, None, None, None, None)],
                ),
                (
                    0,
                    "NFS write OPs: 0",
                ...
                (
                    ...
                    [("nfs_read_throughput", 9.000180003600072e-06, None, None, None, None)],
                ),
                (
                    0,
                    "NFS write throughput: 0.00 B/s",
                    [("nfs_write_throughput", 9.000180003600072e-06, None, None, None, None)],
                ),
                (0, "NFS OPs: 0", [("nfs_ios", 9.000180003600072e-06, None, None, None, None)]),
            ],
        ),
        (
            "n4",
            ...
            [
                (
                    0,
                    "NFSv4 read OPs: 0",
                    [("nfsv4_read_ios", 9.000180003600072e-06, None, None, None, None)],
                ),
                (
                    0,
                    "NFSv4 write OPs: 0",
                    [("nfsv4_write_ios", 9.000180003600072e-06, None, None, None, None)],
                ),
                (0, "NFSv4 OPs: 0", [("nfsv4_ios", 9.000180003600072e-06, None, None, None, None)]),
            ],
        ),
        (
            "n41",
            ...
            [
                (
                    ...
                    [("nfsv4_1_read_throughput", 9.000180003600072e-06, None, None, None, None)],
                ),
                (
                    0,
                    "NFSv4.1 write throughput: 0.00 B/s",
                    [("nfsv4_1_write_throughput", 9.000180003600072e-06, None, None, None, None)],
                ),
            ],
        ),
        (
        ...
        ("pcvs0_norefs", {}, [(0, "CIFS read latency: -", []), (0, "CIFS write latency: -", [])]),
    ]
}
