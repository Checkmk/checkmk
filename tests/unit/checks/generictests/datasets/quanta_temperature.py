...
info = [[['1', '3', 'Temp_PCI1_Outlet\x01', '41', '85', '80', '-99', '-99'],
...
checks = {'': [('Temp_CPU0_Inlet',
                {},
                [(0, '37.0 \xb0C', [('temp', 37.0, 70.0, 75.0, None, None)])]),
               ('Temp_CPU1_Inlet',
                {},
                [(0, '37.0 \xb0C', [('temp', 37.0, 75.0, 75.0, None, None)])]),
               ('Temp_DIMM_AB', {}, [(1, 'Status: other', [])]),
               ('Temp_DIMM_CD', {}, [(3, 'Status: unknown', [])]),
               ('Temp_PCI1_Outlet',
                {},
                [(0, '41.0 \xb0C', [('temp', 41.0, 80.0, 85.0, None, None)])])]}
