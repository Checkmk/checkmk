...
info = [
    ...
    ["gcc_version", "7.4.0"],
    ["process_id", "1064"],
    ["run_id", "38d09b0d45dcc76bbff989d894fae6bb98e93a15"],
    ["tcp_port", "6380"],
    ["uptime_in_seconds", "10267"],
    ["uptime_in_days", "0"],
    ["hz", "10"],
    ["lru_clock", "15347536"],
    ...
    ["# Memory"],
    ["used_memory", "533072"],
    ["used_memory_human", "520.58K"],
    ["used_memory_rss", "4083712"],
    ["used_memory_rss_human", "3.89M"],
    ["used_memory_peak", "534096"],
    ["used_memory_peak_human", "521.58K"],
    ["used_memory_peak_perc", "99.81%"],
    ["used_memory_overhead", "524942"],
    ["used_memory_startup", "475312"],
    ...
    ["total_commands_processed", "279"],
    ["instantaneous_ops_per_sec", "0"],
    ["total_net_input_bytes", "6300"],
    ["total_net_output_bytes", "387527"],
    ...
    ["cluster_enabled", "0"],
    ["# Keyspace"],
    ["[[[MY_SECOND_REDIS|127.0.0.1|6379]]]"],
    ["# Server"],
    ["redis_version", "4.0.9"],
    ["redis_git_sha1", "00000000"],
    ["redis_git_dirty", "0"],
    ...
    ["gcc_version", "7.4.0"],
    ["process_id", "1320"],
    ["run_id", "d9fb68e25be9d16e6eacd4643aefa4d1a8cec9ce"],
    ["tcp_port", "6379"],
    ...
    ["instantaneous_ops_per_sec", "0"],
    ["total_net_input_bytes", "1960"],
    ["total_net_output_bytes", "385217"],
    ["instantaneous_input_kbps", "0.00"],
    ["instantaneous_output_kbps", "0.00"],
    ["rejected_connections", "0"],
    ["sync_full", "0"],
...
checks = {
    "": [
        (
            ...
            [
                ...
                (
                    0,
                    "Up since Fri Dec  6 09:44:53 2019, uptime: 2:51:07",
        ...
        (
            ...
            [
                ...
                (
                    0,
                    "Up since Fri Dec  6 09:44:54 2019, uptime: 2:51:06",
    ...
    "clients": [
        (
            ...
            [
                ...
                (0, "Longest output list: 0", [("clients_output", 0, None, None, None, None)]),
                (0, "Biggest input buffer: 0", [("clients_input", 0, None, None, None, None)]),
                (
                    0,
    ...
    "persistence": [
        (
            "MY_FIRST_REDIS",
            {"rdb_last_bgsave": 1, "aof_last_rewrite": 1},
            [
