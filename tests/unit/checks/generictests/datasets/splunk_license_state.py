...
checks = {'': [(u'Splunk_Enterprise_Splunk_Analytics_for_Hadoop_Download_Trial',
                ...
                [(0, u'Status: VALID', []),
                 ...
                 (0,
                  u'Max violations: 5 within window period of 30 Days, Quota: 500 MB',
                  [])]),
               (u'Splunk_Forwarder',
                {'expiration_time': (1209600, 604800), 'state': 2},
                [(0, u'Status: VALID', []),
                 ...
                 (0,
                  u'Max violations: 5 within window period of 30 Days, Quota: 1 MB',
                  [])]),
               (u'Splunk_Free',
                {'expiration_time': (1209600, 604800), 'state': 2},
                [(0, u'Status: VALID', []),
                 (0, 'Expiration time: 2038-01-19 04:14:07', []),
                 (0,
                  u'Max violations: 3 within window period of 30 Days, Quota: 500 MB',
                  [])])]}
