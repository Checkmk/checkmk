...
info = [[
    'equipmentPsuInputStats', 'Dn sys/switch-A/psu-2/input-stats', 'Current 0.625000',
    'PowerAvg 142.333344', 'Voltage 228.000000'
],
        [
            'equipmentPsuInputStats', 'Dn sys/switch-A/psu-1/input-stats', 'Current 0.562500',
            'PowerAvg 132.431259', 'Voltage 236.000000'
        ],
        [
            'equipmentPsuInputStats', 'Dn sys/switch-B/psu-2/input-stats', 'Current 0.625000',
            'PowerAvg 142.670456', 'Voltage 228.500000'
        ],
        [
            'equipmentPsuStats', 'Dn sys/chassis-1/psu-1/stats', 'AmbientTemp 17.000000',
            'Output12vAvg 12.008000', 'Output3v3Avg 3.336000'
        ]]

discovery = {
    '': [('Chassis 1 Module 1', {})],
    'chassis_temp': [('Ambient Chassis 1', {})],
    'switch_power': [('Switch A Module 1', {}), ('Switch A Module 2', {}), ('Switch B Module 2',
                                                                            {})]
}
