...
checks = {
    'backend': [(None, {}, [(0, u'varnish_backend_busy_rate: 0.0 conn. too many/s',
                            ...
                            (0, u'varnish_backend_toolate_rate: 0.0 conn. was closed/s',
    ...
    'cache_hit_ratio': [(None, {
        'levels_lower': (70.0, 60.0)
    }, [(2, 'cache_hit_ratio: 39.3% (warn/crit below 70.0%/60.0%)',
         [('cache_hit_ratio', 39.2761823422654, None, None, None, None)])])],
    'client': [(None, {}, [(0, u'varnish_client_drop_rate: 0.0 Connection dropped, no sess wrk/s',
                            [(u'varnish_client_drop_rate', 0.0, None, None, None, None)]),
                           (0, u'varnish_client_req_rate: 0.0 requests received/s',
                            [(u'varnish_client_req_rate', 0.0, None, None, None, None)]),
                           (0, u'varnish_client_conn_rate: 0.0 connections accepted/s',
                            [(u'varnish_client_conn_rate', 0.0, None, None, None, None)]),
                           (0, u'varnish_client_drop_late_rate: 0.0 Connection dropped late/s',
    ...
    'fetch': [(None, {}, [(0, u'varnish_fetch_oldhttp_rate: 0.0 pre HTTP 1.1 closed/s',
                           [(u'varnish_fetch_oldhttp_rate', 0.0, None, None, None, None)]),
                          (0, u'varnish_fetch_head_rate: 0.0 head/s',
                           [(u'varnish_fetch_head_rate', 0.0, None, None, None, None)]),
                          (0, u'varnish_fetch_eof_rate: 0.0 EOF/s',
                           [(u'varnish_fetch_eof_rate', 0.0, None, None, None, None)]),
                          (0, u'varnish_fetch_zero_rate: 0.0 zero len/s',
                           [(u'varnish_fetch_zero_rate', 0.0, None, None, None, None)]),
                          (0, u'varnish_fetch_304_rate: 0.0 no body (304)/s',
                           [(u'varnish_fetch_304_rate', 0.0, None, None, None, None)]),
                          (0, u'varnish_fetch_length_rate: 0.0 with Length/s',
                           [(u'varnish_fetch_length_rate', 0.0, None, None, None, None)]),
                          (0, u'varnish_fetch_failed_rate: 0.0 failed/s',
                           [(u'varnish_fetch_failed_rate', 0.0, None, None, None, None)]),
                          (0, u'varnish_fetch_bad_rate: 0.0 had bad headers/s',
                           [(u'varnish_fetch_bad_rate', 0.0, None, None, None, None)]),
                          (0, u'varnish_fetch_close_rate: 0.0 wanted close/s',
                           [(u'varnish_fetch_close_rate', 0.0, None, None, None, None)]),
                          (0, u'varnish_fetch_1xx_rate: 0.0 no body (1xx)/s',
                           [(u'varnish_fetch_1xx_rate', 0.0, None, None, None, None)]),
                          (0, u'varnish_fetch_chunked_rate: 0.0 chunked/s',
                           [(u'varnish_fetch_chunked_rate', 0.0, None, None, None, None)]),
                          (0, u'varnish_fetch_204_rate: 0.0 no body (204)/s',
                           [(u'varnish_fetch_204_rate', 0.0, None, None, None, None)])])],
    'objects': [(None, {}, [(0, u'varnish_objects_expired_rate: 0.0 expired objects/s',
                             [(u'varnish_objects_expired_rate', 0.0, None, None, None, None)]),
                            (0, u'varnish_objects_lru_nuked_rate: 0.0 LRU nuked objects/s',
                             [(u'varnish_objects_lru_nuked_rate', 0.0, None, None, None, None)]),
                            (0, u'varnish_objects_lru_moved_rate: 0.0 LRU moved objects/s',
                             [(u'varnish_objects_lru_moved_rate', 0.0, None, None, None, None)])])],
    'worker': [(None, {}, [(0, u'varnish_worker_lqueue_rate: 0.0 work request queue length/s',
                            [(u'varnish_worker_lqueue_rate', 0.0, None, None, None, None)]),
                           (0, u'varnish_worker_create_rate: 0.0 worker threads created/s',
                            [(u'varnish_worker_create_rate', 0.0, None, None, None, None)]),
                           (0, u'varnish_worker_drop_rate: 0.0 dropped work requests/s',
                            [(u'varnish_worker_drop_rate', 0.0, None, None, None, None)]),
                           (0, u'varnish_worker_rate: 0.0 worker threads/s',
                            [(u'varnish_worker_rate', 0.0, None, None, None, None)]),
                           (0, u'varnish_worker_failed_rate: 0.0 worker threads not created/s',
                            [(u'varnish_worker_failed_rate', 0.0, None, None, None, None)]),
                           (0, u'varnish_worker_queued_rate: 0.0 queued work requests/s',
                            [(u'varnish_worker_queued_rate', 0.0, None, None, None, None)]),
                           (0, u'varnish_worker_max_rate: 0.0 worker threads limited/s',
                            [(u'varnish_worker_max_rate', 0.0, None, None, None, None)])])],
    'worker_thread_ratio': [(None, {
        'levels_lower': (70.0, 60.0)
    }, [(0, 'varnish_worker_thread_ratio: 100.0%', [('varnish_worker_thread_ratio', 100.0, None,
                                                     None, None, None)])])]
}
