...
info = [['TaskName             ',
         ' Monitoring - Content Replication get failed'],
        ['and outdated items'],
        ...
        ['TaskName             ',
         ' Monitoring - Content Replicaton status'],
        ['reporting overall'],
...
discovery = {'': [('Monitoring - Content Replication get failed and outdated items', None),
...
checks = {'': [('Monitoring - Content Replication get failed and outdated items',
                {},
                [(0, 'The task exited successfully (0x00000000)', []),
                 (0,
                  'Last run time: 7/21/2020 6:30:02 AM, Next run time: 7/22/2020 6:30:00 AM',
                  [])]),
               ('Monitoring - Content Replicaton status reporting overall',
                {},
                [(0, 'The task exited successfully (0x00000000)', []),
                 (0,
                  'Last run time: 7/21/2020 6:45:02 AM, Next run time: 7/22/2020 6:45:00 AM',
                  [])]),
