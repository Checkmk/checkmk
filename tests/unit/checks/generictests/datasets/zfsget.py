...
checks = {'': [('/',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '17.9% used (1.75 of 9.78 GB), trend: 0.00 B / 24 hours',
                  [('/',
                    1793.4736328125,
                    8012.215625,
                    9013.742578125,
                   ...
                   ('trend', 0, None, None, 0, 417.3028971354167)])]),
               ('/dev/fd',
                {'inodes_levels': (10.0, 5.0),
                 'levels': (80.0, 90.0),
                 'levels_low': (50.0, 60.0),
               ...
               ('/etc/svc/volatile',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.000151% used (232.00 kB of 146.37 GB), trend: 0.00 B / 24 hours',
                  [('/etc/svc/volatile',
                    0.2265625,
                    119906.7125,
                    134895.0515625,
               ...
               ('/export',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.000409% used (21.00 kB of 4.89 GB), trend: 0.00 B / 24 hours',
               ...
               ('/home',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.00107% used (55.00 kB of 4.89 GB), trend: 0.00 B / 24 hours',
               ...
               ('/opt',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '2.84% used (142.33 MB of 4.89 GB), trend: 0.00 B / 24 hours',
               ...
               ('/tmp',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.528% used (10.80 MB of 2.00 GB), trend: 0.00 B / 24 hours',
               ...
               ('/u01',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '64.9% used (18.99 of 29.29 GB), trend: 0.00 B / 24 hours',
               ...
               ('/var/run',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '1.56e-05% used (24.00 kB of 146.37 GB), trend: 0.00 B / 24 hours',
                  [('/var/run',
                    0.0234375,
                    119906.55,
                    134894.86875,
                   ...
                   ('growth', 0.0, None, None, None, None),
                   ('trend', 0, None, None, 0, 6245.1328125)])])]}
