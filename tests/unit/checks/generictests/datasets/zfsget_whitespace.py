...
checks = {'': [(u'/',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '2.67% used (755.23 MB of 27.6 GB), trend: 0 B / 24 hours',
                  [(u'/',
                    755.234375,
                    22611.02578125,
                    25437.40400390625,
               ...
               (u'/mnt/DataStorage',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.2% used (7.04 GB of 3.51 TB), trend: 0 B / 24 hours',
                  [(u'/mnt/DataStorage',
                    7209.889709472656,
                    2942965.987902832,
                    3310836.736390686,
               ...
               (u'/mnt/DataStorage/ ISO-File',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.000005% used (175.83 kB of 3.5 TB), trend: 0 B / 24 hours',
               ...
               (u'/mnt/test2',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '2.04% used (9.07 of 445.62 GB), trend: 0 B / 24 hours',
                  [(u'/mnt/test2',
                    9290.05859375,
                    365055.8875,
                    410687.8734375,
               ...
               (u'/mnt/test2/ISO-File',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.44% used (1.92 of 438.47 GB), trend: 0 B / 24 hours',
                  [(u'/mnt/test2/ISO-File',
                    1965.42578125,
                    359196.18125,
                    404095.70390625,
               ...
               (u'/mnt/test2/Server1',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '1.61% used (7.15 of 443.7 GB), trend: 0 B / 24 hours',
                  [(u'/mnt/test2/Server1',
                    7320.1328125,
                    363479.946875,
                    408914.940234375,
               ...
               (u'/mnt/test2/iocage',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.0001% used (632 kB of 436.55 GB), trend: 0 B / 24 hours',
                  [(u'/mnt/test2/iocage',
                    0.6171875,
                    357624.334375,
                    402327.376171875,
               ...
               (u'/mnt/test2/iocage/download',
                {'inodes_levels': (10.0, 5.0),
                 ...
                 'trend_range': 24},
                [(0,
                  '0.00002% used (88 kB of 436.55 GB), trend: 0 B / 24 hours',
                  [(u'/mnt/test2/iocage/download',
                    0.0859375,
                    357623.909375,
                    402326.898046875,
