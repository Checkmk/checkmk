    ...
    '': [
        (
            '/', {
                ...
                (
                    0, 'Used: 2.67% - 755 MiB of 27.6 GiB', [
                        (
                            'fs_used', 755.234375, 22611.02578125,
                            25437.40400390625, 0, None
                        ), ('fs_free', 27508.5478515625, None, None, 0, None),
                        (
                            'fs_used_percent', 2.672092393530493, 80.0, 90.0, 0.0, 100.0
                        ), ('fs_size', 28263.7822265625, None, None, 0, None)
                    ]
                )
            ]
        ),
        (
            '/mnt/DataStorage', {
                ...
                (
                    0, 'Used: 0.20% - 7.04 GiB of 3.51 TiB', [
                        (
                            'fs_used', 7209.889709472656, 2942965.987902832,
                            3310836.736390686, 0, None
                        ),
                        ('fs_free', 3671497.5951690674, None, None, 0, None),
                        (
                            'fs_used_percent', 0.1959897528985158, 80.0, 90.0, 0.0, 100.0
                        ), ('fs_size', 3678707.48487854, None, None, 0, None)
                    ]
                )
            ]
        ),
        (
            '/mnt/DataStorage/ ISO-File', {
                ...
                (
                    0, 'Used: <0.01% - 176 KiB of 3.50 TiB', [
                        (
                            'fs_used', 0.1717071533203125, 2937198.2135009766,
                            3304347.9901885986, 0, None
                        ),
                        ('fs_free', 3671497.5951690674, None, None, 0, None),
                        (
                            'fs_used_percent', 4.676760391070704e-06, 80.0, 90.0, 0.0, 100.0
                        ),
                        ('fs_size', 3671497.7668762207, None, None, 0, None)
                    ]
                )
            ]
        ),
                ...
                (
                    0, 'Used: 0.20% - 7.04 GiB of 3.51 TiB', [
                        (
                            ...
                            3310835.057563019, 0, None
                        ),
                        ('fs_free', 3671497.5951690674, None, None, 0, None),
                        (
                            'fs_used_percent', 0.1959391452026352, 80.0, 90.0, 0.0, 100.0
                        ),
                        ('fs_size', 3678705.6195144653, None, None, 0, None)
                    ]
                )
            ]
        ),
        (
            '/mnt/test2', {
                ...
                (
                    0, 'Used: 2.04% - 9.07 GiB of 446 GiB', [
                        (
                            'fs_used', 9290.05859375, 365055.8875,
                            410687.8734375, 0, None
                        ), ('fs_free', 447029.80078125, None, None, 0, None),
                        (
                            'fs_used_percent', 2.035865501552827, 80.0, 90.0, 0.0, 100.0
                        ), ('fs_size', 456319.859375, None, None, 0, None)
                    ]
                )
            ]
        ),
        (
            '/mnt/test2/ISO-File', {
                ...
                (
                    0, 'Used: 0.44% - 1.92 GiB of 438 GiB', [
                        (
                            'fs_used', 1965.42578125, 359196.18125,
                            404095.70390625, 0, None
                        ), ('fs_free', 447029.80078125, None, None, 0, None),
                        (
                            'fs_used_percent', 0.43773868071989697, 80.0, 90.0, 0.0, 100.0
                        ), ('fs_size', 448995.2265625, None, None, 0, None)
                    ]
                )
            ]
        ),
        (
            '/mnt/test2/Server1', {
                ...
                (
                    0, 'Used: 1.61% - 7.15 GiB of 444 GiB', [
                        (
                            'fs_used', 7320.1328125, 363479.946875,
                            408914.940234375, 0, None
                        ), ('fs_free', 447029.80078125, None, None, 0, None),
                        (
                            'fs_used_percent', 1.6111222366866644, 80.0, 90.0, 0.0, 100.0
                        ), ('fs_size', 454349.93359375, None, None, 0, None)
                    ]
                )
            ]
        ),
        (
            '/mnt/test2/iocage', {
                ...
                (
                    0, 'Used: <0.01% - 632 KiB of 437 GiB', [
                        (
                            'fs_used', 0.6171875, 357624.334375,
                            402327.376171875, 0, None
                        ), ('fs_free', 447029.80078125, None, None, 0, None),
                        (
                            'fs_used_percent', 0.00013806387109056747, 80.0, 90.0, 0.0, 100.0
                        ), ('fs_size', 447030.41796875, None, None, 0, None)
                    ]
                )
            ]
        ),
        (
            '/mnt/test2/iocage/download', {
                ...
                (
                    0, 'Used: <0.01% - 88.0 KiB of 437 GiB', [
                        (
                            'fs_used', 0.0859375, 357623.909375,
                            402326.898046875, 0, None
                        ), ('fs_free', 447029.80078125, None, None, 0, None),
                        (
                            'fs_used_percent', 1.9224106162295095e-05, 80.0, 90.0, 0.0, 100.0
                        ), ('fs_size', 447029.88671875, None, None, 0, None)
                    ]
                )
            ]
        ),
