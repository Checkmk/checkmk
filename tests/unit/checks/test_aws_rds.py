...
def test_aws_rds_transaction_logs_usage_discovery(
    ...
    check = fix_register.check_plugins[CheckPluginName("aws_rds_transaction_logs_usage")]
    assert list(check.discovery_function(section)) == discovery_result


def test_check_aws_rds_transaction_logs_usage_item_not_found(
    fix_register: FixRegister,
) -> None:
    check = fix_register.check_plugins[CheckPluginName("aws_rds_transaction_logs_usage")]
    assert (
...
def test_check_aws_rds_transaction_logs_usage_metric_not_found(
    fix_register: FixRegister,
) -> None:
    check = fix_register.check_plugins[CheckPluginName("aws_rds_transaction_logs_usage")]
...
def test_check_aws_rds_transaction_logs_usage_no_allocated_storage(
    fix_register: FixRegister,
) -> None:
    check = fix_register.check_plugins[CheckPluginName("aws_rds_transaction_logs_usage")]
    check_result = list(
...
def test_check_aws_rds_transaction_logs_usage_allocated_storage_is_zero(
    fix_register: FixRegister,
) -> None:
    check = fix_register.check_plugins[CheckPluginName("aws_rds_transaction_logs_usage")]
    check_result = list(
