...
info_df_lnx = [[u'/dev/sda4', u'ext4', u'143786696', u'101645524', u'34814148', u'75%', u'/'],
               [u'[df_inodes_start]'],
...
info_df_lnx_docker = [
    ...
    [
        u'/dev/sda3', u'ext4', u'143786696', u'101645524', u'34814148', u'75%',
        u'/var/lib/docker-latest'
    ],
    [
        u'/dev/sda4', u'ext4', u'143786696', u'101645524', u'34814148', u'75%',
        u'/var/lib/docker/some-fs/mnt/grtzlhash'
    ], [u'[df_inodes_start]'],
    ...
    [
        u'/dev/sda4', u'ext4', u'9142272', u'1654272', u'7488000', u'19%',
        u'/var/lib/docker/some-fs/mnt/grtzlhash'
    ], [u'[df_inodes_end]']
]
...
info_df_lnx_tmpfs = [
    ...
    [u'tmpfs', u'tmpfs', u'2038210', u'57', u'2038153', u'1%', u'/dev/shm'], [u'[df_inodes_end]']
]
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {
                "ignore_fs_types": ['tmpfs', 'nfs', 'smbfs', 'cifs', 'iso9660'
                                   ],  # Ignoring tmpfs explicitly, but
                "never_ignore_mountpoints": [u'/opt/omd/sites/heute/tmp']
            }),  # including one mountpoint explicitly
        ...
        (
            info_df_lnx_docker,
            [
                (u'/var/lib/docker', {}),  # Omit docker container filesystems,
