...
def parse_docker_image_inspect(__):
    return [{
...
def test_parse_docker_node_images():
    parsed = parse_docker_node_images([])
    assert parsed == expected, "expected: %r, got %r" % (expected, parsed)
