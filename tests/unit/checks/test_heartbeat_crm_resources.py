...
def _heartbeat_crm_resources_check_plugin() -> Check:
    return Check("heartbeat_crm.resources")
...
def test_discovery_heartbeat_crm_resources_nothing(heartbeat_crm_resources_check: Check) -> None:
...
@pytest.mark.usefixtures("config_load_all_checks")
def test_discovery_heartbeat_crm_resources_something(heartbeat_crm_resources_check: Check,
                                                     section_2: StringTable) -> None:
...
@pytest.mark.usefixtures("config_load_all_checks")
def test_check_heartbeat_crm_resources_no_data(section_2: StringTable,
                                               heartbeat_crm_resources_check: Check) -> None:
    assert not list(heartbeat_crm_resources_check.run_check("no such item", {}, section_2))


@pytest.mark.usefixtures("config_load_all_checks")
def test_check_heartbeat_crm_resources_ok(section_1: StringTable,
                                          heartbeat_crm_resources_check: Check) -> None:
    assert list(
        heartbeat_crm_resources_check.run_check(
            ...
            (0, "clone_nfs_sapmnt_IFG Clone Started hrssc61i01, hrssc61i02"),
        ]


@pytest.mark.usefixtures("config_load_all_checks")
def test_check_heartbeat_crm_resources_started(section_2: StringTable,
                                               heartbeat_crm_resources_check: Check) -> None:
    assert list(
        heartbeat_crm_resources_check.run_check(
            ...
            (0, "cluster1_fence(stonith:fence_ipmilan): Started cluster2"),
...
def test_discover_heartbeat_crm_resources_pacemaker_v2(
        section_pacemaker_v2: StringTable, heartbeat_crm_resources_check: Check) -> None:
