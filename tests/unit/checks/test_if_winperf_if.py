        ...
        CheckResult([
            BasicCheckResult(
                ...
                [
                    ...
                    PerfValue('inmcast', 0.0, None, None, None, None),
                    PerfValue('inbcast', 0.0, None, None, None, None),
                    ...
                    PerfValue('outmcast', 0.0, None, None, None, None),
                    PerfValue('outbcast', 0.0, None, None, None, None),
