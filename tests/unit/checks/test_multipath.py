...
@pytest.mark.parametrize("group,result", [
    ...
    (['1IET', u'00010001', u'dm-4', u'IET,VIRTUAL-DISK'],
      '1IET 00010001'),
    (['SDataCoreSANsymphony_DAT05-fscl', u'dm-6', u'DataCore,SANsymphony'],
      'SDataCoreSANsymphony_DAT05-fscl'),
    (['SDDN_S2A_9900_1308xxxxxxxx', u'dm-13', u'DDN,S2A', u'9900'],
    ...
    (['mpath1', u'(SIBM_____SwapA__________DA02BF71)'],
    ...
    (['360a980004334644d654a316e65306e51dm-4', u'NETAPP,LUN'],
