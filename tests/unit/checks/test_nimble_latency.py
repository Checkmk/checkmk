...
def test_nimble_latency_ranges(check_manager, params, data, result):
...
@pytest.mark.usefixtures("config_load_all_checks")
def test_nimble_latency_read_params(check_manager, params, data, result):
...
@pytest.mark.usefixtures("config_load_all_checks")
def test_nimble_latency_write_params(check_manager, params, data, result):
