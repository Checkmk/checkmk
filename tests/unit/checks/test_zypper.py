...
[
    ...
    (
        [
            ['SLES12-SP1-Updates ', ' SUSE-SLE-SERVER-12-SP1-2016-1150 ', ' recommended ', ' low       ', ' ---         ', ' needed ', ' Recommended update for release-notes-sles# SLES12-SP1-Updates']
        ],
        (1, "1 updates (recommended: 1(!))")
    ),
    (
        [
            ['SLES12-SP1-Updates ', ' SUSE-SLE-SERVER-12-SP1-2016-1150 ', ' not relevant ', ' low       ', ' ---         ', ' needed ', ' Recommended update for release-notes-sles# SLES12-SP1-Updates']
        ],
