...
from cmk.base.legacy_checks.aix_hacmp_nodes import (
...
def test_inventory_aix_hacmp_nodes(
    ...
    expected_result: Sequence[tuple[str, None]],
) -> None:
    assert inventory_aix_hacmp_nodes(parse_aix_hacmp_nodes(string_table)) == expected_result
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            (
                0,
                "Network: prod_net, interface: pasv0450, attribute: public, IP: 1.2.3.15, interface: pasc0159, attribute: public, IP: 1.2.3.5, interface: pasc0158, attribute: public, IP: 1.2.3.9",
            ),
        ),
        (
            _STRING_TABLE_2,
