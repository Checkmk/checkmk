...
from cmk.base.legacy_checks.couchbase_buckets_operations import (
    discover_couchbase_buckets_operations,
    discover_couchbase_buckets_operations_total,
)
...
def test_discover_per_bucket_skips_aggregate() -> None:
    ...
    discovered = sorted(discover_couchbase_buckets_operations(_section()))
...
def test_discover_total_yields_only_aggregate() -> None:
    ...
    discovered = list(discover_couchbase_buckets_operations_total(_section()))
