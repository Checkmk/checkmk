...
def make_agent_output_1():
    return [
        ...
        [
            u'127.0.0.1', u'None', u'CurrentTime:', u'Wednesday,', u'14-Aug-2019', u'10:46:26',
            u'CEST'
        ],
        ...
        [
            u'127.0.0.1', u'None', u'ServerUptime:', u'1', u'day', u'23', u'hours', u'17',
            u'minutes', u'52', u'seconds'
        ...
        [u'127.0.0.1', u'None', u'CPUUser:',
         u'.34'], [u'127.0.0.1', u'None', u'CPUSystem:', u'.15'],
        ...
        [u'127.0.0.1', u'None', u'BusyWorkers:', u'1'],
        [u'127.0.0.1', u'None', u'IdleWorkers:', u'49'],
...
def make_agent_output_2():
    return [
        ...
        [
            ...
            u'ServerUptime: 1 day 3 hours 42 minutes 19 seconds'
...
def test_cluster_check_function(monkeypatch):
    monkeypatch.setattr(
        apache_status,
        "get_value_store",
        lambda: {
    ...
    cluster_section = {"node1": make_section_1(), "node2": make_section_2()}

    assert list(
        apache_status.cluster_check_apache_status(
            "MY CHECK MK",
            {},
            cluster_section,  # type: ignore[arg-type]
        )) == [
            Result(state=State.OK, summary='Uptime: 1 day 3 hours'),
            Metric('Uptime', 99739),
            Result(state=State.OK, summary='Idle workers: 49'),
