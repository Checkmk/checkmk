...
@pytest.mark.parametrize('string_table, item, result', [
    ...
    (DATA, "Chassis 2", [
        ...
        Result(state=State.CRIT, summary='Temperature: 56.0°C (warn/crit at 55.0°C/55.0°C)'),
        Result(state=State.OK, notice='Configuration: show most critical state'),
    ...
    (DATA, "Chassis 3", [
        ...
        Result(state=State.WARN, summary='Temperature: 52.0°C (warn/crit at 50.0°C/60.0°C)'),
        Result(state=State.OK, notice='Configuration: show most critical state'),
    ...
    (DATA, "Chassis 4", [
        ...
        Result(state=State.CRIT, summary='Temperature: 70.0°C (warn/crit at 50.0°C/60.0°C)'),
        Result(state=State.OK, notice='Configuration: show most critical state'),
