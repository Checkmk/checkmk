...
_STRING_TABLE_AWS_LAMBDA_PROVISIONED_CONCURRENCY = [[
    ...
    '"AllocatedProvisionedConcurrentExecutions":', '2,', '"Status":', '"READY",', '"LastModified":',
    ...
    '"AllocatedProvisionedConcurrentExecutions":', '1,', '"Status":', '"READY",', '"LastModified":',
...
_STRING_TABLE_AWS_LAMBDA_CONCURRENCY = [
    [
        ...
        '"arn:aws:lambda:eu-central-1:710145618630:function:calling_other_lambda_concurrently:provisioned_alias",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_1_ConcurrentExecutions",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:calling_other_lambda_concurrently",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[1.0, null]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_1_DeadLetterErrors",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:calling_other_lambda_concurrently",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_1_DestinationDeliveryFailures",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:calling_other_lambda_concurrently",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_1_Duration",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:calling_other_lambda_concurrently",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[4973.39,', 'null]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_1_Errors",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:calling_other_lambda_concurrently",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[0.0,', '600]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_1_Invocations",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:calling_other_lambda_concurrently",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[1.0,', '600]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_1_IteratorAge",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:calling_other_lambda_concurrently",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_1_PostRuntimeExtensionsDuration",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:calling_other_lambda_concurrently",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_1_ProvisionedConcurrencyInvocations",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:calling_other_lambda_concurrently",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_1_ProvisionedConcurrencySpilloverInvocations",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:calling_other_lambda_concurrently",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_1_ProvisionedConcurrencyUtilization",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:calling_other_lambda_concurrently",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_1_ProvisionedConcurrentExecutions",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:calling_other_lambda_concurrently",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_1_Throttles",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:calling_other_lambda_concurrently",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[0.0,', '600]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_1_UnreservedConcurrentExecutions",',
        '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:calling_other_lambda_concurrently",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_2_ConcurrentExecutions",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function:ProvisionedAlias",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[2.0, null]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_2_DeadLetterErrors",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function:ProvisionedAlias",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_2_DestinationDeliveryFailures",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function:ProvisionedAlias",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_2_Duration",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function:ProvisionedAlias",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[0.9190000000000002,',
        'null]],', '"StatusCode":', '"Complete"},', '{"Id":', '"id_2_Errors",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function:ProvisionedAlias",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[0.0,', '600]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_2_Invocations",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function:ProvisionedAlias",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[10.0,', '600]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_2_IteratorAge",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function:ProvisionedAlias",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_2_PostRuntimeExtensionsDuration",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function:ProvisionedAlias",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_2_ProvisionedConcurrencyInvocations",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function:ProvisionedAlias",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[10.0,', '600]],',
        '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_2_ProvisionedConcurrencySpilloverInvocations",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function:ProvisionedAlias",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[1.0,', '600]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_2_ProvisionedConcurrencyUtilization",',
        '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function:ProvisionedAlias",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[1.0,', 'null]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_2_ProvisionedConcurrentExecutions",',
        '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function:ProvisionedAlias",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[10.0,', '600]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_2_Throttles",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function:ProvisionedAlias",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[0.0,', '600]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_2_UnreservedConcurrentExecutions",',
        '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function:ProvisionedAlias",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[1.0, null]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_3_ConcurrentExecutions",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[10.0,', '600]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_3_DeadLetterErrors",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_3_DestinationDeliveryFailures",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_3_Duration",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[0.9190000000000002,',
        'null]],', '"StatusCode":', '"Complete"},', '{"Id":', '"id_3_Errors",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[0.0,', '600]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_3_Invocations",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[10.0,', '600]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_3_IteratorAge",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_3_PostRuntimeExtensionsDuration",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_3_ProvisionedConcurrencyInvocations",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[10.0,', '600]],',
        '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_3_ProvisionedConcurrencySpilloverInvocations",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[0.0,', '600]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_3_ProvisionedConcurrencyUtilization",',
        '"Label":', '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"},', '{"Id":',
        '"id_3_ProvisionedConcurrentExecutions",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[10.0,', '600]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_3_Throttles",', '"Label":',
        '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function",',
        '"Timestamps":', '["2021-07-16', '15:32:00+00:00"],', '"Values":', '[[0.0,', '600]],',
        '"StatusCode":', '"Complete"},', '{"Id":', '"id_3_UnreservedConcurrentExecutions",',
        '"Label":', '"arn:aws:lambda:eu-central-1:710145618630:function:my_python_test_function",',
        '"Timestamps":', '[],', '"Values":', '[],', '"StatusCode":', '"Complete"}]'
    ],
    [
...
_STRING_TABLE_AWS_LAMBDA_REGION_LIMITS = [
    [
        '[["total_code_size",', '"Total', 'Code', 'Size",', '100,', '80530636800,',
        '"eu-central-1"],', '["concurrent_executions",', '"Concurrent', 'Executions",', '100,',
        '1000,', '"eu-central-1"],', '["unreserved_concurrent_executions",', '"Unreserved',
        'Concurrent', 'Executions",', '100,', '995,', '"eu-central-1"]]'
    ],
    [
        '[["total_code_size",', '"Total', 'Code', 'Size",', '100,', '80530636800,', '"eu-west-1"],',
        '["concurrent_executions",', '"Concurrent', 'Executions",', '100,', '1000,',
        '"eu-west-1"],', '["unreserved_concurrent_executions",', '"Unreserved', 'Concurrent',
        'Executions",', '100,', '1000,', '"eu-west-1"]]'
    ]
]
        ...
        (
            ...
            [
                ...
                Result(state=State.CRIT,
                       summary=
                       'provisioned concurrency utilization: 100.00% (warn/crit at 90.00%/95.00%)'),
                Metric('aws_lambda_provisioned_concurrency_utilization', 100.0,
                       levels=(90.0, 95.0)),
            ],
        ),
        (
            ...
            [
                ...
                Result(state=State.OK,
                       summary='unreserved concurrent executions in percent: 0.10%'),
                Metric('aws_lambda_unreserved_concurrent_executions_in_percent',
                       0.10050251256281408,
                       levels=(90.0, 95.0)),
                Result(state=State.CRIT,
...
def test_end_to_end_parsing_and_check(item, params, string_table_aws_lambda_provisioned_concurrency,
    ...
    assert list(
        check_aws_lambda_concurrency(
            ...
            if string_table_aws_lambda_region_limits else None,
        )) == results
