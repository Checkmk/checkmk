...
def test_parse_aws_lambda(string_table_aws_lambda: StringTable,
                          results: Optional[LambdaCloudwatchSection]) -> None:
...
def test_parse_aws_lambda_missing_mandatory_metric(
        string_table_aws_lambda: StringTable, results: Optional[LambdaCloudwatchSection]) -> None:
...
def test_check_aws_lambda_performance(
        item, params: LambdaPerformanceParameters,
...
def test_discover_aws_lambda(
    ...
    assert list(
        discover_aws_lambda(section_aws_lambda_summary, section_aws_lambda,
