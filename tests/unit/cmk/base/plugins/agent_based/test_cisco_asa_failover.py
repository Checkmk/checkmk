...
@pytest.mark.parametrize('params, section, expected', [
    pytest.param(
        cisco_asa_failover_params,
        Section(local_role='primary', local_status='9', local_status_detail='Active unit',
                failover_link_status='2', failover_link_name='ClusterLink Port-channel4 (system)',
                remote_status='10'),
    ...
    pytest.param(
        cisco_asa_failover_params,
        Section(local_role='primary', local_status='10', local_status_detail='Standby unit',
                failover_link_status='2', failover_link_name='ClusterLink Port-channel4 (system)',
                remote_status='9'),
    ...
    pytest.param(
        cisco_asa_failover_params,
        Section(local_role='primary', local_status='8', local_status_detail='Backup unit',
                failover_link_status='2', failover_link_name='ClusterLink Port-channel4 (system)',
                remote_status='10'),
    ...
    pytest.param(
        cisco_asa_failover_params,
        Section(local_role='primary', local_status='9', local_status_detail='Active unit',
                failover_link_status='3', failover_link_name='ClusterLink Port-channel4 (system)',
                remote_status='10'),
        [Result(state=State.OK, summary='Device (primary) is the Active unit'),
         Result(state=State.CRIT, summary='Failover link ClusterLink Port-channel4 (system) state is down'),
         ],
