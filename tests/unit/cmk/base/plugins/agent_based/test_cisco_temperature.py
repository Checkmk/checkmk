...
def test_parse_admin_state_mapping(
    ...
    assert snmp_is_detected(SectionName("cisco_temperature"), snmp_walk)

    assert expected_section == get_parsed_snmp_section(SectionName("cisco_temperature"), snmp_walk)
...
.1.3.6.1.4.1.9.9.91.1.2.1.1.6.38487.2 1"""
    snmp_walk = as_path(input_table)
    parsed_section = get_parsed_snmp_section(SectionName("cisco_temperature"), snmp_walk)
