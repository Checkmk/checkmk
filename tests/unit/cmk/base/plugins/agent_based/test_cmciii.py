...
def _generictest_cmciii():
    return [
        ...
        [['1.1', 'Temperature.DescName', '1', '', '0', 'Temperature', '0'],
         ...
         [
             '1.57', 'System.Temperature.SetPtHighWarning', '4', 'degree C', '-100',
             '70.00 degree C', '7000'
         ],
         [
             '1.58', 'System.Temperature.SetPtLowWarning', '9', 'degree C', '-100',
             '-25.00 degree C', '-2500'
         ],
         [
...
@pytest.mark.parametrize('plugin,params,expected', [
    ...
    (
        ...
        [
            ...
            Service(item='CMC-IOModul Input 3', parameters={'_item_key': 'CMC-IOModul Input 3'}),
            Service(item='CMC-IOModul Input 4', parameters={'_item_key': 'CMC-IOModul Input 4'}),
            Service(item='CMC-IOModul Input 5', parameters={'_item_key': 'CMC-IOModul Input 5'}),
            Service(item='CMC-IOModul Input 6', parameters={'_item_key': 'CMC-IOModul Input 6'}),
            Service(item='CMC-IOModul Input 7', parameters={'_item_key': 'CMC-IOModul Input 7'}),
            Service(item='CMC-IOModul Input 8', parameters={'_item_key': 'CMC-IOModul Input 8'}),
            Service(item='CMC-IOModul Output 1', parameters={'_item_key': 'CMC-IOModul Output 1'}),
            Service(item='CMC-IOModul Output 2', parameters={'_item_key': 'CMC-IOModul Output 2'}),
            Service(item='CMC-IOModul Output 3', parameters={'_item_key': 'CMC-IOModul Output 3'}),
            Service(item='CMC-IOModul Output 4', parameters={'_item_key': 'CMC-IOModul Output 4'}),
    ...
    (
        ...
        [
            ...
            Service(item='Dew Point CMC-Temperatur',
    ...
    (
        ...
        [
            ...
            Service(item='CMC-PU System.CAN2 Current',
...
@pytest.mark.parametrize('plugin, params, items', [
    ...
    (
        ...
        [
            ('CMC-IOModul Input 1',
             [Result(state=State.OK, summary='Status: OK, Logic: 0:OK / 1:Alarm, Delay: 5.0 s')]),
            ('CMC-IOModul Input 2',
             [Result(state=State.OK, summary='Status: OK, Logic: 0:OK / 1:Alarm, Delay: 5.0 s')]),
            ('CMC-IOModul Input 3',
             [Result(state=State.OK, summary='Status: Off, Logic: 0:On / 1:Off, Delay: 5.0 s')]),
            ('CMC-IOModul Input 4',
             [Result(state=State.OK, summary='Status: OK, Logic: 0:Alarm / 1:OK, Delay: 0.5 s')]),
            ('CMC-IOModul Input 5',
             [Result(state=State.OK, summary='Status: OK, Logic: 0:Alarm / 1:OK, Delay: 0.5 s')]),
            ('CMC-IOModul Input 6',
             [Result(state=State.OK, summary='Status: OK, Logic: 0:Alarm / 1:OK, Delay: 0.5 s')]),
            ('CMC-IOModul Input 7',
             [Result(state=State.OK, summary='Status: Off, Logic: 0:Off / 1:On, Delay: 0.5 s')]),
            ('CMC-IOModul Input 8',
             [Result(state=State.OK, summary='Status: Off, Logic: 0:Off / 1:On, Delay: 0.5 s')]),
            ('CMC-IOModul Output 1',
             [Result(state=State.OK, summary='Status: OK, Logic: 0:OK / 1:Alarm, Relay: Off')]),
            ...
            ('CMC-PU Input 2',
             [Result(state=State.OK, summary='Status: Off, Logic: 0:Off / 1:On, Delay: 0.5 s')]),
            ('CMC-PU Output',
             [Result(state=State.CRIT, summary='Status: Off, Logic: 0:Off / 1:On, Relay: Off')]),
        ],
    ),
    (
        'cmciii_access',
...
def _generictest_cmciii_input_regression():
    return [[[u'1', u'CMCIII-PU', u'CMCIII-PU', u'2'], [u'2', u'CMCIII-IO3', u'CMCIII-IO1', u'2'],
             [u'3', u'CMCIII-IO3', u'CMCIII-IO2', u'2'], [u'4', u'CMCIII-SEN', u'Doors', u'2'],
...
@pytest.mark.parametrize('plugin,params,expected', [
    ...
    (
        ...
        [
            ...
            Service(item='CMCIII-IO2 Input 4', parameters={'_item_key': u'CMCIII-IO2 Input 4'}),
            Service(item='CMCIII-IO2 Input 5', parameters={'_item_key': u'CMCIII-IO2 Input 5'}),
            Service(item='CMCIII-IO2 Input 6', parameters={'_item_key': u'CMCIII-IO2 Input 6'}),
            Service(item='CMCIII-IO2 Input 7', parameters={'_item_key': u'CMCIII-IO2 Input 7'}),
            Service(item='CMCIII-IO2 Input 8', parameters={'_item_key': u'CMCIII-IO2 Input 8'}),
...
@pytest.mark.parametrize('plugin, items', [
    ...
    (
        ...
        [
            ...
            ('CMCIII-IO2 Input 8',
             [Result(state=State.OK, summary='Status: Off, Logic: 0:Off / 1:On, Delay: 0.5 s')]),
            ('Doors Input', [Result(state=State.OK, summary='Status: Closed, Delay: 1 s')]),
        ],
    ),
])
