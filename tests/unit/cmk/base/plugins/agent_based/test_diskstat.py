...
def test_parse_diskstat_dmsetup():
    assert diskstat.parse_diskstat([
        ['1596025224'],
        [
            '259', '0', 'nvme0n1', '1497491', '455400', '113361605', '1143198', '773329', '599538',
            '37988658', '1395234', '0', '604316', '1097280', '0', '0', '0', '0'
        ],
        [
            '253', '0', 'dm-0', '1951297', '0', '113329354', '2084064', '1339672', '0', '37988424',
            '12603352', '0', '608364', '14687416', '0', '0', '0', '0'
        ],
        [
            '253', '1', 'dm-1', '1876633', '0', '112723490', '2074720', '1025893', '0', '35617992',
            '7615504', '0', '587960', '9690224', '0', '0', '0', '0'
        ],
        [
            '253', '2', 'dm-2', '74620', '0', '604024', '12548', '309840', '0', '2478720',
            '4781108', '0', '23492', '4793656', '0', '0', '0', '0'
        ],
        ['[dmsetup_info]'],
...
def test_parse_diskstat_vx_dsk():
    assert diskstat.parse_diskstat([
        ['1439883623'],
        [
            '253', '0', 'dm-0', '5888172', '0', '49638154', '234782', '19476903', '0', '155815224',
            '13469572', '0', '5663303', '13713680'
        ],
        [
            '253', '1', 'dm-1', '5851194', '0', '46809552', '154378', '0', '0', '0', '0', '0',
            '154404', '154405'
        ],
        [
            '65', '192', 'sdac', '1677718', '2543608', '8858709', '200958', '4217589', '28',
            '251814166', '1133920', '0', '1059518', '1333205'
        ],
        [
            '253', '2', 'dm-2', '5857900', '0', '47115410', '183023', '560857145', '0',
            '4486857160', '81720481', '0', '18413486', '81960804'
        ],
        [
            '253', '3', 'dm-3', '5851198', '0', '46809578', '162306', '12883365', '0', '103066920',
            '25366952', '0', '910764', '25529266'
        ],
        [
            '199', '3000', 'VxVM3000', '595084', '173', '8680186', '174091', '72847857',
            '500306960', '4585269136', '212664111', '0', '80648985', '212785322'
        ],
        [
            '199', '7000', 'VxVM7000', '479267', '152', '4033890', '103249', '12690313', '92841124',
            '844251992', '28260756', '0', '26058778', '28358884'
        ],
        [
            '199', '8000', 'VxVM8000', '543077', '291', '37131250', '274160', '19336020',
            '281685620', '2408182752', '155722978', '0', '30286244', '155989384'
        ],
        [
            '66', '160', 'sdaq', '239411', '559267', '1921823', '131489', '1710651', '286',
            '119899732', '1040265', '0', '509307', '1171318'
        ],
        [
            '199', '11000', 'VxVM11000', '209312', '96', '1747658', '48511', '6223668', '52087993',
            '466495304', '16982595', '0', '10872733', '17028919'
        ],
        [
            '199', '28000', 'VxVM28000', '971', '7834', '70442', '4614', '4142', '407556',
            '3293584', '26623', '0', '9388', '31237'
        ],
        ['[dmsetup_info]'],
...
def test_diskstat_convert_info():
    section_diskstat = {
        'cciss/c0d0': {
    ...
    assert diskstat.diskstat_convert_info(
        {},
        section_multipath,
    ) == {}
...
def test_check_diskstat_single_item(value_store):
    ...
    assert list(diskstat.check_diskstat(
        ...
        Result(state=state.OK, notice='Utilization: 0.00%'),
        ...
        Result(state=state.OK, notice='Average read wait: 39 microseconds'),
        Metric('disk_average_read_wait', 3.987349554326878e-05),
        Result(state=state.OK, notice='Average write wait: 691 microseconds'),
