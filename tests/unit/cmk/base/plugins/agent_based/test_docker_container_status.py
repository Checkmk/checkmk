...
NOW_SIMULATED = "2019-06-05T10:00:00.000000000Z"
...
@pytest.mark.parametrize("params, expected_results", [
    ({}, [
        Result(state=state.OK,
               summary='Up since Jun 05 2019 10:58:07, Uptime:: 1 hour 1 minute',
               details='Up since Jun 05 2019 10:58:07, Uptime:: 1 hour 1 minute'),
    ...
    ({
        ...
        Result(
            state=state.CRIT,
            summary=
            'Up since Jun 05 2019 10:58:07, Uptime:: 1 hour 1 minute (warn/crit at 16 minutes 40 seconds/33 minutes 20 seconds)',
            details=
            'Up since Jun 05 2019 10:58:07, Uptime:: 1 hour 1 minute (warn/crit at 16 minutes 40 seconds/33 minutes 20 seconds)'
        ),
