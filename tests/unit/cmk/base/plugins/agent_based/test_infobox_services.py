...
example_snmp_string_table_v9 = [
    ...
    [
        ...
        ["11", "5", ""],
        ["12", "1", "11.112.133.204"],
        ["13", "1", "14% - System memory usage is OK."],
        ["14", "1", "Online"],
        ["15", "1", "16% - Database capacity usage is OK."],
        ["16", "5", ""],
        ["17", "5", ""],
        ["18", "5", ""],
        ["19", "5", ""],
        ...
        ["26", "1", "FAN 2: 8725 RPM"],
        ["27", "1", "FAN 3: 8725 RPM"],
        ["28", "5", "Fan does not exist"],
        ["29", "5", "Fan does not exist"],
        ["30", "5", "Fan does not exist"],
        ["31", "5", "Fan does not exist"],
        ["32", "5", "Fan does not exist"],
        ["33", "1", "Power1 OK"],
        ["34", "5", "No power information available."],
        ["35", "1", "The NTP service resumed synchronization."],
        ["36", "1", "CPU_TEMP: +36.00 C"],
        ["37", "5", "No temperature information available."],
        ["38", "1", "SYS_TEMP: +34.00 C"],
        ["39", "5", ""],
        ["40", "1", "CPU Usage: 5%"],
        ["41", "4", ""],
        ["42", "4", ""],
        ...
        ["44", "5", ""],
        ["45", "5", ""],
        ["46", "5", "Reporting Service is inactive"],
        ["47", "5", ""],
        ["48", "4", ""],
        ["49", "1", "0% - System swap space usage is OK."],
        ["50", "5", "Discovery Consolidator Service is inactive"],
        ["51", "5", "Discovery Collector Service is inactive"],
        ["52", "1", "0% - Discovery capacity usage is OK."],
        ["53", "5", "Threat Protection Service is inactive"],
        ["54", "5", "Cloud API service is inactive."],
    ],
]
