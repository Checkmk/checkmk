...
def test_discovery_kemp_loadmaster_services(section: Section,
                                            expected_services: Sequence[Service]) -> None:
...
def test_check_kemp_loadmaster_services(section: Section, item: str,
                                        expected_results: Sequence[Result]) -> None:
