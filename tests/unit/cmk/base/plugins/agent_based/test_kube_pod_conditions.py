...
from cmk.base.api.agent_based.checking_classes import Result
...
def test_check_all_results_with_summary_status_false() -> None:
...
def test_check_all_results_with_summary_status_true() -> None:
