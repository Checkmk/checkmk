...
@pytest.mark.parametrize('string_table, result', [
    ([[[
        'System Status', 'Normal Operation', 'System Model Number', 'Liebert CRV',
        'Unit Operating State', 'standby', 'Unit Operating State Reason', 'Reason Unknown'
    ]]], {
    ...
    ([[[
        'System Status', 'Normal Operation', 'System Model Number', 'Liebert CRV',
        'Unit Operating State', 'on', 'Unit Operating State Reason', 'Reason Unknown'
    ]]], {
        'System Model Number': 'Liebert CRV',
        'System Status': 'Normal Operation',
