        ...
        with value_store.context(CheckPluginName("livestatus_status"), None):
            ...
            assert yielded_results == [
                ...
                Metric('average_latency_generic',
                       ...
                       boundaries=(None, None)),
                Result(state=state.OK,
                       summary='Average Check_MK latency: 0.000s',
                       details='Average Check_MK latency: 0.000s'),
                ...
                Metric('helper_usage_generic',
                       ...
                       boundaries=(None, None)),
                Result(state=state.OK,
                       summary='Check_MK helper usage: 0.04%',
                       details='Check_MK helper usage: 0.04%'),
                ...
                Result(state=state.OK,
                       summary='Core version: Check_MK 2019.05.31',
                       details='Core version: Check_MK 2019.05.31'),
                Result(state=state.OK,
