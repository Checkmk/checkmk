...
_RESULTS = [
    ...
    Result(state=state.OK, notice="Number of performance data received: 0"),
    Metric("perf_data_count", 0.0, boundaries=(0.0, None)),
    Result(state=state.OK, notice="Rate of performance data received: 0/s"),
    Metric("perf_data_count_rate", 0.0, boundaries=(0.0, None)),
    Result(state=state.OK, notice="Number of metrics received: 0"),
    Metric("metrics_count", 0.0, boundaries=(0.0, None)),
    ...
    Metric("carbon_queue_usage", 0.0, levels=(60.0, 80.0), boundaries=(0.0, None)),
    Result(state=state.OK, notice="Carbon queue usage rate: 0/s"),
    Metric("carbon_queue_usage_rate", 0.0, boundaries=(0.0, None)),
    Result(state=state.OK, notice="Performance data loss for Carbon: 0"),
    Metric("carbon_overflows", 0.0, boundaries=(0.0, None)),
    Result(state=state.OK, notice="Rate of performance data loss for Carbon: 0/s"),
    Metric("carbon_overflows_rate", 0.0, levels=(0.01, 0.02), boundaries=(0.0, None)),
    Result(state=state.OK, notice="Bytes sent to the Carbon connection: 0 B"),
    Metric("carbon_bytes_sent", 0.0, boundaries=(0.0, None)),
    ...
    Metric("influxdb_queue_usage", 0.0, levels=(60.0, 80.0), boundaries=(0.0, None)),
    Result(state=state.OK, notice="InfluxDB queue usage rate: 0/s"),
    Metric("influxdb_queue_usage_rate", 0.0, boundaries=(0.0, None)),
    Result(state=state.OK, notice="Performance data loss for InfluxDB: 0"),
    Metric("influxdb_overflows", 0.0, boundaries=(0.0, None)),
    Result(state=state.OK, notice="Rate of performance data loss for InfluxDB: 0/s"),
    Metric("influxdb_overflows_rate", 0.0, levels=(0.01, 0.02), boundaries=(0.0, None)),
    Result(state=state.OK, notice="Bytes sent to the InfluxDB connection: 0 B"),
    Metric("influxdb_bytes_sent", 0.0, boundaries=(0.0, None)),
    ...
    Metric("rrdcached_queue_usage", 0.0, levels=(60.0, 80.0), boundaries=(0.0, None)),
    Result(state=state.OK, notice="RRD queue usage rate: 0/s"),
    Metric("rrdcached_queue_usage_rate", 0.0, boundaries=(0.0, None)),
    Result(state=state.OK, notice="Performance data loss for RRD: 0"),
    Metric("rrdcached_overflows", 0.0, boundaries=(0.0, None)),
    Result(state=state.OK, notice="Rate of performance data loss for RRD: 0/s"),
    Metric("rrdcached_overflows_rate", 0.0, levels=(0.01, 0.02), boundaries=(0.0, None)),
    Result(state=state.OK, notice="Bytes sent to the RRD connection: 0 B"),
    Metric("rrdcached_bytes_sent", 0.0, boundaries=(0.0, None)),
