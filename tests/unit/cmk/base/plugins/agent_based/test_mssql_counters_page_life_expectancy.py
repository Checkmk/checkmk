...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            [
                Result(state=State.UNKNOWN, summary='Item not found in monitoring data'),
            ],
        ),
    ])
def test_cluster_check_mssql_counters_page_life_expectancy(item, params, section, expected_result):
    assert list(cluster_check_mssql_counters_page_life_expectancy(
        item,
        params,
        section,
    )) == expected_result
