    ...
    [
        ...
        (
            ...
            [
                ...
                Metric('fs_size', 2621440.0),
                Metric('fs_used_percent',
                       12.065238952636719,
                       levels=(None, None),
                       boundaries=(None, None)),
                Result(state=state.OK, summary='12.1% used (309 GiB of 2.50 TiB)'),
        ...
        (
            ...
            [
                ...
                Metric('fs_size', 614400.0),
                Metric('fs_used_percent',
                       20.386067708333332,
                       levels=(None, None),
                       boundaries=(None, None)),
                Result(state=state.OK, summary='20.4% used (122 of 600 GiB)'),
...
@pytest.mark.parametrize("section, params, expected", [
    (
        ...
        [
            ...
            Metric('fs_size', 2621440.0),
            Metric('fs_used_percent', 12.065238952636719),
            Result(state=state.OK, summary='12.1% used (309 GiB of 2.50 TiB)'),
            Metric('growth', -4423.433540694911),
            Result(state=state.OK, summary='trend per 1 day 0 hours: -4.32 GiB'),
            Result(state=state.OK, summary='trend per 1 day 0 hours: -0.17%'),
