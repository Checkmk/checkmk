...
@pytest.mark.parametrize("info, expected_result", [
    ...
    ([[["1", "-1", "15", "1111111", ""]]
     ], [Result(state=State.OK, summary="unknown alert group -1#15: unknown alert code: 1111111")]),
    ([[["2", "2", "15", "-1", ""]]
...
@mock.patch.dict("cmk.base.plugins.agent_based.printer_alerts.PRINTER_ALERTS_TEXT_MAP", {
