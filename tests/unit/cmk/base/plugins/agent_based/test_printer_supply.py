...
@pytest.mark.parametrize("item, params, info, expected_result", [
    ...
    (
        ...
        [Result(state=State.OK, summary="Level: 5"),
         Metric("pages", 5)],
    ),
    ("Magenta Ink Cartridge", {
        "levels": (20.0, 10.0),
        ...
        Result(state=State.CRIT, summary="Remaining: 5.00% (warn/crit below 20.00%/10.00%)"),
    ...
    (
        ...
        [
            Result(state=State.WARN, summary="Remaining: 15.00% (warn/crit below 20.00%/10.00%)"),
