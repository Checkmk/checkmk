...
def test_parse_sap_hana_replication_status(  # type:ignore[no-untyped-def]
...
def test_discovery_sap_hana_replication_status(  # type:ignore[no-untyped-def]
    fix_register, info, expected_result
) -> None:
...
def test_check_sap_hana_replication_status(  # type:ignore[no-untyped-def]
