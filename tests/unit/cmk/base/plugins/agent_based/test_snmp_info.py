...
@pytest.mark.parametrize("string_table, expected_result", [
    ([["KONICA MINOLTA bizhub C451", "R. Hantzsch", "Bizhub C451 1.OG\n", "1.OG / Raum 1.08"]],
     SNMPInfo("KONICA MINOLTA bizhub C451", "R. Hantzsch", "Bizhub C451 1.OG", "1.OG / Raum 1.08")),
    ([["KONICA MINOLTA bizhub C451", "R. Hantzsch", "Bizhub C451\n1.OG", "1.OG / Raum 1.08"]],
     SNMPInfo("KONICA MINOLTA bizhub C451", "R. Hantzsch", "Bizhub C451 1.OG", "1.OG / Raum 1.08")),
    ([["KONICA MINOLTA bizhub C451", "R. Hantzsch", "Bizhub C451\r\n1.OG", "1.OG / Raum 1.08"]],
     SNMPInfo("KONICA MINOLTA bizhub C451", "R. Hantzsch", "Bizhub C451 1.OG", "1.OG / Raum 1.08")),
])
