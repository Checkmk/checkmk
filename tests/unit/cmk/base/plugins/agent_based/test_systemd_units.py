    ...
    [
        ...
        pytest.param(
            [
                ...
                "dev-disk-by\\x2duuid-7941a423\\x2de7d7\\x2d4bbd\\x2d9526\\x2dfdb7ba7982a6.device loaded active plugged /dev/disk/by-uuid/7941a423-e7d7-4bbd-9526-fdb7ba7982a6",
                ...
                "check-mk-agent@40273-10.223.16.185:6556-10.20.114.58:57796.service loaded activating start start CheckMK (10.20.114.58:57796)",
                "corosync-qdevice.service loaded active running Corosync Qdevice daemon",
                ...
                'dsmcad_SCHED_PHT_BACKUP_DC2.service loaded active running "IBM Spectrum Protect Client dsmcad systemd-style service."',
        ...
        pytest.param(
            [
                ...
                "Loaded: loaded (/lib/systemd/system/systemd-ask-password-console.service; static)",
                "Active: inactive (dead)",
                ...
                "systemd-ask-password-plymouth.service loaded active running NOT FROM SYSTEMD",
