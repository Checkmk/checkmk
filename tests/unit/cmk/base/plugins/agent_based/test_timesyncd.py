...
DATA1 = [['Server:', '91.189.91.157', '(ntp.ubuntu.com)'],
         ['Poll', 'interval:', '32s', '(min:', '32s;', 'max', '34min', '8s)'], ['Leap:', 'normal'],
         ['Version:', '4'], ['Stratum:', '2'], ['Reference:', 'C0248F97'],
         ['Precision:', '1us', '(-24)'], ['Root', 'distance:', '87.096ms', '(max:', '5s)'],
         ['Offset:', '-53.991ms'], ['Delay:', '208.839ms'], ['Jitter:', '0'],
         ['Packet', 'count:', '1'], ['Frequency:', '-500,000ppm'], ['[[[1569922392.37]]]']]

DATA2 = [['Server:', '(null)', '(ntp.ubuntu.com)'],
...
@pytest.mark.parametrize('string_table, params, result', [
    (DATA1, timesyncd.default_check_parameters, [
        ...
        Result(
            state=state.CRIT,
            summary=
            'Time since last sync: 22 hours 1 minute (warn/crit at 2 hours 0 minutes/3 hours 0 minutes)'
        ),
    ...
    (DATA2, timesyncd.default_check_parameters, [
        Result(
            state=state.CRIT,
            summary=
            'Time since last sync: 22 hours 1 minute (warn/crit at 2 hours 0 minutes/3 hours 0 minutes)'
