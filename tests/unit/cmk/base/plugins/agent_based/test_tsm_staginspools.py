...
@pytest.mark.parametrize("item, params, expected", [
    ...
    ("foo", tsm_stagingpools.TSM_STAGINGPOOLS_DEFAULT_LEVELS, [
        ...
        Metric('free', 1.0, levels=(None, None), boundaries=(None, None)),
        Metric('tapes', 1.0, levels=(None, None), boundaries=(None, None)),
        Metric('util', 0.071, levels=(None, None), boundaries=(None, None)),
    ]),
    ("bar", {
        "levels": (2, 1),
        "free_below": 70
        ...
        Metric('free', 0.0, levels=(None, None), boundaries=(None, None)),
        Metric('tapes', 2.0, levels=(None, None), boundaries=(None, None)),
        Metric('util', 1.9780000000000002, levels=(None, None), boundaries=(None, None)),
    ]),
])
