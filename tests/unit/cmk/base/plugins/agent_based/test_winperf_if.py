...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            {Names.INTEL_PRO: _entry(1, Names.INTEL_PRO, 1000000000, Mode.CONN)},
            None,
            None,
            [_entry(1, Names.INTEL_PRO, 1000000000, Mode.CONN)],
            id="agent data only",
        ),
        pytest.param(
            {
                Names.QLOGIC_2: _entry(1, Names.QLOGIC_2, 10000000000, Mode.CONN),
                Names.QLOGIC: _entry(2, Names.QLOGIC, 10000000000, Mode.CONN),
                Names.INTEL_I350: _entry(3, Names.INTEL_I350, 0, Mode.CONN),
                Names.INTEL_I350_2: _entry(4, Names.INTEL_I350_2, 0, Mode.CONN),
                Names.INTEL_I350_3: _entry(5, Names.INTEL_I350_3, 0, Mode.CONN),
                Names.INTEL_I350_4: _entry(6, Names.INTEL_I350_4, 0, Mode.CONN),
                Names.IBM_USB_2: _entry(7, Names.IBM_USB_2, 9728000, Mode.CONN),
                Names.ISATAP_A4: _entry(8, Names.ISATAP_A4, 100000, Mode.CONN),
                Names.ISATAP_4F: _entry(9, Names.ISATAP_4F, 100000, Mode.CONN),
            },
            None,
            EXPECTED_WINPERF_IF_WIN32_NETWORKADAPTER_OUTPUT_1,
            [
                _entry(1, Names.QLOGIC_2, 10000000000, Mode.CONN),
                _entry(
                    2,
                    Names.QLOGIC,
                    10000000000,
                ...
                _entry(8, Names.ISATAP_A4, 100000, Mode.CONN),
                _entry(9, Names.ISATAP_4F, 100000, Mode.CONN),
            ],
            id="with additional data",
        ),
        pytest.param(
            {
                Names.INTEL_NDC: _entry(1, Names.INTEL_NDC, 1000000000, Mode.CONN),
                Names.INTEL_X520: _entry(2, Names.INTEL_X520, 10000000000, Mode.CONN),
                Names.INTEL_X520_2: _entry(3, Names.INTEL_X520_2, 10000000000, Mode.CONN),
                Names.INTEL_NDC_2: _entry(4, Names.INTEL_NDC_2, 0, Mode.CONN),
                Names.INTEL_NDC_3: _entry(5, Names.INTEL_NDC_3, 0, Mode.CONN),
                Names.INTEL_NDC_4: _entry(6, Names.INTEL_NDC_4, 0, Mode.CONN),
                Names.INTEL_X520_3: _entry(7, Names.INTEL_X520_3, 10000000000, Mode.CONN),
                Names.INTEL_X520_4: _entry(8, Names.INTEL_X520_4, 10000000000, Mode.CONN),
                Names.NIN: _entry(9, Names.NIN, 100000, Mode.CONN),
                Names.ISATAP_01: _entry(10, Names.ISATAP_01, 100000, Mode.CONN),
                Names.ISATAP_16: _entry(11, Names.ISATAP_16, 100000, Mode.CONN),
                Names.ISATAP_7A: _entry(12, Names.ISATAP_7A, 100000, Mode.CONN),
            },
            {
                "{70F3DEC7-8347-4157-B066-95F5672F39BA}": TeamingData(
                    team_name="DAG-NET",
            ...
            [
                ...
                _entry(9, Names.NIN, 100000, Mode.CONN),
                _entry(10, Names.ISATAP_01, 100000, Mode.CONN),
                _entry(11, Names.ISATAP_16, 100000, Mode.CONN),
                _entry(12, Names.ISATAP_7A, 100000, Mode.CONN),
            ],
            id="with additional data",
        ),
    ],
