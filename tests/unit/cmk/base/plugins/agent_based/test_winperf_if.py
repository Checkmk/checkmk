...
WINPERF_IF_WIN32_NETWORKADAPTER_INPUT: _Block = [
    [
        "Node",
        "MACAddress",
        "Name",
...
EXPECTED_WINPERF_IF_WIN32_NETWORKADAPTER_OUTPUT: Sequence[AdditionalIfData] = [
    AdditionalIfData(
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            _flatten(
                [MULTIPLY_INTERFACES_12_INPUT, TEAMING_INPUT, WINPERF_IF_WIN32_NETWORKADAPTER_INPUT]
            ),
            SectionCounters(
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            WINPERF_IF_WIN32_NETWORKADAPTER_INPUT,
            EXPECTED_WINPERF_IF_WIN32_NETWORKADAPTER_OUTPUT,
            id="windows_if.ps1 2",
        ),
        pytest.param(
            [
