...
def test_check_winperf_if() -> None:
    section = SectionCounters(
        timestamp=3.0,
        interfaces={
            "Intel[R]": interfaces.InterfaceWithCounters(
                interfaces.Attributes(
                    index="1",
                    descr="Intel[R]",
                    alias="Intel[R]",
    ...
    value_store = {
        "in_octets.1.Intel[R].Intel[R].None": (2.0, 60023498),
        "in_ucast.1.Intel[R].Intel[R].None": (2.0, 42348),
        "in_bcast.1.Intel[R].Intel[R].None": (2.0, 685),
        "in_disc.1.Intel[R].Intel[R].None": (2.0, 0),
        "in_err.1.Intel[R].Intel[R].None": (2.0, 0),
        "out_octets.1.Intel[R].Intel[R].None": (2.0, 1363362),
        "out_ucast.1.Intel[R].Intel[R].None": (2.0, 5771),
        "out_bcast.1.Intel[R].Intel[R].None": (2.0, 126),
        "out_disc.1.Intel[R].Intel[R].None": (2.0, 0),
        "out_err.1.Intel[R].Intel[R].None": (2.0, 0),
    }
    results = list(
        _check_winperf_if(
            "Intel[R]",
    ...
    assert results == [
        ...
        Result(
            state=State.OK, summary="(Not available)", details="Operational state: Not available"
        ),
        Result(state=State.OK, summary="Speed: 1 GBit/s"),
        Metric("outqlen", 0.0),
        Result(state=State.OK, summary="In: 0.00 B/s (0%)"),
        Metric("in", 0.0, boundaries=(0.0, 125000000.0)),
        Result(state=State.OK, summary="Out: 0.00 B/s (0%)"),
        Metric("out", 0.0, boundaries=(0.0, 125000000.0)),
