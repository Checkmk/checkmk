...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {},
            [
                Result(state=State.OK, summary='Total CPU: 99.9998%'),
                Metric('util', 99.99983122362869, boundaries=(0, 4)),  # boundaries: 4 as in 4 CPUs
                Result(state=State.OK, notice='User: 0.00%'),
                Metric('user', 0.0005063291139240507),
                Result(state=State.OK, notice='Privileged: 0.00%'),
        ...
        (VALUE_STORE, {
            ...
            Result(state=State.CRIT, summary='Total CPU: 99.9998% (warn/crit at 90.0%/95.0%)'),
