...
def test_rbn_match_rule_do_not_match_ec_alerts_passes_host_notification() -> None:
    assert (
        notify.rbn_match_rule(
...
def test_rbn_match_rule_do_not_match_ec_alerts_blocks_ec_alert() -> None:
    assert (
        notify.rbn_match_rule(
            _make_rule() | {"match_ec": False},
