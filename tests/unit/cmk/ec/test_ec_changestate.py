...
def test_changestate_of_nonexistent_event(status_server) -> None:
...
def test_change_event_state(event_status, status_server) -> None:
    """Changestate 1 event."""
    event = {
        "host": "ABC1",
        "text": "not important",
...
def test_changetestate_of_multiple_events(event_status, status_server) -> None:
...
def test_changestate_of_partially_existing_multiple_events(event_status, status_server) -> None:
