...
def test_host_config(host_config: HostConfig, live: MockLiveStatusConnection, hostname_str: str,
                     result: Optional[HostInfo]) -> None:
...
def test_host_config_get_canonical_name(host_config: HostConfig, live: MockLiveStatusConnection,
                                        search_term: str, result: Optional[HostName]) -> None:
    with live(expect_status_query=False):
        live.expect_query(["GET status", "Columns: program_start", "ColumnHeaders: off"])
        live.expect_query([
            "GET hosts",
...
def test_host_config_get_canonical_name_is_cached_updated(host_config: HostConfig,
                                                          live: MockLiveStatusConnection) -> None:
    with live(expect_status_query=False):
        live.expect_query(["GET status", "Columns: program_start", "ColumnHeaders: off"])
        live.expect_query([
            "GET hosts",
