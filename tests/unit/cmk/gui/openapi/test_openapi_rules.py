...
DEFAULT_RULESET = "inventory_df_rules"
...
# A "Periodic service discovery" value in the current format, i.e. one that the ruleset's
# migration leaves untouched.
PERIODIC_DISCOVERY_VALUE_RAW = """{
...
def test_edit_rule_rejects_outdated_legacy_value(clients: ClientRegistry) -> None:
    ...
    created = clients.Rule.create(
        ...
        value_raw=PERIODIC_DISCOVERY_VALUE_RAW,
        conditions={},
    )
