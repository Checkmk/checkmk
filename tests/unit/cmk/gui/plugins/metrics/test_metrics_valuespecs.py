...
@pytest.mark.parametrize("entry, result", [
    pytest.param("add_host_name", ["plain", "add_host_name"],
                 id="->1.5.0i2->2.0.0i1 pnp_graph reportlet"),
    pytest.param("plain", ["plain"], id="1.5.0i2->2.0.0i1 direct plain title"),
    pytest.param(("add_title_infos", ["add_host_alias", "add_service_description"]),
