    ...
    'check_table': [
        ...
        ('new', 'df', 'filesystem', '/opt/omd/sites/stable/tmp', {
         ...
         [('fs_used', 9.42578125, 6356.853125, 7151.459765625, 0, 7946.06640625),
          ...
          ('inodes_used', 1412, 1830773.7, 1932483.3499999999, 0.0, 2034193.0)], {}, None),
        (
            'new',
            'df',
            'filesystem',
        ...
        (
            ...
            [('fs_used', 217.3671875, 563.5875, 634.0359375, 0, 704.484375),
             ('fs_size', 704.484375), ('fs_used_percent', 30.854791846873823),
        ...
        ('old', 'lnx_thermal', 'temperature', 'Zone 0', '{}', {
            ...
            'levels': (70.0, 80.0)
        }, 'Temperature Zone 0', 0, '25.0 °C', [('temp', 25.0, 107.0, 107.0)], {}, None),
        (
            'old',
            'lnx_thermal',
            'temperature',
        ...
        (
            ...
            [('active', 8891592704), ('active_anon', 7336378368), ('active_file', 1555214336),
             ('anon_huge_pages', 0), ('anon_pages', 7420919808), ('bounce', 0),
             ('buffers', 272564224), ('cached', 3219124224), ('caches', 4009385984),
             ('cma_free', 0), ('cma_total', 0), ('commit_limit', 9359654912),
             ('committed_as', 16258154496), ('dirty', 14913536), ('hardware_corrupted', 0),
             ('inactive', 2157494272), ('inactive_anon', 1121906688), ('inactive_file', 1035587584),
             ('kreclaimable', 361406464), ('kernel_stack', 28037120), ('mapped', 970366976),
             ('mem_available', 7177719808), ('mem_free', 4710035456), ('mem_total', 16664109056),
             ('mem_used', 7944687616), ('mem_used_percent', 47.675441809110545), ('mlocked', 81920),
             ('nfs_unstable', 0), ('page_tables', 84729856), ('pending', 14913536),
             ('percpu', 9633792), ('sreclaimable', 361406464), ('sunreclaim', 257396736),
             ('shmem', 934322176), ('shmem_huge_pages', 0), ('shmem_pmd_mapped', 0),
             ('slab', 618803200), ('swap_cached', 156291072), ('swap_free', 226992128),
             ('swap_total', 1027600384), ('swap_used', 800608256), ('total_total', 17691709440),
             ('total_used', 8745295872), ('unevictable', 19808256), ('writeback', 0),
             ('writeback_tmp', 0)],
            {},
            None,
        ),
        (
            ...
            [('num_open_events', 0), ('process_virtual_size', 218300416),
             ...
             ('average_rule_trie_rate', 0.0), ('average_drop_rate', 0.0),
             ('average_event_rate', 0.0), ('average_connect_rate', 0.0),
             ('average_request_time', 0.00027762370400620984)],
            {},
            None,
        ),
        (
            ...
            [('num_open_events', 0), ('process_virtual_size', 205152256),
             ...
             ('average_rule_trie_rate', 0.0), ('average_drop_rate', 0.0),
             ('average_event_rate', 0.0), ('average_connect_rate', 0.0),
             ('average_request_time', 0.00039733688471126213)],
            {},
            None,
        ),
        (
        ...
        (
            ...
            [
                'codepage=437', 'dmask=0077', 'errors=remount-ro', 'fmask=0077',
                'iocharset=iso8859-1', 'relatime', 'rw', 'shortname=mixed'
            ],
        ...
        (
            ...
            0,
            'WAITING - Counter based check, cannot be done offline',
            [('requests_images', 0.0), ('requests_cmk_other', 0.0), ('requests_cmk_snapins', 0.0),
             ('requests_styles', 0.0), ('requests_scripts', 0.0), ('requests_cmk_wato', 0.0),
             ('requests_cmk_views', 0.0),
             ('requests_cmk_bi', 0.0), ('requests_cmk_dashboards', 0.0),
             ('requests_nagvis_snapin', 0.0), ('requests_nagvis_ajax', 0.0),
             ('requests_nagvis_other', 0.0), ('requests_other', 0.0), ('secs_cmk_other', 0.0),
             ('secs_cmk_snapins', 0.0), ('secs_scripts', 0.0), ('secs_cmk_wato', 0.0),
             ('secs_images', 0.0), ('secs_styles', 0.0), ('secs_cmk_views', 0.0),
             ('secs_cmk_bi', 0.0), ('secs_cmk_dashboards', 0.0), ('secs_nagvis_snapin', 0.0),
             ('secs_nagvis_ajax', 0.0), ('secs_nagvis_other', 0.0), ('secs_other', 0.0),
             ('bytes_scripts', 0.0), ('bytes_styles', 0.0), ('bytes_cmk_other', 0.0),
             ('bytes_cmk_snapins', 0.0), ('bytes_cmk_wato', 0.0), ('bytes_images', 0.0),
             ('bytes_cmk_views', 0.0), ('bytes_cmk_bi', 0.0), ('bytes_cmk_dashboards', 0.0),
             ('bytes_nagvis_snapin', 0.0), ('bytes_nagvis_ajax', 0.0), ('bytes_nagvis_other', 0.0),
             ('bytes_other', 0.0)],
            {},
            None,
        ),
        (
            ...
            0,
            'WAITING - Counter based check, cannot be done offline',
            [('requests_cmk_other', 0.0), ('requests_cmk_views', 0.0), ('requests_cmk_wato', 0.0),
             ('requests_cmk_bi', 0.0), ('requests_cmk_snapins', 0.0),
             ('requests_cmk_dashboards', 0.0), ('requests_nagvis_snapin', 0.0),
             ('requests_nagvis_ajax', 0.0),
             ('requests_nagvis_other', 0.0), ('requests_images', 0.0), ('requests_styles', 0.0),
             ('requests_scripts', 0.0), ('requests_other', 0.0), ('secs_cmk_other', 0.0),
             ('secs_cmk_views', 0.0), ('secs_cmk_wato', 0.0), ('secs_cmk_bi', 0.0),
             ('secs_cmk_snapins', 0.0), ('secs_cmk_dashboards', 0.0), ('secs_nagvis_snapin', 0.0),
             ('secs_nagvis_ajax', 0.0), ('secs_nagvis_other', 0.0), ('secs_images', 0.0),
             ('secs_styles', 0.0), ('secs_scripts', 0.0), ('secs_other', 0.0),
             ('bytes_cmk_other', 0.0), ('bytes_cmk_views', 0.0), ('bytes_cmk_wato', 0.0),
             ('bytes_cmk_bi', 0.0), ('bytes_cmk_snapins', 0.0), ('bytes_cmk_dashboards', 0.0),
             ('bytes_nagvis_snapin', 0.0), ('bytes_nagvis_ajax', 0.0), ('bytes_nagvis_other', 0.0),
             ('bytes_images', 0.0), ('bytes_styles', 0.0), ('bytes_scripts', 0.0),
             ('bytes_other', 0.0)],
            {},
            None,
        ),
