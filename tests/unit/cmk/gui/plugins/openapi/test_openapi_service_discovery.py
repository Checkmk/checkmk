    ...
    "check_table": [
        ...
        (
            ...
            [
                ...
                ("fs_size", 7946.06640625),
                ("fs_used_percent", 0.07929434424363863),
        ...
        (
            ...
            [
                ...
                ("fs_size", 7946.06640625),
                ("fs_used_percent", 0.11862197933037819),
        ...
        (
            ...
            [
                ...
                ("fs_size", 477500.03125),
                ("fs_used_percent", 25.236947792084568),
        ...
        (
            ...
            [
                ("process_creations", 0.0, None, None),
                ("context_switches", 0.0, None, None),
                ("major_page_faults", 0.0, None, None),
                ("page_swap_in", 0.0, None, None),
        ...
        (
            ...
            [
                ("user", 14.70410082412248, None, None),
                ("system", 12.142805812602681, None, None),
        ...
        (
            ...
            [
                ("active", 8891592704),
                ("active_anon", 7336378368),
                ("active_file", 1555214336),
                ("anon_huge_pages", 0),
                ("anon_pages", 7420919808),
                ("bounce", 0),
                ("buffers", 272564224),
                ("cached", 3219124224),
                ("caches", 4009385984),
                ("cma_free", 0),
                ("cma_total", 0),
                ("commit_limit", 9359654912),
                ("committed_as", 16258154496),
                ("dirty", 14913536),
                ("hardware_corrupted", 0),
                ("inactive", 2157494272),
                ("inactive_anon", 1121906688),
                ("inactive_file", 1035587584),
                ("kreclaimable", 361406464),
                ("kernel_stack", 28037120),
                ("mapped", 970366976),
                ("mem_available", 7177719808),
                ("mem_free", 4710035456),
                ("mem_total", 16664109056),
                ("mem_used", 7944687616),
                ("mem_used_percent", 47.675441809110545),
                ("mlocked", 81920),
                ("nfs_unstable", 0),
                ("page_tables", 84729856),
                ("pending", 14913536),
                ("percpu", 9633792),
                ("sreclaimable", 361406464),
                ("sunreclaim", 257396736),
                ("shmem", 934322176),
                ("shmem_huge_pages", 0),
                ("shmem_pmd_mapped", 0),
                ("slab", 618803200),
                ("swap_cached", 156291072),
                ("swap_free", 226992128),
                ("swap_total", 1027600384),
                ("swap_used", 800608256),
                ("total_total", 17691709440),
                ("total_used", 8745295872),
                ("unevictable", 19808256),
                ("writeback", 0),
                ("writeback_tmp", 0),
            ],
            {},
        ...
        (
            ...
            [
                ("num_open_events", 0),
                ("process_virtual_size", 218300416),
                ("average_message_rate", 0.0),
                ("average_rule_hit_rate", 0.0),
                ("average_rule_trie_rate", 0.0),
                ("average_drop_rate", 0.0),
                ("average_event_rate", 0.0),
                ("average_connect_rate", 0.0),
        ...
        (
            ...
            [
                ("num_open_events", 0),
                ("process_virtual_size", 205152256),
                ("average_message_rate", 0.0),
                ("average_rule_hit_rate", 0.0),
                ("average_rule_trie_rate", 0.0),
                ("average_drop_rate", 0.0),
        ...
        (
            ...
            [
                ("CLOSED", 0, None, None),
                ("CLOSE_WAIT", 5, None, None),
                ("CLOSING", 0, None, None),
                ("ESTABLISHED", 13, None, None),
                ("FIN_WAIT1", 0, None, None),
                ("FIN_WAIT2", 1, None, None),
                ("LAST_ACK", 0, None, None),
                ("LISTEN", 21, None, None),
                ("SYN_RECV", 0, None, None),
                ("SYN_SENT", 1, None, None),
