...
@pytest.mark.parametrize("perf_data, expected_result", [
    (
        ...
        (
            '0 Tot / 0.00 s',
            HTML(
                "<div class=\"stacked\"><table><tr><td style=\"width: 0%; background-color: #aabb50\" class=\"inner\"></td>"
                "<td style=\"width: 100%; background-color: #ffffff\" class=\"inner\"></td></tr></table>"
                "<table><tr><td style=\"width: 0%; background-color: #ccff50\" class=\"inner\"></td>"
                "<td style=\"width: 100%; background-color: #ffffff\" class=\"inner\"></td></tr></table></div>"
            ),
        ),
    ),
])
