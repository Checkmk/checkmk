...
def test_registered_painters() -> None:
    ...
    expected_painters = [
        ...
        "inv_networking_cdp_cache",
        "inv_networking_cdp_cache_neighbors",
        "inv_networking_interfaces",
        "inv_networking_interfaces_is_show_more",
        "inv_networking_interfaces_name",
        ...
        "inv_software_applications_azure_metadata",
        "inv_software_applications_azure_metadata_entity",
        "inv_software_applications_azure_metadata_name",
        "inv_software_applications_azure_metadata_object",
        "inv_software_applications_azure_metadata_region",
        "inv_software_applications_azure_metadata_resource_group",
        ...
        "inv_software_applications_cisco_meraki_networks",
        "inv_software_applications_cisco_meraki_organisations",
        ...
        "inv_software_applications_kube_cluster",
        ...
        "inv_software_applications_proxmox_ve",
        "inv_software_applications_proxmox_ve_cluster",
        ...
        "invcdpcache_capabilities",
        "invcdpcache_duplex",
        "invcdpcache_local_port",
        "invcdpcache_native_vlan",
        "invcdpcache_neighbor_id",
        "invcdpcache_neighbor_name",
        "invcdpcache_neighbor_port",
        "invcdpcache_neighbor_address",
        "invcdpcache_platform",
        "invcdpcache_platform_details",
        "invcdpcache_power_consumption",
        "invcdpcache_vtp_mgmt_domain",
        ...
        "invchassis_serial",
        "invchassis_software",
        "invmerakilicenses_gateway_mg_count",
        "invmerakilicenses_org_id",
        "invmerakilicenses_org_name",
        "invmerakilicenses_other_count",
        "invmerakilicenses_security_mx_count",
        "invmerakilicenses_sensor_mt_count",
        "invmerakilicenses_summary",
        "invmerakilicenses_switch_ms_count",
        "invmerakilicenses_systems_manager_sm_count",
        "invmerakilicenses_video_mv_count",
        "invmerakilicenses_wireless_mr_count",
        "invmerakinetworks_enrollment_string",
        "invmerakinetworks_is_bound_to_template",
        "invmerakinetworks_network_id",
        "invmerakinetworks_network_name",
        "invmerakinetworks_notes",
        "invmerakinetworks_org_id",
        "invmerakinetworks_org_name",
        "invmerakinetworks_product_types",
        "invmerakinetworks_tags",
        "invmerakinetworks_time_zone",
        "invmerakinetworks_url",
        "invmerakiorganisations_api_status",
        "invmerakiorganisations_cloud_region",
        "invmerakiorganisations_licensing_model",
        "invmerakiorganisations_org_id",
        "invmerakiorganisations_org_name",
        "invmerakiorganisations_url",
        "invcmksites_apache",
        ...
        "invdeviceuplinks_address",
        "invdeviceuplinks_assignment_mode",
        "invdeviceuplinks_gateway",
        "invdeviceuplinks_interface",
        "invdeviceuplinks_protocol",
        "invdeviceuplinks_public_address",
        ...
        "invipaddresses_scope_id",
        "invipaddresses_type",
        "invkernelconfig_name",
        "invkernelconfig_value",
        "invlldpcache_capabilities",
        "invlldpcache_capabilities_map_supported",
        "invlldpcache_local_port",
        "invlldpcache_neighbor_address",
        "invlldpcache_neighbor_address",
        "invlldpcache_neighbor_id",
        "invlldpcache_neighbor_name",
        "invlldpcache_neighbor_port",
        "invlldpcache_port_description",
        "invlldpcache_system_description",
    ...
    if cmk_version.edition(paths.omd_root) is not cmk_version.Edition.COMMUNITY:
        expected_painters += [
            ...
            "oracle_active_sessions_figure",
            "oracle_active_undo_blocks_figure",
            "oracle_buffer_hit_ratio_gauge",
            "oracle_instance_dashboard_link",
            "oracle_library_hit_ratio_gauge",
            "oracle_long_active_sessions_figure",
        ]
