...
filter_tests = [
    ...
    FilterTest(
        ...
        expected_filters=("Filter: comment_entry_time >= 981154800\n"
    ...
    FilterTest(
        ...
        expected_filters=("Filter: comment_entry_time >= 1523803800\n"
    ...
    FilterTest(
        ...
        expected_filters=("Filter: host_tags = 'a' 'a'\n"
    ...
    FilterTest(
        ...
        expected_filters=("Filter: current_notification_number >= 10\n"
    ...
    FilterTest(
        ...
        expected_filters=("Filter: host_tags != 'address_family' 'no-ip1'\n"
    ...
    FilterTest(
        ...
        expected_filters=("Filter: host_num_services_crit > 0\n"
                          "Filter: host_num_services_pending > 0\n"
                          "Or: 2\n"),
    ),
    FilterTest(ident="hostsgroups_having_problems",
    ...
    FilterTest(
        ...
        expected_filters=('Filter: log_type ~ HOST .*\n'
                          'Filter: log_state = 0\n'
                          'And: 2\n'
    ...
    FilterTest(
        ...
        expected_filters=('Filter: event_contact_groups_precedence = host\n'
    ...
    FilterTest(
        ...
        expected_filters=("Filter: service_last_hard_state = 1\n"
...
filter_table_tests = [
    ...
    FilterTableTest(ident="invinterface_index",
                    request_vars=[
...
def _set_expected_queries(filt_ident, live):
    ...
    if filt_ident in [
            "contactgroups", "optcontactgroup", "opthost_contactgroup", "optservice_contactgroup",
