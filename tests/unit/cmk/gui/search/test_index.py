...
def test_updates_requested_false_when_no_file_exists() -> None:
    assert index._updates_requested() is False  # noqa: SLF001


def test_updates_requested_true_after_rebuild_request() -> None:
    index.request_rebuild()
    assert index._updates_requested() is True  # noqa: SLF001
...
def test_request_index_rebuild_sets_rebuild_flag() -> None:
    ...
    value = index._read_and_remove_update_requests()  # noqa: SLF001
...
def test_read_and_remove_update_requests_removes_file() -> None:
    index.request_rebuild()
    index._read_and_remove_update_requests()  # noqa: SLF001
    assert index._updates_requested() is False  # noqa: SLF001


def test_read_and_remove_update_requests_defaults_when_no_file_exists() -> None:
    assert index._read_and_remove_update_requests() == {"rebuild": False, "change_actions": []}  # noqa: SLF001


def test_read_and_remove_update_requests_defaults_on_corrupted_json() -> None:
    index._PATH_UPDATE_REQUESTS.write_text("not valid json")  # noqa: SLF001
...
def test_read_and_remove_update_requests_defaults_on_missing_keys() -> None:
    index._PATH_UPDATE_REQUESTS.write_text('{"rebuild": true}')  # noqa: SLF001
...
def test_read_and_remove_update_requests_coerces_change_action_types() -> None:
    index._PATH_UPDATE_REQUESTS.write_text('{"rebuild": false, "change_actions": [1, 2]}')  # noqa: SLF001
...
def test_main_requests_an_index_rebuild() -> None:
    ...
    assert index._read_and_remove_update_requests() == {"rebuild": True, "change_actions": []}  # noqa: SLF001
