...
def test_registered_pages() -> None:
    expected_pages = [
        ...
        "ajax_maps_ticket",
        "ajax_maps_command",
        "ajax_maps_form_schema",
        "ajax_maps_form_parse",
        "ajax_maps_parse_cfg",
        "ajax_maps_image_upload",
        "ajax_maps_image_delete",
        "ajax_maps_background_upload",
        "ajax_maps_background_delete",
        "ajax_ping_host",
    ...
    actual_set = {p for p in cmk.gui.pages.page_registry if p != "switch_customer"}  #
