...
def test_basic(register_builtin_html):
    ...
    with Table(table_id, title, searchable=False, sortable=False) as table:
        table.row()
        table.cell("A", "1")
        table.cell("B", "2")
        table.row()
...
def test_context(register_builtin_html):
    ...
    with Table(table_id=table_id, searchable=False, sortable=False) as table:
        for row in rows:
            table.row()
...
def test_nesting(register_builtin_html):
    ...
    with Table(table_id, title, searchable=False, sortable=False) as table1:
        table1.row()
        table1.cell("A", "1")
        table1.cell("B", "")
        with Table(table_id + 1, title + "2", searchable=False, sortable=False) as table2:
            table2.row()
            table2.cell("_", "+")
            table2.cell("|", "-")
...
def test_nesting_context(register_builtin_html):
    ...
    with Table(table_id=table_id, title=title, searchable=False, sortable=False) as table1:
        table1.row()
        table1.cell("A", "1")
        table1.cell("B", "")
        with Table(table_id + 1, title + "2", searchable=False, sortable=False) as table2:
