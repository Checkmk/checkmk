...
@pytest.mark.parametrize("entry, result", [
    ...
    ("4h", ((1567687800.0, 1567702200.0), "Last 4 hours")),
    (4 * 60 * 60, ((1567687800.0, 1567702200.0), "The last 4 hours")),
    ("25h", ((1567612200.0, 1567702200.0), "Last 25 hours")),
    ("8d", ((1567011000.0, 1567702200.0), "Last 8 days")),
    ("15d", ((1566406200.0, 1567702200.0), "Last 15 days")),
    ("35d", ((1564678200.0, 1567702200.0), "Last 35 days")),
    ("400d", ((1533142200.0, 1567702200.0), "Last 400 days")),
    ("d0", ((1567641600.0, 1567702200.0), "Today")),
    ("d1", ((1567555200.0, 1567641600.0), "Yesterday")),
    ("d7", ((1567036800.0, 1567123200.0), "2019-08-29")),
    ("d8", ((1566950400.0, 1567036800.0), "2019-08-28")),
    ("w0", ((1567382400.0, 1567702200.0), "This week")),
    ("w1", ((1566777600.0, 1567382400.0), "Last week")),
    ("w2", ((1566172800.0, 1566777600.0), "2019-08-19 — 2019-08-25")),
    (("date", (1536098400.0, 1567288800.0)),
     ((1536098400.0, 1567375200.0), "2018-09-04 — 2019-09-01")),
    (("until", 1577232000), ((1567702200.0, 1577232000.0), "2019-12-25")),
    (("time", (1549374782.0, 1567687982.0)),
     ((1549374782.0, 1567687982.0), "2019-02-05 — 2019-09-05")),
    (("age", 2 * 3600), ((1567695000.0, 1567702200.0), "The last 2 hours")),
    (("next", 3 * 3600), ((1567702200.0, 1567713000.0), "The next 3 hours")),
])
