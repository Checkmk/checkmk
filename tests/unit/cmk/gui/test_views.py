...
def test_registered_display_hints(load_plugins):
    ...
    ".hardware.storage.physical_volumes:*.physical_volume_total_partitions",
    ".hardware.storage.physical_volumes:*.physical_volume_free_partitions",
    '.hardware.system.',
    ...
    ".networking.domain_name",
    ".networking.ip_address",
    ".networking.gateway",
    ".networking.sub_netmask",
    ".networking.name_server",
    '.software.',
