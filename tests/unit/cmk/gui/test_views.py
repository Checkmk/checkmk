...
def test_registered_display_hints(load_plugins):
    ...
    ".hardware.storage.logical_volumes:*.disc_type",
    ".hardware.storage.logical_volumes:*.logical_partitions",
    ".hardware.storage.logical_volumes:*.physical_partitions",
    ".hardware.storage.logical_volumes:*.physical_volumes",
    ".hardware.storage.logical_volumes:*.state",
    ".hardware.storage.logical_volumes:*.mount_point",
    '.hardware.system.',
