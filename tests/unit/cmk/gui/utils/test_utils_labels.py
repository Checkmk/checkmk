...
SINGLE_SETUP_ROWS = _LivestatusLabelResponse(
    ...
    LivestatusResponse(
        [
            LivestatusRow(["heute", {"cmk/site": "heute", "label1": "value2"}]),
        ]
    ),
)
    ...
    [
        [
            ...
            _MergedLabels(
                ...
                {
                    SiteId("heute"): {"svclabel": "['svcvalue1', 'svcvalue2']"},
                    SiteId("heute_remote_1"): {"svclabel": "['svcvalue3']"},
                    SiteId("heute_remote_2"): {},
                },
            ),
        ],
        [
            ...
            _MergedLabels(
                ...
                {SiteId("heute"): {"cmk/site": "['heute']", "label1": "['value2']"}},
            ),
        ],
    ],
)
