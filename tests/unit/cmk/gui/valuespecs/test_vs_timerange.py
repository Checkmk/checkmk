...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ("date", (1536098400, 1567288800)),
            ((1536098400, 1567375200), "2018-09-04 — 2019-09-01"),
        ),
        (("until", 1577232000), ((1567702200, 1577232000), "2019-12-25")),
        (
            ("time", (1549374782, 1567687982)),
            ((1549374782, 1567687982), "2019-02-05 — 2019-09-05"),
        ),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "m2",
            "2019-02-12",
            ((1543622400, 1548979200), "December 2018 — January 2019"),
        ),
        (
            "m3",
            "2019-02-12",
            ((1541030400, 1548979200), "November 2018 — January 2019"),
        ),
        ("m-3", "2019-02-12", ((1548979200, 1556668800), "February 2019 — April 2019")),
        (
            "m-3",
            "2018-12-12",
            ((1543622400, 1551398400), "December 2018 — February 2019"),
        ),
