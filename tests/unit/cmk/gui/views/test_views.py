...
def test_registered_display_hints() -> None:
    expected = [
        ...
        ".software.applications.podman.containers_exited",
        ".software.applications.podman.containers_paused",
        ".software.applications.podman.containers_running",
        ".software.applications.podman.containers_stopped",
        ".software.applications.podman.images",
        ".software.applications.podman.mode",
        ".software.applications.podman.registry",
        ".software.applications.podman.version",
