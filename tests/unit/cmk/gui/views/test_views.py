...
def test_registered_display_hints() -> None:
    expected = [
        ...
        ".hardware.storage.redfish_drives:*.capacity_bytes",
        ".hardware.storage.redfish_drives:*.component",
        ".hardware.storage.redfish_drives:*.firmware_version",
        ".hardware.storage.redfish_drives:*.manufacturer",
        ".hardware.storage.redfish_drives:*.media_type",
        ".hardware.storage.redfish_drives:*.model",
        ".hardware.storage.redfish_drives:*.serial",
        ".hardware.system.",
