...
class TestRuleConditionRenderer:
    ...
    def test_render_host_condition_text_wildcard_host_spec(self) -> None:
        ...
        assert result == HTML("Host name is <b>AP-SEDE-TCOTILLAS*</b>")
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                ...
                [HTML(r"Service name is <b>^File permissions.*\$</b>")],
            ...
            pytest.param(
                ...
                "foo",
                [{"$regex": r"^File permissions.*\$"}],
                [HTML(r"Service name begins with <b>^File permissions.*\$</b>")],
            ...
            pytest.param(
                ...
                "foo",
                [{"$regex": "^foo$"}, {"$regex": "^bar$"}],
                [HTML("Service name is <b>^foo</b> or <b>^bar</b>")],
            ...
            pytest.param(
                ...
                "foo",
                [{"$regex": "^foo$"}, {"$regex": "^bar"}],
                [HTML("Service name is <b>^foo</b> or begins with <b>^bar</b>")],
            ...
            pytest.param(
                ...
                [HTML("Service name is not <b>^foo</b> or begins not with <b>^bar</b>")],
