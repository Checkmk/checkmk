    ...
    [
        ...
        pytest.param(
            ...
            [
                ...
                Result(
                    state=State.CRIT,
                    summary="Max validity: 4 years 1 day (warn/crit at 181 days 0 hours/181 days 0 hours)",
                ),
            ],
            id="secret_default_params_max_validity_exceeded",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            id="certificate_default_params_max_validity_exceeded",
        ),
    ],
)
