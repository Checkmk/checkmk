...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            check_plugin_azure_postgresql_replication.check_default_parameters,
            [
                Result(
                    state=State.WARN,
...
def test_replication_lag_is_checked_against_levels(
    section: Resource,
    ...
    [
        ...
        pytest.param(
            Resource(
                ...
                location="westeurope",
                metrics={
                    "average_disk_iops_consumed_percentage": AzureMetric(
                        name="io_consumption_percent",
                        aggregation="average",
                        value=85.0,
                        unit="percent",
            ...
            [
                ...
                Metric("io_consumption_percent", 85.0, levels=(80.0, 90.0)),
            ],
            id="io warn flexible",
        ),
    ],
