        ...
        pytest.param(
            {
                ...
                "config": {},
                "services": [],
                "safe_hostnames": ("enabled", {"exclude_vms": False}),
            },
            HostConfig(name="testhost"),
            [
                "--tenant",
            ...
            id="safe hostnames enabled without vm exclusion",
        ),
        pytest.param(
            {
                "authority": "global_",
                ...
                "config": {},
                "services": [],
                "safe_hostnames": ("enabled", {"exclude_vms": True}),
            },
            HostConfig(name="testhost"),
            [
                "--tenant",
            ...
            id="safe hostnames enabled with vm exclusion",
        ),
    ],
)
