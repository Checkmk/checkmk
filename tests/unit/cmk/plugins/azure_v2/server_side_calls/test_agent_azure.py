        ...
        pytest.param(
            {
                ...
                "config": {},
                "services": [],
                "unique_hostnames": ("enabled", {"template": "long", "exclude_vms": False}),
            },
            HostConfig(name="testhost"),
            [
                "--tenant",
                ...
                "global",
                "--no-subscriptions",
                "--unique-hostnames=long",
                "--cache-id",
                "testhost",
                "--tenant-name",
                "my_tenant",
            ],
            id="unique hostnames long template without vm exclusion",
        ),
        pytest.param(
            {
                "authority": "global_",
                ...
                "config": {},
                "services": [],
                "unique_hostnames": ("enabled", {"template": "long", "exclude_vms": True}),
            },
            HostConfig(name="testhost"),
            [
                "--tenant",
