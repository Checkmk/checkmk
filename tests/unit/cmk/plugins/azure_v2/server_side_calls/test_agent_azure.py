        ...
        pytest.param(
            {
                ...
                "config": {
                    "explicit": [
                        {"group_name": "group_1", "resources": ["res1_group_1", "res2_group_1"]},
                        {"group_name": "group_2", "resources": ["res1_group_2", "res2_group_2"]},
                    ],
                },
                "services": [],
            },
            ...
            [
                ...
                "group=group_1",
                "--explicit-config",
                "resources=res1_group_1,res2_group_1",
                "--explicit-config",
                "group=group_2",
                "--explicit-config",
                "resources=res1_group_2,res2_group_2",
                "--cache-id",
                "testhost",
            ],
            id="multiple explicits",
        ),
        pytest.param(
            {
                "authority": "global_",
            ...
            id="unique hostnames enabled without vm exclusion",
        ),
        pytest.param(
            {
                "authority": "global_",
            ...
            id="unique hostnames enabled with vm exclusion",
        ),
    ],
)
