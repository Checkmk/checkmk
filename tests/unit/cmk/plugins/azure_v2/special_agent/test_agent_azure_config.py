    ...
    [
        (
            ...
            [
                ...
                "argparse: no_subscriptions = False",
                "argparse: subscriptions_require_tag = []",
                "argparse: subscriptions_require_tag_value = []",
                "argparse: client = 'client-id'",
                "argparse: tenant = 'tenant-id'",
                "argparse: secret = None",
                "argparse: secret_id = 'secret'",  # fear not, this is just the id.
                "argparse: cache_id = 'testhost'",
                "argparse: tenant_name = 'mytenant'",
                "argparse: proxy = None",
        ...
        (
            ...
            [
                ...
                "argparse: require_tag = ['tag1']",
                "argparse: require_tag_value = [['tag2', 'value2']]",
                "argparse: explicit_config = ['group=group_1', 'resources=res1_group_1,res2_group_1', 'group=group_2', 'resources=res1_group_2,res2_group_2']",
                "argparse: services = ['Microsoft.Compute/virtualMachines', 'Microsoft.Storage/storageAccounts']",
                "argparse: tag_key_pattern = <TagsImportPatternOption.import_all: 'IMPORT_ALL'>",
                "argparse: connection_test = False",
                "argparse: unique_hostnames = 'short'",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "[group_1]\nresource: res1_group_1\nresource: res2_group_1\n[group_2]\nresource: res1_group_2\nresource: res2_group_2",
        ),
    ],
)
