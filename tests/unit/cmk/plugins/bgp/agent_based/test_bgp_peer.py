...
DATA_IETF_BGB_PEER_NO_ERROR: Sequence[StringByteTable] = [
    [
...
DATA_IETF_BGB_PEER_ERROR_WITHOUT_SUBCODE: Sequence[StringByteTable] = [
    [["10.255.252.18", "65500", "10.5.0.11", "2", "6", [4, 0], "385012", "10.255.252.1"]],
    [["10.4.0.11"]],
]

DATA_IETF_BGB_PEER_ERROR_WITH_SUBCODE: Sequence[StringByteTable] = [
    [["10.255.252.18", "65500", "10.5.0.11", "2", "6", [3, 1], "385012", "10.255.252.1"]],
    [["10.4.0.11"]],
]

DATA_IETF_BGB_PEER_UNKNOWN_SUBCODE: Sequence[StringByteTable] = [
...
def test_bgp_peer_parse_ietf(data: Sequence[StringByteTable], result: bgp_peer.Section) -> None:
