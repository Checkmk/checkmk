...
def test_diskstat_convert_info() -> None:
    ...
    section_multipath = {
        "SDataCoreSANsymphony_VVol735": Group(
            paths=["sdi", "sdd"],
            broken_paths=[],
        ...
        "SDataCoreSANsymphony_VVol733": Group(
            paths=["sdb", "sdg"],
            broken_paths=[],
        ...
        "SDataCoreSANsymphony_VVol734": Group(
            paths=["sdc", "sdh"],
            broken_paths=[],
        ...
        "SDataCoreSANsymphony_VVol732": Group(
            paths=["sda", "sdf"],
            broken_paths=[],
        ...
        "SDataCoreSANsymphony_VVol795": Group(
            paths=["sdj", "sde"],
            broken_paths=[],
