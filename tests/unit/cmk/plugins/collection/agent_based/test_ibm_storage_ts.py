...
def test_ibm_storage_ts_info(
    ...
    plugin = fix_register.check_plugins[CheckPluginName("ibm_storage_ts")]
    assert (
...
def test_ibm_storage_ts_status(
    ...
    plugin = fix_register.check_plugins[CheckPluginName("ibm_storage_ts_status")]
    assert (
        list(plugin.check_function(section=string_table, item=None, params={})) == expected_result
    )
...
def test_ibm_storage_ts_library(
    ...
    plugin = fix_register.check_plugins[CheckPluginName("ibm_storage_ts_library")]
...
def test_ibm_storage_ts_drive(
    ...
    plugin = fix_register.check_plugins[CheckPluginName("ibm_storage_ts_drive")]
    assert list(plugin.check_function(section=string_table, item="1", params={})) == expected_result
