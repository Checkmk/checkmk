...
from cmk.plugins.collection.agent_based.inventory_kube_deployment import inventory_kube_deployment
...
def test_inventory_kube_deployment_calls_labels_to_table(
    ...
    mock = mocker.patch(
        "cmk.plugins.collection.agent_based.inventory_kube_deployment.labels_to_table"
    )
