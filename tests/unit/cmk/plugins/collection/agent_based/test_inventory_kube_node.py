...
from cmk.plugins.collection.agent_based.inventory_kube_node import inventory_kube_node
...
def test_inventory_kube_node_calls_labels_to_table(mocker: MockerFixture) -> None:
    ...
    mock = mocker.patch("cmk.plugins.collection.agent_based.inventory_kube_node.labels_to_table")
