...
from cmk.plugins.collection.agent_based.inventory_kube_pod import (
...
def test_inventory_kube_pod_calls_labels_to_table(mocker: MockerFixture) -> None:
    ...
    mock = mocker.patch("cmk.plugins.collection.agent_based.inventory_kube_pod.labels_to_table")
