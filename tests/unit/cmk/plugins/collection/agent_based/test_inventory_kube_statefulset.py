...
from cmk.plugins.collection.agent_based.inventory_kube_statefulset import inventory_kube_statefulset
...
def test_inventory_kube_statefulset_calls_labels_to_table(
    ...
    mock = mocker.patch(
        "cmk.plugins.collection.agent_based.inventory_kube_statefulset.labels_to_table"
    )
