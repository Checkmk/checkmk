...
from cmk.plugins.collection.agent_based.kube_deployment_info import check_kube_deployment_info
from cmk.plugins.kube.schemata.api import ContainerName, NamespaceName, Selector, Timestamp
from cmk.plugins.kube.schemata.section import DeploymentInfo, FilteredAnnotations, ThinContainers
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            id="Deployment with absent creation timestamp shows Age: unknown",
        ),
    ],
)
