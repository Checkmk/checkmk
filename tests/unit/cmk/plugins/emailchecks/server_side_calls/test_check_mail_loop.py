...
def test_check_mail_loop_basic() -> None:
    ...
    assert actual == ActiveCheckCommand(
        ...
        command_arguments=[
            ...
            Secret(1).unsafe("--fetch-password=%s"),
            "--connect-timeout=23",
            "--send-protocol=SMTP",
            ...
            Secret(0).unsafe("--send-password=%s"),
        ...
        (
            ...
            ActiveCheckCommand(
                ...
                command_arguments=[
                    ...
                    "--fetch-port=143",
                    "--fetch-username=hans",
                    Secret(0).unsafe(template="--fetch-password=%s"),
                    "--send-protocol=SMTP",
                    "--send-server=1.2.3.4",
                    "--mail-from=",
                    "--mail-to=",
        ...
        (
            ...
            ActiveCheckCommand(
                ...
                command_arguments=[
                    ...
                    "--fetch-tls",
                    "--fetch-username=me@gmx.de",
                    Secret(2).unsafe(template="--fetch-password=%s"),
                    "--connect-timeout=23",
                    "--send-protocol=SMTP",
                    "--send-server=smtp.gmx.de",
                    "--send-port=42",
                    "--send-tls",
                    "--send-username=me@gmx.de",
                    Secret(1).unsafe(template="--send-password=%s"),
                    "--mail-from=me_from@gmx.de",
                    "--mail-to=me_to@gmx.de",
                    "--status-suffix=non-existent-testhost-MailLoop_imap",
                    "--warning=93780",
        ...
        pytest.param(
            ...
            ActiveCheckCommand(
                ...
                command_arguments=[
                    ...
                    "--fetch-port=143",
                    "--fetch-username=hans",
                    Secret(4).unsafe(template="--fetch-password=%s"),
                    "--send-protocol=EWS",
                    "--send-server=5.6.7.8",
                    "--send-port=50",
                    "--send-tls",
                    ...
                    Secret(3).unsafe(template="--send-client-secret=%s"),
        ...
        pytest.param(
            ...
            ActiveCheckCommand(
                ...
                command_arguments=[
                    ...
                    "--fetch-port=143",
                    "--fetch-username=hans",
                    Secret(6).unsafe(template="--fetch-password=%s"),
                    "--send-protocol=EWS",
                    "--send-server=5.6.7.8",
                    "--send-port=50",
                    "--send-tls",
                    "--send-disable-cert-validation",
                    "--send-username=user",
                    Secret(5).unsafe(template="--send-password=%s"),
                    "--send-email-address=address@email.com",
                    "--mail-from=None",
                    "--mail-to=None",
                    "--delete-messages",
