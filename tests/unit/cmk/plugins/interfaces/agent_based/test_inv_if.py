...
from cmk.plugins.interfaces.agent_based.inv_if import inventorize_if, parse_inv_if, SectionInvIf
...
def test_parse_inv_if_handles_non_numeric_admin_status() -> None:
    ...
    # raised ValueError. The parser now maps the text labels back to their
    # IF-MIB integer values.
        ...
        [
            [
                [
                    ...
                    "4294967295",
                    "",
                    "up",  # oper_status as text
                    "up",  # admin_status as text
                    [116, 218, 136, 88, 22, 17],
                    "5300",
                ],
                [
                    "2",
                    "Unit: 1 Slot: 0 Port: 2",
                    "",
                    "ethernetCsmacd",
                    "4294967295",
                    "",
    ...
    assert [(iface.oper_status, iface.admin_status) for iface in section.interfaces] == [
        (1, 1),
        (6, 2),
    ]
