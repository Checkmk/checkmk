...
from cmk.plugins.kube.agent_based.inventory_kube_statefulset import inventory_kube_statefulset
...
from tests.unit.cmk.plugins.kube.agent_based.utils_inventory import sort_inventory_result
