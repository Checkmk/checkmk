    ...
    [
        pytest.param(
            ...
            [
                ...
                Result(
                    state=State.WARN,
                    summary="Used: 81.51% (warn/crit at 80.00%/90.00%)",
                ),
                ...
                Result(
                    state=State.OK,
                    summary="Virtual memory: 75.43% - 111 GiB of 147 GiB",
                ),
                Result(
                    state=State.WARN,
                    summary="Used: 75.43% (warn/crit at 70.00%/90.00%)",
                ),
        ...
        pytest.param(
            ...
            [
                ...
                Result(state=State.OK, notice="Used (averaged over 10 min): 81.51%"),
                Metric("mem_used_percent_avg", 81.50597700132717),
                Result(state=State.OK, notice="Used (averaged over 10 min): 104 GiB"),
                ...
                Result(state=State.OK, notice="Used (averaged over 10 min): 75.43%"),
                Metric("pagefile_used_percent_avg", 75.4296092229873),
                Result(state=State.OK, notice="Used (averaged over 10 min): 111 GiB"),
                Metric("pagefile_used_avg", 119057674240.0),
                Result(
                    state=State.WARN,
                    summary="Free (averaged over 10 min): 36.1 GiB (warn/crit below 48.8 GiB/3.91 GiB)",
                ),
        ...
        pytest.param(
                    ...
                    "abs_used": {
                        "upper": (
                            ...
                            (
                                ...
                                PREDICTED_VALUE_MEM,
                                (
                                    int(PREDICTED_VALUE_MEM * 0.9),
                                    int(PREDICTED_VALUE_MEM * 1.1),
                                ),
                            ),
                        ),
                        "lower": ("no_levels", None),
                    ...
                    "abs_used": {
                        "upper": (
                            ...
                            (
                                ...
                                PREDICTED_VALUE_PGF,
                                (
                                    int(PREDICTED_VALUE_PGF * 0.9),
                                    int(PREDICTED_VALUE_PGF * 1.1),
                                ),
                            ),
                        ),
                        "lower": ("no_levels", None),
            ...
            [
                ...
                Metric(
                    "pagefile_used",
                    119057674240.0,
                    levels=(90000000000.0, 110000000000.0),
                ),
        ...
        pytest.param(
            ...
            [
                ...
                Metric("mem_used", 112020467712.0, boundaries=(0.0, 137438347264.0)),
                Metric("mem_free", 25417879552.0, boundaries=(0.0, 137438347264.0)),
                Result(state=State.OK, notice="Used (averaged over 60 min): 81.51%"),
                Metric("mem_used_percent_avg", 81.50597700132717),
                Result(
                    state=State.WARN,
                    summary="Used (averaged over 60 min): 104 GiB (prediction: 97.7 GiB) (warn/crit at 87.9 GiB/107 GiB)",
                ),
                Metric(
                    "mem_used_avg",
                    112020467712.0,
                    levels=(94371840000.0, 115343360000.0),
                ),
                Metric("predict_mem_used", 104857600000.0),
                ...
                Metric("pagefile_used", 119057674240.0, boundaries=(0.0, 157839441920.0)),
                Metric("pagefile_free", 38781767680.0, boundaries=(0.0, 157839441920.0)),
                Result(state=State.OK, notice="Used (averaged over 60 min): 75.43%"),
                Metric("pagefile_used_percent_avg", 75.4296092229873),
                Result(
                    state=State.CRIT,
                    summary="Used (averaged over 60 min): 111 GiB (prediction: 93.1 GiB) (warn/crit at 83.8 GiB/102 GiB)",
                ),
                Metric(
                    "pagefile_used_avg",
                    119057674240.0,
                ...
                Metric("predict_pagefile_used", 100000000000.0),
                Result(state=State.OK, notice="Free (averaged over 60 min): 36.1 GiB"),
                Metric("pagefile_free_avg", 38781767680.0),
            ],
