...
from cmk.plugins.msexch.agent_based import msexch_autodiscovery
...
def test_msexch_autodiscovery_discovery(parsed: WMISection) -> None:
...
def test_msexch_autodiscovery_check(parsed: WMISection) -> None:
