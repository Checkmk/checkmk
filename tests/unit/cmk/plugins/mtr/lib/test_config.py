...
def test_section_names(
    mtr_config: Sequence[Mapping[str, object]], expected_result: Sequence[str]
) -> None:
...
def test_indistinguishable_entries_collide(mtr_config: Sequence[Mapping[str, object]]) -> None:
