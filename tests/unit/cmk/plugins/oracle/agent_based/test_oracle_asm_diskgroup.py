    ...
    [
        ...
        (
            ...
            [
                ...
                Result(state=State.OK, summary="Used: 12.07% - 332 GB of 2.75 TB"),
                Metric("fs_size", 2621440.0, boundaries=(0.0, None)),
                Metric("growth", -4423.433540694911),
                Result(state=State.OK, summary="trend per 1 day 0 hours: -4.64 GB"),
        ...
        (
            ...
            [
                ...
                Result(state=State.OK, summary="Used: 20.39% - 131 GB of 644 GB"),
