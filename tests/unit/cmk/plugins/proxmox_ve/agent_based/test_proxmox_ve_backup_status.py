...
@pytest.mark.xfail(
    strict=True,
    reason="Crash group 3721 and 4500: negative age crashes render.timespan",
)
def test_check_proxmox_ve_vm_backup_status_future_started_time() -> None:
    ...
    list(pvbs.check_proxmox_ve_vm_backup_status(FROZEN_TIME, {"age_levels_upper": None}, section))
