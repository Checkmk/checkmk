    ...
    [
        (
            ...
            [
                ...
                Result(state=State.OK, summary="Used: 0.18% - 457 MB of 257 GB"),
                ...
                Result(state=State.OK, notice="Unique: 448 MB"),
                Metric("unique_size", 447850990.0),
                Result(state=State.OK, notice="Snapshots: 2.89 MB"),
                Metric("snapshots_size", 2890766.0),
                Result(state=State.OK, notice="Shared: 6.60 MB"),
                ...
                Result(state=State.OK, notice="Empty: 257 GB"),
            ],
        )
    ],
)
