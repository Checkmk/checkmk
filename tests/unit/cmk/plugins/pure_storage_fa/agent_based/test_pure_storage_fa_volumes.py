    ...
    [
        pytest.param(
            ...
            [
                ...
                Result(state=State.OK, summary="Used: 3.56% - 3.82 GB of 107 GB"),
                Result(state=State.OK, summary="Data reduction: 8.52 to 1"),
                Metric("data_reduction", 8.522708060028126),
                Result(state=State.OK, notice="Size: 107 GB"),
                Metric("fs_size", 107374182400.0, boundaries=(0.0, None)),
                Result(state=State.OK, notice="Physical capacity used - volume: 448 MB"),
                Metric("unique_size", 447850921.0),
                Result(state=State.OK, notice="Physical capacity used - snapshots: 2.89 MB"),
                Metric("snapshots_size", 2890766.0),
                Result(state=State.OK, notice="Virtual capacity used - volume: 3.82 GB"),
