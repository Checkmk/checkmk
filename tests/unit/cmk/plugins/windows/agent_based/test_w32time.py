...
FR_GOOD_SYNC = [
    ...
    ["Durée écoulée depuis l’heure de la dernière synchronisation réussie : 22.0930147s"],
]
...
DE_LINE_WRAP = [
    ...
    ["Serverrolle: 0 (Keine)"],
    [
        "Letzter Synchronierungsfehler: 2 (Der Computer wurde nicht synchronisiert, da nur veraltete Zeitdaten"
    ],
    ["verf\\x81gbar waren.)"],
    [
        "Zeit seit der letzten erfolgr. Synchronisierungszeit: 4812.7981071s",
    ],
]
