...
def test_windows_multipath_files(conf: dict[str, object], expected: list[Plugin]) -> None:
    parsed = bakery_plugin_windows_multipath.parameter_parser(conf)
    result = list(bakery_plugin_windows_multipath.files_function(parsed))
