...
def test_get_services(
    livestatus_response: LivestatusResponse, expected_data: Checks, local_connection: mock.Mock
) -> None:
...
@pytest.mark.usefixtures("mock_instance_id")
def test_get_services_unexpected_result_or_column(local_connection: mock.Mock) -> None:
