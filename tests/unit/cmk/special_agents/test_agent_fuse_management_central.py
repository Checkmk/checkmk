    ...
    "systems": [
        {
            ...
            "name": "system-1",
            "componentTypes": [{"id": "SYSTEM", "displayName": "System Status"}],
            "type": "OTCS",
        },
        {
            ...
            "name": "system-2",
            "componentTypes": [
                {"id": "SYSTEM", "displayName": "System Status"},
                {"id": "OTAC_ARCHIVE", "displayName": "Logical Archives"},
            ],
            "type": "OTAC",
        },
    ],
    "environments": [
        {
            ...
            "name": "PRODUCTION",
            "componentTypes": [
                {"id": "SOV", "displayName": "System Object Volume"},
                {"id": "AGENTS", "displayName": "Agents"},
            ],
        }
    ],
    "admin": {"componentTypes": [{"id": "HEALTH", "displayName": "Health"}]},
}
...
SUMMARY: list = [
    ...
    {"componentType": "HEALTH", "warnings": 7.0, "link": "link_FUSE_HEALTH"},
]
...
SUMMARY_STRUCTURE: SummaryStructure = SummaryStructure(
    ...
    {"HEALTH": {"componentType": "HEALTH", "warnings": 7.0, "link": "link_FUSE_HEALTH"}},
)


@pytest.mark.parametrize("summary_alerts,summary_alerts_structure", [(SUMMARY, SUMMARY_STRUCTURE)])
...
@pytest.mark.parametrize(
    "params,system_alerts_list",
    [
        (
            {"layout": LAYOUT, "system_alerts": SUMMARY_STRUCTURE.system_alerts},
            [
                Alert(
...
@pytest.mark.parametrize(
    "params,env_alerts_list",
    [
        (
            {"layout": LAYOUT, "env_alerts": SUMMARY_STRUCTURE.env_alerts},
            [
                Alert(
...
@pytest.mark.parametrize(
    "params,admin_alerts_list",
    [
        (
            {"layout": LAYOUT, "fuse_alerts": SUMMARY_STRUCTURE.fuse_alerts},
