...
bi_status_rows = [
    [
        ...
        [[
            ...
            'host labels', 1, 1, 1, 0, 0, 1
        ],
         [
             'Check_MK', 0, 1,
             'OK - [agent] Version: 2020.07.04, OS: linux, execution time 1.0 sec ', 0, 1, 1, 0, 0,
             1
         ],
         [
             'Check_MK HW/SW Inventory', 0, 1,
             'OK - Found 187 inventory entries, Found 157 status entries', 0, 1, 1, 0, 0, 1
         ],
         [
             'OMD heute apache', 0, 1,
             'OK - 2.01 Requests/s, 0.03 Seconds serving/s, 203.10 kB Sent/s', 0, 1, 1, 0, 0, 1
         ],
         [
         ...
         [
             ...
             '415 B/s (0.0%)', 1, 1, 1, 0, 0, 1
         ],
         [
             'OMD heute Notification Spooler', 0, 1, 'OK - Version: 2020.09.03, Spooler running', 0,
             1, 1, 0, 0, 1
         ],
         [
             'Interface 3', 0, 1,
             'OK - [docker0], Operational state: up, MAC: 02:42:BE:0A:7B:5A, assuming '
             '10 MBit/s, In: 0.00 B/s (0.0%), Out: 0.00 B/s (0.0%)', 0, 1, 1, 0, 0, 1
         ],
         [
             'Interface 2', 1, 1,
             'WARN - [tun0], Operational state: up, 10 MBit/s (wrong speed, expected: 0 '
             'Bit/s)(!), In: 280 B/s (0.0%), Out: 87.2 B/s (0.0%)', 1, 1, 1, 0, 0, 1
         ],
         [
             ...
             'certificate validity (until 3019-01-05 11:38:09): 364633.93', 0, 1, 1, 0, 0, 1
         ],
         [
             'Uptime', 0, 1, 'OK - Up since Fri Sep  4 09:45:36 2020, uptime: 4:37:11', 0, 1, 1, 0,
             0, 1
         ],
         [
             'Filesystem /opt/omd/sites/heute/tmp', 0, 1,
             'OK - 0.04% used (6.52 MB of 15.49 GB), trend: +317.48 kB / 24 hours', 0, 1, 1, 0, 0, 1
         ]]
    ],
    [
        ...
        [[
         ...
         [
             'Filesystem /opt/omd/sites/heute/tmp', 0, 1,
             'OK - 0.04% used (6.52 MB of 15.49 GB), trend: 0.00 B / 24 hours', 0, 1, 1, 0, 0, 1
         ],
         [
             'Interface 2', 1, 1,
             'WARN - [tun0], Operational state: up, 10 MBit/s (wrong speed, expected: 0 '
             'Bit/s)(!), In: 279 B/s (0.0%), Out: 86.2 B/s (0.0%)', 1, 1, 1, 0, 0, 1
         ...
         [
             ...
             'unknown, In: 0.00 B/s, Out: 0.00 B/s', 0, 1, 1, 0, 0, 1
         ],
         [
             'OMD heute Event Console', 0, 1,
             'OK - Current events: 0, Virtual memory: 191.69 MB, Overall event limit '
         ...
         [
             'Uptime', 0, 1, 'OK - Up since Fri Sep  4 09:45:36 2020, uptime: 4:37:12', 0, 1, 1, 0,
             0, 1
         ],
         [
             'Check_MK HW/SW Inventory', 0, 1,
             'OK - Found 187 inventory entries, software changes, Found 157 status '
             'entries', 0, 1, 1, 0, 0, 1
         ],
         [
             'Check_MK', 0, 1,
             'OK - [agent] Version: 2020.07.04, OS: linux, execution time 1.2 sec ', 0, 1, 1, 0, 0,
             1
         ]]
    ]
]
...
bi_acknowledgment_status_rows = [[
    ...
    [
        [
            ...
            'livestatus_status:1, kernel_util:1, kernel_performance:1, diskstat:1, '
            'df:3, cpu_threads:1, cpu_loads:1)(!), no vanished services found, no new '
            'host labels', 1, 1, 1, 0, 1, 1
        ],
        [
            'Check_MK', 0, 1,
            'OK - [agent] Version: 2020.07.04, OS: linux, execution time 1.0 sec ', 0, 1, 1, 0, 0, 1
        ],
        [
            'Check_MK HW/SW Inventory', 0, 1,
            'OK - Found 187 inventory entries, Found 157 status entries', 0, 1, 1, 0, 0, 1
    ...
    'packs': [{
        ...
        'rules': [{
            ...
            'nodes': [{
                'action': {
                    'host_regex': '$HOSTNAME$',
                    'service_regex': 'CPU|Memory|Vmalloc|Kernel|Number '
                                     'of threads',
                    'type': 'state_of_service'
                },
                'search': {
