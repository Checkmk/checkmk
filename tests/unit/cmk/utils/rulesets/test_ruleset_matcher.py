...
def test_ruleset_matcher_get_host_ruleset_values_labels(monkeypatch: MonkeyPatch, hostname_str: str,
                                                        expected_result: Sequence[str]) -> None:
    ts = Scenario()
    ...
    assert list(
        matcher.get_host_ruleset_values(RulesetMatchObject(host_name=HostName(hostname_str),
...
def test_basic_get_host_ruleset_values(monkeypatch: MonkeyPatch) -> None:
    ...
    assert list(
        matcher.get_host_ruleset_values(RulesetMatchObject(host_name=HostName("abc"),
                                                           service_description=None),
                                        ruleset=ruleset,
                                        is_binary=False)) == []
    assert list(
        matcher.get_host_ruleset_values(RulesetMatchObject(host_name=HostName("xyz"),
                                                           service_description=None),
                                        ruleset=ruleset,
                                        is_binary=False)) == []
    assert list(
        matcher.get_host_ruleset_values(RulesetMatchObject(host_name=HostName("host1"),
                                                           service_description=None),
                                        ruleset=ruleset,
                                        is_binary=False)) == ["BLA", "BLUB"]
    assert list(
        matcher.get_host_ruleset_values(RulesetMatchObject(host_name=HostName("host2"),
                                                           service_description=None),
                                        ruleset=ruleset,
...
def test_basic_get_host_ruleset_values_subfolders(monkeypatch: MonkeyPatch) -> None:
    ...
    assert list(
        matcher.get_host_ruleset_values(RulesetMatchObject(host_name=HostName("xyz"),
                                        ...
                                        is_binary=False)) == []
    assert list(
        matcher.get_host_ruleset_values(RulesetMatchObject(host_name=HostName("lvl1"),
                                                           service_description=None),
                                        ruleset=ruleset,
                                        is_binary=False)) == ["LEVEL1"]
    assert list(
        matcher.get_host_ruleset_values(RulesetMatchObject(host_name=HostName("lvl2"),
                                                           service_description=None),
                                        ruleset=ruleset,
                                        is_binary=False)) == ["LEVEL1", "LEVEL2"]
    assert list(
        matcher.get_host_ruleset_values(RulesetMatchObject(host_name=HostName("lvl1a"),
                                                           service_description=None),
                                        ruleset=ruleset,
                                        is_binary=False)) == []
...
def test_basic_host_ruleset_get_merged_dict_values(monkeypatch: MonkeyPatch) -> None:
    ...
    matcher = config_cache.ruleset_matcher
    assert matcher.get_host_ruleset_merged_dict(RulesetMatchObject(host_name=HostName("abc"),
                                                                   service_description=None),
                                                ruleset=dict_ruleset) == {}
    assert matcher.get_host_ruleset_merged_dict(RulesetMatchObject(host_name=HostName("xyz"),
                                                                   service_description=None),
                                                ruleset=dict_ruleset) == {}
    assert matcher.get_host_ruleset_merged_dict(RulesetMatchObject(host_name=HostName("host1"),
                                                                   service_description=None),
                                                ruleset=dict_ruleset) == {
                                                    "hu": "BLA",
                                                    "ho": "BLA",
    ...
    assert matcher.get_host_ruleset_merged_dict(RulesetMatchObject(host_name=HostName("host2"),
                                                                   service_description=None),
                                                ruleset=dict_ruleset) == {
                                                    "hu": "BLUB",
                                                    "ho": "BLA",
...
def test_basic_host_ruleset_is_matching_host_ruleset(monkeypatch: MonkeyPatch) -> None:
    ...
    matcher = config_cache.ruleset_matcher
    assert matcher.is_matching_host_ruleset(RulesetMatchObject(host_name=HostName("abc"),
                                                               service_description=None),
                                            ruleset=binary_ruleset) is False
    assert matcher.is_matching_host_ruleset(RulesetMatchObject(host_name=HostName("xyz"),
                                                               service_description=None),
                                            ruleset=binary_ruleset) is False
    assert matcher.is_matching_host_ruleset(RulesetMatchObject(host_name=HostName("host1"),
                                                               service_description=None),
                                            ruleset=binary_ruleset) is True
    assert matcher.is_matching_host_ruleset(RulesetMatchObject(host_name=HostName("host2"),
                                                               service_description=None),
                                            ruleset=binary_ruleset) is False
...
def test_ruleset_matcher_get_service_ruleset_values_labels(monkeypatch: MonkeyPatch,
                                                           hostname: HostName,
    ...
    ts.add_host(HostName("host1"))
    ts.set_autochecks(HostName("host1"), [
    ...
    ts.add_host(HostName("host2"))
    ts.set_autochecks(HostName("host2"), [
        Service(
