...
class FixRegister:
    ...
    def __init__(self) -> None:
        ...
        import cmk.base.plugins.config_generation.register as config_generation_register  # pylint: disable=import-outside-toplevel,cmk-module-layer-violation
        ...
        self._active_checks = copy.deepcopy(config_generation_register.registered_active_checks)
