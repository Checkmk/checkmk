...
from omdlib.config_hooks import (
    ...
    _next_free_port,
    _report_error,
    _set_livestatus_tcp_instances,
    _set_livestatus_tcp_per_source,
...
def test_set_livestatus_tcp_port_no_conflict(tmp_path: Path) -> None:
    ...
    result = _set_livestatus_tcp_port("mysite", _DEFAULT_TCP_CONFIG, tmp_path, "6557")
...
def test_set_livestatus_tcp_port_invalid_value(tmp_path: Path) -> None:
    ...
    result = _set_livestatus_tcp_port("mysite", _DEFAULT_TCP_CONFIG, tmp_path, "not-a-port")
...
def test_set_livestatus_tcp_instances_updates_conf(tmp_path: Path) -> None:
    ...
    result = _set_livestatus_tcp_instances("mysite", _DEFAULT_TCP_CONFIG, tmp_path, "300")
...
def test_set_livestatus_tcp_instances_preserves_other_values(tmp_path: Path) -> None:
    ...
    _set_livestatus_tcp_instances("mysite", _DEFAULT_TCP_CONFIG, tmp_path, "300")
...
def test_set_livestatus_tcp_per_source_updates_conf(tmp_path: Path) -> None:
    ...
    result = _set_livestatus_tcp_per_source("mysite", _DEFAULT_TCP_CONFIG, tmp_path, "50")
...
def test_set_livestatus_tcp_per_source_preserves_other_values(tmp_path: Path) -> None:
    ...
    _set_livestatus_tcp_per_source("mysite", _DEFAULT_TCP_CONFIG, tmp_path, "50")
    text = (site_dir / "etc/xinetd.d/livestatusv1").read_text()
