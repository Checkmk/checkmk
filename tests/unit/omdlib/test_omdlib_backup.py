...
def test_backup_site_to_tarfile(site, tmp_path) -> None:  # type:ignore[no-untyped-def]
...
def test_backup_site_to_tarfile_broken_link(site, tmp_path) -> None:  # type:ignore[no-untyped-def]
...
def test_backup_site_to_tarfile_vanishing_files(  # type:ignore[no-untyped-def]
