...
class ErrorReporter:
    ...
    _known_item_requirements = {
        ...
        ('check', 'systemd_units_services_summary',
    ...
    _known_error_loading_defaults = {
        ...
        ('check', 'aws_dynamodb_table_read_capacity',
         'checkgroup_parameters:aws_dynamodb_capacity'),
        ('check', 'aws_dynamodb_table_write_capacity',
         'checkgroup_parameters:aws_dynamodb_capacity'),
        ...
        ('check', 'cisco_prime_wifi_access_points',
         'checkgroup_parameters:cisco_prime_wifi_access_points'),
        ('check', 'cisco_prime_wifi_connections',
        ...
        ('check', 'wagner_titanus_topsense_airflow_deviation',
